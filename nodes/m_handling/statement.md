...
- **status:** PROVED
- **closure:** proof
- **refs (legacy repo):** ['proof_sketch/s7_list_side.md#3']

## Statement

Either the official reading bounds m (exists-m / fixed small m: worst-case route suffices) or for-all-m holds (a-regular collapse required for m >= 4). Exhaustive over readings.
