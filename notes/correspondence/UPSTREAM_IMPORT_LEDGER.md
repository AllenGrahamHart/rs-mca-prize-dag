...
| BC curve second moment (#395 Thm C1) | TARGET pending verification (SPLIT from the Veronese row; separate unintegrated PR) | #395 | ledger only | -- | not verified; do not conflate with the Veronese emptiness |
