...
**Outcome:** `COMPLETE`. Modal app `ap-qUwke475x3bODff3kZHe9N` completed
all fourteen specializations in 17 seconds. The final ideal is the singleton
unit ideal at five roots:

```text
465887767, 666570304, 676802667, 1036595577, 1141382033.
```

Two survivors, `47655010` and `1893783428`, are zero-dimensional with
seven-element bases. The remaining seven survivors,

```text
0, 1, 16711679, 451278922, 1629292471, 2113994754, 2130706432,
```

have dimension two in the seven-variable ring; the added `q5`, `q7`, and
`q6` relations do not lower the final dimension on those components. Thus
the generic denominator ledger plus this replay closes five exceptional
fibers but does not yet close `FFF`. The exact survivor bases are banked for
guard and omitted-`q4` analysis. Result SHA-256:
