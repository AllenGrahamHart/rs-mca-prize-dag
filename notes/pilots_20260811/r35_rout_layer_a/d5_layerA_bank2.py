...
sys.path.insert(0, "notes/pilots_20260811/r34_layer_a")   # r34: my own copy
...
P("=" * 78)
print("\n".join(out))
# r35 EDIT: the inherited path wrote into r34_layer_a/ -- an OUT-OF-SCOPE write
# that this module performs at IMPORT time (MISS 1).  Redirected into my dir.
with open("notes/pilots_20260811/r35_rout_layer_a/d3b_replay_r35.txt", "w") as f:
    f.write("\n".join(out) + "\n")
