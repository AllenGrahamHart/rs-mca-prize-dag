...
- `T = 3` over `mu_32` was NOT reached; the failure is algorithmic (a third
  exact solve is missing), not arithmetic. **ZERO POWER over whether the
  class continues.**
...
tools/ramguard tiny -- python3 \
  notes/pilots_20260811/r37_mint_drafts/l2_par_parametrization/verify.py
```
