# Binding constraints (r36_hrlow, round 36)
...
- WRITE SCOPE: ONLY notes/pilots_20260811/r36_hrlow/. No
...
- QUARANTINE: never open notes/pilots_20260802/CAMPAIGN_LEDGER.md.
  The sibling round-36 dirs are, BY NAME: r36_hrlow (you),
  r36_lawcount_geom, r36_sat3_on_l2, r36_m4_nonsplit — NEVER read
  the other three; you never need to ls the parent (the names are
  ...
  SEARCH level: --exclude-dir=r36_lawcount_geom
  --exclude-dir=r36_sat3_on_l2 --exclude-dir=r36_m4_nonsplit
