...
""",
        addenda=(
            ...
            (
                "critical/nodes/rate_half_list_adjacent_crossing/statement_addenda/16-round29-row-size-scope.md",
                (
                    "rate_half_list_adjacent_crossing",
                ),
            ),
    ...
    Document(
        ...
        addenda=(
            ...
            (
                "critical/nodes/rate_half_band_closure/attack_addenda/27-wave65-positive-433-cell4-xi3-pairing0.md",
                ("rate_half_band_closure",),
            ),
            (
                "critical/nodes/rate_half_band_closure/attack_addenda/28-wave66-positive-433-cell4-xi3-pairings1-2.md",
                ("rate_half_band_closure",),
            ),
            (
            ...
            (
                "critical/nodes/rate_half_band_closure/attack_addenda/31-wave69-positive-433-cell4-xi3-pairing5-12.md",
                ("rate_half_band_closure",),
            ),
            (
                "critical/nodes/rate_half_band_closure/attack_addenda/32-wave70-positive-433-cell4-xi3-pairing7-10.md",
                ("rate_half_band_closure",),
            ),
            (
                "critical/nodes/rate_half_band_closure/attack_addenda/33-wave71-positive-433-cell4-xi3-pairing8-13.md",
                ("rate_half_band_closure",),
            ),
            (
                "critical/nodes/rate_half_band_closure/attack_addenda/34-wave72-positive-433-cell4-complete.md",
                (
                    "rate_half_band_closure",
                    ...
                    "rate_half_kb_m2_r4_coordinate_positive_433_1b_cells4_7_duplicate_role_complete_exclusion",
                ),
            ),
        ),
...
- `attack_addenda/28-wave66-positive-433-cell4-xi3-pairings1-2.md`: exact
  reciprocal-linear exclusions at `xi=3`, matchings 1 and 2, plus both
  `xi=4` transport payments; six matching-exchange pairs remain.
