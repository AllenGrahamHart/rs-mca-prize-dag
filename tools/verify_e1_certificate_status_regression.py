...
def main():
    ...
    require("78<=v<=134" in sparse_l1_statement and "v<=76" in sparse_l1_statement,
    ...
    require("c<=-22" in signed_chord_statement and "circular sidon" in signed_chord_statement,
