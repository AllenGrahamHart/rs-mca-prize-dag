...
def main():
    ...
    require("86<=v<=134" in sparse_l1_statement and "v<=84" in sparse_l1_statement,
    ...
    require("c<=-20" in signed_chord_statement and "circular sidon" in signed_chord_statement,
