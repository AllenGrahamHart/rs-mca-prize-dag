...
def main():
    ...
    require("82<=v<=134" in sparse_l1_statement and "v<=80" in sparse_l1_statement,
    ...
    require("c<=-21" in signed_chord_statement and "circular sidon" in signed_chord_statement,
