...
- **claim:** the final F2 extras-plus-trades budget on all official
  prize-max admissible rows
...
- **falsifier:** an official admissible row with more than `n^3` extras and
  trades
