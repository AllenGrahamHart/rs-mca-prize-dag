...
- **Input:** a first-owned full-petal contributor not paid by the top band or
  the fixed-`e` root-pinning ledger.
...
- **Nonclaims:** mixed/partial-petal payment; `M=t`; a per-source bound without
  source-multiplicity control; a Conjecture-F linear-flat reduction.
