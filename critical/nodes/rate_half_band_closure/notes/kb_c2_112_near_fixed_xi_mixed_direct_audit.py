#!/usr/bin/env python3
"""Independent opposite-projection audit for the fixed-xi mixed chart."""
...
def main() -> None:
    ...
    for root_name, root in (("c", c), ("d", d)):
        ...
        conditions = {
            "product": sp.cancel(bottom - top / (2 * d)),
            "sum": sp.cancel(
                middle + (sp.Rational(1, 2) + 1 / d) * top
            ),
        }
    ...
    print(
        "KB_C2_112_NEAR_FIXED_XI_MIXED_DIRECT_AUDIT_PASS "
