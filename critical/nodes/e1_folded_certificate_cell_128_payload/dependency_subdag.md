# dependency sub-DAG: e1_folded_certificate_cell_128_payload
...
This conditional node supplies the `N'=128` transcript once the no-vector
certificate leaf is closed. The sibling conditional node
`e1_folded_certificate_cell_256_payload` supplies the other open E1 cell.
