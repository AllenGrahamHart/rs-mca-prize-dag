...
SCRATCH = "."  # PATH REPAIR catch #112: was the author scratchpad
NOTES = "."  # PATH REPAIR catch #112: siblings shipped flat
...
def s3():
    ...
    with open(f"{SCRATCH}/qrl_coverage_table.md", "w") as f:
