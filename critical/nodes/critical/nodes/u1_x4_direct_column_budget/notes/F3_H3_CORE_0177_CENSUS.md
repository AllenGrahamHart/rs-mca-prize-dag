# F3 h=3 core `(0,1,77)` complete census (Terminal C)

Status: PRE-REGISTERED CORE-SLICE CENSUS.  This is the seventy-sixth of
...
```text
A = [0,1,77],  B any 3-subset of Z/96Z disjoint from A.
```
