# F3 h=3 core `(0,1,63)` complete census (Terminal C)

Status: PRE-REGISTERED CORE-SLICE CENSUS.  This is the sixty-second of
...
```text
A = [0,1,63],  B any 3-subset of Z/96Z disjoint from A.
```
