# F3 h=3 core `(0,1,40)` complete census (Terminal C)

Status: PRE-REGISTERED CORE-SLICE CENSUS.  This is the thirty-ninth of
...
```text
A = [0,1,40],  B any 3-subset of Z/96Z disjoint from A.
```
...
```text
rational norm exception:       1381 / 129766 = 1.0642%
