# F3 h=3 core `(0,1,8)` complete census (Terminal C)

Status: PRE-REGISTERED COMPLETE CORE-SLICE CENSUS.  This is the seventh of the
...
```text
A = [0,1,8],  B any 3-subset of Z/96Z disjoint from A.
```
