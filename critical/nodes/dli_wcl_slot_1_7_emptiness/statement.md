# WCL slot 1,7 emptiness (extended window)
...
blind census by the exact five-variable divisor

```text
G=YA^2-B^2 | Y^256-1,       deg A=3, deg B<=2, B(0)=1,
```

and a pruned `76`-variable, `78`-equation straight-line unit ideal. Computing
