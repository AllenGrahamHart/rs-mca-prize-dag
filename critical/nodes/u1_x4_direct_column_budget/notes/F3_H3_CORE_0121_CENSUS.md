# F3 h=3 core `(0,1,21)` complete census (Terminal C)

Status: PRE-REGISTERED COMPLETE CORE-SLICE CENSUS.  This is the twentieth of
...
```text
A = [0,1,21],  B any 3-subset of Z/96Z disjoint from A.
```
