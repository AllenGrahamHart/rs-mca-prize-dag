# F3 h=3 core `(0,1,13)` complete census (Terminal C)

Status: PRE-REGISTERED COMPLETE CORE-SLICE CENSUS.  This is the twelfth of the
...
```text
A = [0,1,13],  B any 3-subset of Z/96Z disjoint from A.
```
