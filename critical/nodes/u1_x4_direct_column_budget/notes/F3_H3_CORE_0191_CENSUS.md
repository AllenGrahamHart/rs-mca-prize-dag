# F3 h=3 core `(0,1,91)` complete census (Terminal C)

Status: PRE-REGISTERED CORE-SLICE CENSUS.  This is the ninetieth of
...
```text
A = [0,1,91],  B any 3-subset of Z/96Z disjoint from A.
```
