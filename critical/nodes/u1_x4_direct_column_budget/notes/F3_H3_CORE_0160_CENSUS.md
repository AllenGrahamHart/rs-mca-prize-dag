# F3 h=3 core `(0,1,60)` complete census (Terminal C)

Status: PRE-REGISTERED CORE-SLICE CENSUS.  This is the fifty-ninth of
...
```text
A = [0,1,60],  B any 3-subset of Z/96Z disjoint from A.
```
