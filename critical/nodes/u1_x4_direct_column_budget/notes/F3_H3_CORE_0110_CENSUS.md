# F3 h=3 core `(0,1,10)` complete census (Terminal C)

Status: PRE-REGISTERED COMPLETE CORE-SLICE CENSUS.  This is the ninth of the
...
```text
A = [0,1,10],  B any 3-subset of Z/96Z disjoint from A.
```
...
```text
rational norm exception:       1111 / 129766 = 0.8562%
