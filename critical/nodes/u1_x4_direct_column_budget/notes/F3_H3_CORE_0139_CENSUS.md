# F3 h=3 core `(0,1,39)` complete census (Terminal C)

Status: PRE-REGISTERED CORE-SLICE CENSUS.  This is the thirty-eighth of
...
```text
A = [0,1,39],  B any 3-subset of Z/96Z disjoint from A.
```
