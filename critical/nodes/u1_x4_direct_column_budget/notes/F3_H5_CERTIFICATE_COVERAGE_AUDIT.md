...
The existing evidence consists of 473 complete zero rows:

```text
n=32:  all admissible primes p = 1 mod 32 with 32^2 < p <= 65537
n=64:  all admissible primes p = 1 mod 64 with 64^2 < p <= 20353,
...
exponent `0`, disjoint supports, equal `e_1..e_4`, and unequal `e_5`.  All 473
rows have
...
```text
 ...
 64    63     4289  262337          694          631     442817361
