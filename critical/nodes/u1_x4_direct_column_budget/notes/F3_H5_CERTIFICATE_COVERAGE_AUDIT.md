...
The existing evidence consists of 491 complete zero rows:

```text
n=32:  all admissible primes p = 1 mod 32 with 32^2 < p <= 65537
n=64:  all admissible primes p = 1 mod 64 with 64^2 < p <= 26177,
...
exponent `0`, disjoint supports, equal `e_1..e_4`, and unequal `e_5`.  All 491
rows have
...
```text
 ...
 64    81     4289  262337          694          613     569336607
