...
The existing evidence consists of 512 complete zero rows:

```text
n=32:  all admissible primes p = 1 mod 32 with 32^2 < p <= 65537
n=64:  all admissible primes p = 1 mod 64 with 64^2 < p <= 33601,
...
exponent `0`, disjoint supports, equal `e_1..e_4`, and unequal `e_5`.  All 512
rows have
...
```text
 ...
 64   102     4289  262337          694          592     716942394
