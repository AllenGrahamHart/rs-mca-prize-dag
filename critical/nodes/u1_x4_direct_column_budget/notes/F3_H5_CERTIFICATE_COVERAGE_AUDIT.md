...
The existing evidence consists of 579 complete zero rows:

```text
n=32:  all admissible primes p = 1 mod 32 with 32^2 < p <= 65537
n=64:  all admissible primes p = 1 mod 64 with 64^2 < p <= 54721,
...
exponent `0`, disjoint supports, equal `e_1..e_4`, and unequal `e_5`.  All 579
rows have
...
```text
 ...
 64   169     4289  262337          694          525    1187875143
 96     1     9601    9601            1            0      57940519
128     7    17921   20353            7            0    1779622425
total certified zero rows: 579
total right-side probes: 3093742309
```
