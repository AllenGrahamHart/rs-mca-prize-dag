# F3 h=3 core `(0,1,92)` complete census (Terminal C)

Status: PRE-REGISTERED CORE-SLICE CENSUS.  This is the ninety-first of
...
```text
A = [0,1,92],  B any 3-subset of Z/96Z disjoint from A.
```
