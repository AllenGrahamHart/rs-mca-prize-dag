# F3 h=3 core `(0,1,78)` complete census (Terminal C)

Status: PRE-REGISTERED CORE-SLICE CENSUS.  This is the seventy-seventh of
...
```text
A = [0,1,78],  B any 3-subset of Z/96Z disjoint from A.
```
