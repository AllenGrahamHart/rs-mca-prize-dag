# F3 h=3 core `(0,1,6)` complete census (Terminal C)

Status: PRE-REGISTERED COMPLETE CORE-SLICE CENSUS.  This is the fifth of the
...
```text
A = [0,1,6],  B any 3-subset of Z/96Z disjoint from A.
```
