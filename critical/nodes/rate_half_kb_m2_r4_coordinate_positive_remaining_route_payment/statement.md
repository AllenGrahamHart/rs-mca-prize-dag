...
This target closes or pays the other eleven in distinct affine slopes:
...
A guarded packet on a route claimed empty, an omitted route, an incorrect
`U_remaining`, or a payment
that changes owner, unit, multiplicity, or chronology.
