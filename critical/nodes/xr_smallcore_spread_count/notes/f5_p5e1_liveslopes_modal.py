...
app = modal.App("rs-mca-f5-p5e1")
image = modal.Image.debian_slim()

# (n, q, n_random_pairs, n_engineered, seed)
ROWS = [
    (12, 97, 40, 20, 11),
    (16, 97, 30, 15, 22),
    (16, 193, 30, 15, 33),
...
def main():
    ...
    with open("/tmp/f5_p5e1.json", "w") as f:
        json.dump([r for r in out if isinstance(r, dict)], f, indent=1)
    print("\nn^3 references: 12->1728, 16->4096, 24->13824 (budget 16n^3 far above)")
