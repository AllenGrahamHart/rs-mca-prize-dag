#!/usr/bin/env python3
"""F2 campaign (Modal): STRUCT-SUBTRACTED ALIGNMENT (cycle 84) —
the honest falsifier-adjacent number, pre-registered in log #95.
...
app = modal.App("rs-mca-f2-struct-sub")
image = modal.Image.debian_slim().pip_install("numpy")

JOBS = [
    (97, 32, 2), (97, 32, 3), (113, 16, 2), (113, 16, 3),
    (193, 64, 2), (257, 64, 2), (257, 64, 3), (353, 32, 2),
    (353, 32, 3), (449, 64, 2), (577, 64, 2), (769, 64, 2),
    (1153, 64, 2),
]
...
def main():
    ...
    if fails:
        raise SystemExit(f"F2_STRUCT_SUB_FAIL ({fails})")
    print("\nF2_STRUCT_SUB_ALIGNMENT_PASS")
