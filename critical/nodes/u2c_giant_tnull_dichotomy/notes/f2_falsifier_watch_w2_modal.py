#!/usr/bin/env python3
"""F2 campaign (Modal): FALSIFIER WATCH W2 (cycle 98) — the
...
app = modal.App("rs-mca-f2-watch-w2")
image = modal.Image.debian_slim().pip_install("numpy")

JOBS = [
    (3457, 64, 2), (4993, 64, 2), (193, 32, 3), (257, 32, 3),
]
...
def main():
    ...
    if fails:
        raise SystemExit(f"F2_WATCH_W2_FAIL ({fails})")
    print("\nF2_FALSIFIER_WATCH_W2_PASS")
