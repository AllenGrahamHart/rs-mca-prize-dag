# dependency sub-DAG: e22_lower_scale_intersection_profile_counts
...
The exact intersection formula payload is proved. This node records the
assembly from a verified weighted formula certificate to the required counts.
