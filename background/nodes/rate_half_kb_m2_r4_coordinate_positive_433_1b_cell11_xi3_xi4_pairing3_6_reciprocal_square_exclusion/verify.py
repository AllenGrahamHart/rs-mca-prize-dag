#!/usr/bin/env python3
"""Verify the cell-11 xi3/xi4 pairing-3/6 exclusion packet."""
...
SCRIPT = EXP / "rate_half_kb_positive_433_1b_cell11_xi3_pairing3_template_adapter_modal.py"
RESULT = EXP / "rate_half_kb_positive_433_1b_cell11_xi3_pairing3_template_adapter_result.json"
...
PINNED = {
    SCRIPT: "cccec78e903f6a16fb2615dfe04913dfe0c82bef731cd9c591f0030c1a384dd7",
    RESULT: "d5f1909d5635efe83299ab48759fd212500888817e9b0aad8abcc21a7cd1eb74",
...
def main():
    ...
    require(
        payload["schema"]
        == "rate-half-kb-positive-433-1b-cell11-xi3-pairing3-adapter-v1"
        and payload["field"] == P
    ...
    require(totals == (48, 84, 32, 32, 0, 0, 0),
            "primary census")
    ...
    require(manifest["id"] == NODE.name and manifest["status"] == "PROVED",
            "node manifest")
    print("PASS cell-11 xi3/xi4 pairing 3/6: "
          "rows=8 candidates=84 labels=4")
