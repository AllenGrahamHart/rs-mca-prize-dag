#!/usr/bin/env python3
"""Run the direct M01-R11 Singular certificate bridge on Modal."""
...
APP_NAME = "rs-mca-k3-pr1144-m01-direct-singular-certificate"
UPSTREAM = "https://github.com/przchojecki/rs-mca.git"
COMMIT = "05ff2348de8f2c0f99683875ff12a9a79dcf21ec"
HERE = Path(__file__).resolve().parent
SCRIPT = HERE / "review_m01_direct_singular_certificate.sage"
OUTPUT = HERE / "modal_review_m01_direct_singular_certificate_output.json"
...
image = (
    ...
    .add_local_file(SCRIPT, "/review_m01_direct_singular_certificate.sage")
)
...
def review() -> dict[str, object]:
    ...
    try:
        completed = subprocess.run(
            ["sage", "/review_m01_direct_singular_certificate.sage"],
            cwd="/repo",
            env=environment,
            capture_output=True,
            text=True,
...
def main() -> None:
    row = review.remote()
    output = {
        "schema": "kb-c2-112-pr1144-m01-direct-singular-certificate-v1",
        "app": APP_NAME,
