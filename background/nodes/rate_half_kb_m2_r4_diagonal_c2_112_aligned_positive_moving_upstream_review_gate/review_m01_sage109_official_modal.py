#!/usr/bin/env python3
"""Replay PR #1144 M01-R11 in the official SageMath 10.9 image."""
...
APP_NAME = "rs-mca-k3-pr1144-m01-sage109-official-review"
...
def main() -> None:
    row = review.remote()
    output = {
        "schema": "kb-c2-112-pr1144-m01-sage109-official-review-v1",
        "app": APP_NAME,
        "upstream_commit": COMMIT,
        "purpose": "official-image replay of the conda conversion failure",
        "result": row,
    }
