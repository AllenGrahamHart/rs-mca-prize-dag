#!/usr/bin/env python3
"""Verify the cell-4 DE-missing pairing-4 48-case exclusion."""
...
PINNED = {
    SCRIPT: "86a51dc9a451980ff2f916fc7c249c7ab35c20a4a6a92d928577534df90c87c3",
    RESULT: "597c5849be2788cbac867fd89f5ae8cef5023bfead864b08c761280132923a76",
}
PARENTS = (
...
def verify_payload(payload):
    require(payload["schema"] ==
            "rate-half-kb-positive-433-1b-cell4-de-pairing4-"
...
def main():
    ...
    verify_dag()
    print(
        "cell=4 pairing=4 DE_copies=3 raw_cases=48 computed=32 "
