#!/usr/bin/env python3
"""Direct residual replay for the cell-12 positive-DE pairing-12 packet."""
...
def main():
    ...
    require(
        root_payload["schema"]
        == (
            "rate-half-kb-positive-433-1b-cell12-positive-de-pairing12-"
            "frobenius-roots-v1"
        )
    ...
    require((uf_count, lift_count, colored_count) == (1184, 96, 96),
            "direct residual census")
    print(
        "PASS positive pairing-12 adapter audit: profiles=160 unique=29 "
        "boundary=16 uf=1184 lifts=96 colored=96"
    )
