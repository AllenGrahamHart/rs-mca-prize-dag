#!/usr/bin/env python3
"""Verify the cell-3 DE-missing pairing-5 48-case exclusion."""
...
PINNED = {
    SCRIPT: "94124686398bcac7cd8a67096f161ce8a0d18b9d3436875620775df61b0e7b3f",
    RESULT: "52cb532594ade8872676dd7002ca0a8aafa27fc63d24af7f60e83c6ab928379d",
}
SIGNS = set(itertools.product((-1, 1), repeat=2))
EXPECTED_MATCHING = ((0, 2), (1, 5), (3, 4))
...
def verify_payload(payload):
    require(
        payload["schema"] ==
        "rate-half-kb-positive-433-1b-cell3-de-pairing5-"
    ...
    for row in payload["rows"]:
        ...
        require(sigma_o == -1 and row["pairing_index"] == 5,
...
def main():
    ...
    verify_dag()
    print(
        "cell=3 pairing=5 DE_copies=3 raw_cases=48 "
        "source_rows=16 lane_checks=96 witnesses=0"
    )
