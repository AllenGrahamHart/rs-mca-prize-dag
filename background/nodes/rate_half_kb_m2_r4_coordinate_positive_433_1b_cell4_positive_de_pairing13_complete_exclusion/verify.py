#!/usr/bin/env python3
"""Verify the cell-4 positive-DE pairing-13 32-case exclusion."""
...
PINNED = {
    SCRIPT: "15a714a6c6840d2914aa6934c9b97d6d8fb11dd4afe2a6a5b60ac2d98c5886ae",
    RESULT: "49504aa2f3a854fad08cc4dec93a8eda7b9cd302d14fca787cffcb81433603e6",
}
PARENTS = (
...
def verify_payload(payload):
    require(payload["schema"] ==
            "rate-half-kb-positive-433-1b-cell4-positive-de-pairing13-"
...
def main():
    ...
    verify_dag()
    print(
        "cell=4 pairing=13 positive_DE=2 raw_cases=32 computed=16 "
        "transported=16 candidates=224 source_points=320 "
        "relation_nonzero=960 colored_nonzero=128 boundaries=0 witnesses=0"
    )
