...
with the row prime ideal `P_r` fixed. In particular, the profile-`(0,18)`,
cofactor-514 occupancy is at most two, independently of the autocorrelation
profile or energy.

## Falsifier

Three distinct ideals `Q_s` in one fixed `P_r` fiber satisfying the displayed
factorization, together with the class-orbit certificate.
