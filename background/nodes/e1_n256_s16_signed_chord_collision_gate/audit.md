...
energy. The constants `102`, `21`, and `-17` are respectively a profile
...
full-conductor variance-36 witness: that vector has `D_64=8`,
`C=-38`, and `V/2=18`, satisfying (1) exactly.

No support census, Modal run, norm computation, or floating approximation is
load-bearing.
