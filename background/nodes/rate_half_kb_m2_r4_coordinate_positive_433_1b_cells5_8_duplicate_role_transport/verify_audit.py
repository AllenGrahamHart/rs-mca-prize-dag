#!/usr/bin/env python3
"""Independent role-cell and label audit for the cells 5-8 transport."""
...
def main():
    ...
    require(images == set(itertools.product(range(7), range(15))),
            "105-label bijection")
    print("audit=ok role_cell=5->8 labels=105 systems=1680")
