...
> Provenance (planner pointer, re-appended per wave convention): posed in
> the Pro inverse-flatness strategy (`notes/pro_briefs_20260801/responses/blackhole/`),
> minted by the planner 2026-08-01, harvested and dependency-hardened by
> the worker the same day (this corrected form is normative).
