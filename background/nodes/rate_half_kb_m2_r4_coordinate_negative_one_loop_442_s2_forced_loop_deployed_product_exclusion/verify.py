#!/usr/bin/env python3
"""Verify the forced-loop S2 exclusion in cubic component zero."""
...
ROOT = NODE.parents[2]
NODE_ID = "rate_half_kb_m2_r4_coordinate_negative_one_loop_442_s2_forced_loop_deployed_product_exclusion"
SOLVER_PATH = ROOT / (
...
def main():
    ...
    require("KB41S2L-1" in statement and "all sixteen" in statement
            and "from 28 to 24" in statement, "claim")
    require("does not delete an `S0`" in statement
    ...
    replay(0)
    print(
        "RATE_HALF_KB_M2_R4_COORDINATE_NEGATIVE_ONE_LOOP_442_S2_LOOP_PASS "
        "component=0 terms=7,7,7 pairs=7 unit=True S2_closed=True frontier=24"
    )
