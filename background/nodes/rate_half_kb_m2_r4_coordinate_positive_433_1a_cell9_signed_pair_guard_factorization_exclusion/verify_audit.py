#!/usr/bin/env python3
"""Mutation controls for the cell-9 guard-factorization verifier."""
...
SPEC = importlib.util.spec_from_file_location("cell9_guard_verify",
                                              NODE / "verify.py")
...
def main():
    ...
    mutation[0]["result"]["basis_size"] = 10
    ...
    mutation = copy.deepcopy(originals)
    mutation[2]["result"]["leading_exception_atlas"]["base_field_norm_roots"].pop()
    must_fail(mutation, "norm root")
    ...
    print("positive 433-1a cell-9 guard factorization audit verified")
