#!/usr/bin/env python3
"""Measure exact norms and moments for representative E=42, L=24 witnesses."""
...
app = modal.App("e1-n256-e42-witness-norm")
...
def main() -> None:
    print("E1_N256_E42_WITNESS_NORM " + repr(measure_all.remote()))
