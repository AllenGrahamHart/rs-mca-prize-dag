#!/usr/bin/env python3
"""Independently check an E=36 quotient-census packet."""
...
SOURCE = HERE / "e36_mod16_quotient_census.cpp"
RESULT = HERE / "e36_mod16_quotient_census_result.json"
PROFILES = {0: (4, 8), 1: (0, 9), 2: (13, 0)}
CAPACITIES = {
...
def main() -> None:
    ...
    assert packet["schema"] == "e1-e36-mod16-quotient-census-v1"
    ...
    print(
        "E1_E36_MOD16_QUOTIENT_CENSUS_CHECK_PASS "
