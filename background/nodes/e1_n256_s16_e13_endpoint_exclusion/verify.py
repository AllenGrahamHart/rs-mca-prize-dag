...
NODE = "e1_n256_s16_e13_endpoint_exclusion"
DEPENDENCIES = {
    "e1_n256_s16_e13_profile_parity_light_reduction",
    "e1_n256_s16_e13_four_profile_exclusion",
}
TARGETS = {"e1_official_prime_exception_control", "unsafe_crossing_family_instantiation"}
PROFILES = {"(5,2)", "(1,3)", "(4,0,1)", "(0,1,1)"}
...
def main() -> None:
    ...
    assert "0<V<=24" in nodes[NODE]["statement"]
    assert all(profile in nodes[NODE]["statement"] for profile in PROFILES)
    print("E1_N256_S16_E13_ENDPOINT_EXCLUSION_PASS profiles=4 exclusions=4 frontier=24 mutations=2")
