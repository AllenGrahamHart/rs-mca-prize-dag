#!/usr/bin/env python3
"""Independently verify the cell-4 xi3 pairing-8 exclusion."""
...
PINNED = {
    SCRIPT: "58ed9e191436e0a629d2c7a263151d50d54910d226eee4c35c0bb55abf2a1b8b",
    RESULT: "9f613211241d17a2c6ee4adfc6bc643607db5a9a4c4f7781e707ae8fb471a6e2",
...
def verify_payload(payload):
    require(
        payload["schema"] ==
        "rate-half-kb-positive-433-1b-cell4-xi3-pairing8-"
...
def main():
    ...
    verify_dag()
    print(
        "cell=4 xi=3 pairing=8 raw_cases=16 sign_lane_rows=8 candidate_r=64 "
