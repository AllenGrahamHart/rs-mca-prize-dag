#!/usr/bin/env python3
"""Run symmetric logarithmic-denominator intersections on Modal."""
...
APP_NAME = "rs-mca-k3-f04-full-j-log-denominator-intersections"
...
LOG_DERIVATIVE = ROUTE / "modal_log_derivative_j_f04_output.json"
SCRIPT = HERE / "denominator_intersection_probe.sage"
OUTPUT = HERE / "modal_denominator_intersections_output.json"
CASES = tuple(
    {"target": target, "pair_index": pair_index}
...
@app.function(image=image, cpu=2, memory=16384, timeout=600, max_containers=4)
...
def main() -> None:
    ...
    output = {
        "schema": "kb-c2-112-f04-full-j-log-denominator-intersections-modal-v1",
        "app": APP_NAME,
