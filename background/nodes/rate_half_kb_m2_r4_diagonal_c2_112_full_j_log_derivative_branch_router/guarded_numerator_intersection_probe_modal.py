#!/usr/bin/env python3
"""Run guarded logarithmic-numerator route intersections on Modal."""
...
APP_NAME = "rs-mca-k3-f04-full-j-log-guarded-numerator-intersections"
...
OUTPUT = HERE / "modal_guarded_numerator_intersections_output.json"
CASES = tuple({"target": target} for target in ("R02", "R20"))
...
@app.function(image=image, cpu=2, memory=16384, timeout=1020, max_containers=2)
...
def main() -> None:
    ...
    output = {
        "schema": "kb-c2-112-f04-full-j-log-guarded-numerator-intersections-modal-v1",
        "app": APP_NAME,
