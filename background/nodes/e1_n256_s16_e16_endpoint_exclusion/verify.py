...
NODE = "e1_n256_s16_e16_endpoint_exclusion"
DEPENDENCIES = {
    "e1_n256_s16_e16_profile_parity_light_reduction",
    "e1_n256_s16_e16_four_profile_exclusion",
}
TARGETS = {"e1_official_prime_exception_control", "unsafe_crossing_family_instantiation"}
PROFILES = {"(4,3)", "(0,4)", "(3,1,1)", "(0,0,0,1)"}
...
def main() -> None:
    ...
    assert "0<V<=30" in nodes[NODE]["statement"]
    assert all(profile in nodes[NODE]["statement"] for profile in PROFILES)
    print(
        "E1_N256_S16_E16_ENDPOINT_EXCLUSION_PASS "
        "profiles=4 exclusions=4 frontier=30 mutations=2"
    )
