...
RESULT_SHA256 = "99314fbf20e1c6935cea1ca0ca9e0fa4c142096b793a63b6f9594d40c673caaa"
PARENTS = {
...
def validate(payload, generic, roots, torus):
    ...
    return CERT.validate_exceptional("DE+", payload, generic, roots, torus)
...
def main():
    ...
    print("RATE_HALF_KB_POSITIVE_433_1B_O0B_REPEAT_BCPLUS_UNCOLORED_DE_VERIFY_PASS cases={cases} fibers={fibers} unit_endpoints={endpoint_rows} labels=240".format(**summary))
