...
def main() -> None:
    ...
    expected_refs = {
        f"background/nodes/{NODE}/statement.md",
        f"background/nodes/{NODE}/attack.md",
        f"background/nodes/{NODE}/frontier.md",
        f"background/nodes/{NODE}/claim_contract.md",
        f"background/nodes/{NODE}/verify.py",
    }
