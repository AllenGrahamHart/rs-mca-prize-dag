#!/usr/bin/env python3
"""Verify the cell-4 positive-DE pairing-9 32-case exclusion."""
...
PINNED = {
    SCRIPT: "1fa844e00b6e3d592c8ef9a478ff45cb61f15bc310842cadbc116d2134a2f05c",
    RESULT: "a523a17066e2f72e9770726ee53ea0534d899060c6fc6b3a536639a59a49b85a",
}
PARENTS = (
...
def verify_payload(payload):
    require(payload["schema"] ==
            "rate-half-kb-positive-433-1b-cell4-positive-de-pairing9-"
...
def main():
    ...
    verify_dag()
    print(
        "cell=4 pairing=9 positive_DE=2 raw_cases=32 computed=16 "
