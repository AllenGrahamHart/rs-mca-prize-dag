#!/usr/bin/env python3
"""Verify the cell-3 DE-missing pairing-11 48-case exclusion."""
...
PINNED = {
    SCRIPT: "22d9c5b90d145af836fcc38a6d21311642f4729cc80dfd2952da73337671a604",
    RESULT: "cb5587cb00b011d668ce28953992be665de9a45246a5a6ea9a4bb542942cd98c",
}
SIGNS = set(itertools.product((-1, 1), repeat=2))
EXPECTED_MATCHING = ((0, 5), (1, 2), (3, 4))
...
def verify_payload(payload):
    require(
        payload["schema"] ==
        "rate-half-kb-positive-433-1b-cell3-de-pairing11-"
    ...
    for row in payload["rows"]:
        ...
        require(sigma_o == -1 and row["pairing_index"] == 11,
...
def main():
    ...
    verify_dag()
    print(
        "cell=3 pairing=11 DE_copies=3 raw_cases=48 "
