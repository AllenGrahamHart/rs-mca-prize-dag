...
- **Claim:** exact coordinate-incidence collisions forced by the proved
  508-container rich-flat population.
- **Quantifiers:** any 508 distinct promoted containers supplied by the
  residual-mass compiler, after choosing 42453 actual zeros from each.
- **Units:** labelled evaluation coordinates and linear spans of direction
  spaces.
