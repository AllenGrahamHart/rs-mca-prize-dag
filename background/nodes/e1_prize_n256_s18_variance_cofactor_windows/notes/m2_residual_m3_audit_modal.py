#!/usr/bin/env python3
"""Folded-pair audit of the normalized m=2 third-moment frontier."""
...
SOURCE = HERE / "m2_residual_m3_audit.cpp"
OUTPUT = HERE / "m2_residual_m3_audit_result.json"
SHARDS = 32
...
app = modal.App("e1-prize-m2-residual-m3-audit")
...
def write_packet(results: list[dict[str, object]]) -> None:
    ...
    packet = {
        "schema": "e1-prize-m2-residual-m3-audit-v1",
...
def main() -> None:
    ...
    for result in audit.map(range(SHARDS), order_outputs=False):
        ...
        print(f"M2_RESIDUAL_M3_AUDIT_PROGRESS returned={len(results)}/{SHARDS}")
    print(
        "M2_RESIDUAL_M3_AUDIT "
