#!/usr/bin/env python3
"""Verify the N=256 square-mass-16 V=58 endpoint exclusion."""
...
NODE = "e1_n256_s16_e29_endpoint_exclusion"
REDUCTION = "e1_n256_s16_e29_profile_parity_light_reduction"
EXCLUSION = "e1_n256_s16_e29_eight_profile_joint_exclusion"
...
def main() -> None:
    ...
    assert "0<V<=56" in nodes[NODE]["statement"]
    assert all(profile in nodes[NODE]["statement"] for profile in PROFILES)

    print("E1_N256_S16_E29_ENDPOINT_EXCLUSION_PASS profiles=8 exclusions=8 frontier=56 mutations=4")
