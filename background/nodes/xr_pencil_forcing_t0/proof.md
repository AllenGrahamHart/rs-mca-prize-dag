...
## 6. T0-NR [R for case (b); T for the route and case (a)]
...
- **Case (b) — the cross-multiplication [R; hand-verified as a clause
  ...
  **THE RESIDUAL LIVES EXACTLY HERE.** The degree hypothesis needed is
  ...
  established**. Thus the argument proves T0-NR, not unrestricted T0.
  See `statement.md` — and note the band is EMPTY for
