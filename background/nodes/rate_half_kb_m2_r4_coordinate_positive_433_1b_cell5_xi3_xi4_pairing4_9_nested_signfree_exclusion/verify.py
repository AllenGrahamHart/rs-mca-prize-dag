#!/usr/bin/env python3
"""Verify the cell-5 xi3/xi4 pairing-4/9 exclusion packet."""
...
SCRIPT = EXP / "rate_half_kb_positive_433_1b_cell5_xi3_pairing4_template_adapter_modal.py"
RESULT = EXP / "rate_half_kb_positive_433_1b_cell5_xi3_pairing4_template_adapter_result.json"
...
PINNED = {
    SCRIPT: "cd6f1b5fec03e812fa03ec31a120d91c41650f5c195eb7f43b778bf031400686",
    RESULT: "84834df5692e9c51f7ffa3939e4c22fdd58e6b691a875bde5962ccbeabc8181a",
...
def main():
    ...
    require(
        payload["schema"]
        == "rate-half-kb-positive-433-1b-cell5-xi3-pairing4-adapter-v1"
        and payload["field"] == P
    ...
    require(totals == (40, 80, 144, 144, 24, 24, 0),
            "primary census")
    ...
    require(manifest["id"] == NODE.name and manifest["status"] == "PROVED",
            "node manifest")
    print("PASS cell-5 xi3/xi4 pairing 4/9: "
          "rows=4 candidates=80 labels=4")
