...
ledger while selecting only pairing 4 from the shared audit.

The second parses all executable sources, checks the independent root method,
checks the nested sign-free roots, 24 common `q` lifts, and 96 final colored cuts, and rejects a hostile mutation of the pairing-4
ledger.
