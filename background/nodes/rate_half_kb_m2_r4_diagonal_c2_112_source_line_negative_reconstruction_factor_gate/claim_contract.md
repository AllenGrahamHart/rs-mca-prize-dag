...
- **Claim ID:** `rate_half_kb_m2_r4_diagonal_c2_112_source_line_negative_reconstruction_factor_gate`
- **Input:** one negative-sign internal edge assignment in a classified
