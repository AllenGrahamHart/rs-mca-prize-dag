#!/usr/bin/env python3
"""Verify the cell-3 DE-missing pairing-13 48-case exclusion."""
...
NODE_ID = NODE.name
SCRIPT = EXPERIMENTS / (
    "rate_half_kb_positive_433_1b_cell3_de_pairing13_"
...
PINNED = {
    SCRIPT: "8022cf6158eb694c4559ee9425253d216144f522f435d957d53da30873d7deb8",
    RESULT: "07decaf41d0b4c450d27252584a8574a7db79f53af380940536e8ef1b9b751f0",
}
SIGNS = set(itertools.product((-1, 1), repeat=2))
EXPECTED_MATCHING = ((0, 5), (1, 3), (2, 4))
...
def verify_payload(payload):
    require(
        payload["schema"] ==
        "rate-half-kb-positive-433-1b-cell3-de-pairing13-"
    ...
    for row in payload["rows"]:
        ...
        require(row["pairing_index"] == 13, "pairing scope")
        require(
...
def main():
    ...
    verify_dag()
    print(
        "cell=3 pairing=13 DE_copies=3 raw_cases=48 "
        "source_rows=32 lane_checks=64 witnesses=0"
    )
