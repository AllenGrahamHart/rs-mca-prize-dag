#!/usr/bin/env python3
"""Direct residual replay for the cell-5 DE pairing-5 packet."""
...
def main():
    ...
    require(
        root_payload["schema"]
        == "rate-half-kb-positive-433-1b-cell5-de-pairing5-frobenius-roots-v1"
    ...
    require((uf_count, lift_count, colored_count, f_boundary_count)
            == (1424, 144, 96, 48), "direct residual census")
    print(
        "PASS pairing-5 adapter audit: profiles=320 unique=41 "
        "uf=1424 lifts=144 colored=96"
    )
