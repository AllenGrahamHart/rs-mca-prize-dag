...
| field | value |
|---|---|
| target | Exhaust every literal saturated source-line assignment through q-slice and full quotient gates. |
...
| aligned-positive proved | `36/36` cells |
| aligned-positive residual | none |
...
| affine near-positive newly closed | all six `F02` orbits: four square by unit ideals, two mixed by forbidden-collision localization |
| affine near-positive residual | `24` representatives in `F04,F06,M01,M03` |
...
| remaining frontier | 24 affine near-positive representatives; near-positive projective boundary; aligned-negative and near-negative literal coverage |
