...
2. Treat the proved `F00/F01` literal inversion as the only current
   full-system fixed-assignment transport.
...
5. For remaining cells, use the upstream quadratic `U^2-VZ` split and retain
   the `V=0` rank-drop branch.
