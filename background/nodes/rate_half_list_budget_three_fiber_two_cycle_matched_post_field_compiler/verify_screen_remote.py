"""Remote launcher registration for the HARMONIC_TOP Modal screen (w17-C1 ruling).
...
must be re-pinned afterwards. Original run: Modal app ap-PVTrzkKlh4j1B6qDmGU1Wf, 0 hits.
"""
import subprocess
import sys
...
LAUNCHER = ROOT / "experiments/prize_resolution" / "rate_half_list_fiber_two_cycle_harmonic_top_characteristic_modal.py"
