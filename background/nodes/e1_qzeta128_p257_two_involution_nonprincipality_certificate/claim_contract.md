...
`e1_qzeta128_p257_j63_fixed_field_nonprincipality_certificate` proves
...
in the degree-32 fixed field of `sigma_63`, using the explicit Jacobi-sum
residue obstruction. The proof in `proof.md` transfers that certificate to
`J_63`.
...
- The published `359057,29301` ledger is evidence, not the remaining
  certificate.
- Neither half alone is sufficient for the two-involution reduction.
