...
Fix source signs and a target lane. On the proved cell-12 four-basis tower,
...
```text
R(u,f)=(u^2+de*f^2)^2-S*f^2*u^2=0.                (RS12-DE9)
```
...
has 336 case-labeled candidates and lifts to 608 guarded source points. Of
1,056 Cartesian `(u,f)` rows, 992 fail (RS12-DE9). The other 64 reconstruct
...
An external compiled Frobenius/gcd pass reconstructs all roots of the 29
...
and directly replays all 1,056 `(u,f)` rows.
