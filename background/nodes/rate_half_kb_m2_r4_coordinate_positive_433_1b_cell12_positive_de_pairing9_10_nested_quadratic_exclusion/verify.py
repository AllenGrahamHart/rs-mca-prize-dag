#!/usr/bin/env python3
"""Verify the cell-12 positive-DE pairing-9/10 packet."""
...
SCRIPT = EXP / (
    "rate_half_kb_positive_433_1b_cell12_positive_de_pairing9_"
...
PINNED = {
    SCRIPT: "898b63f79978511dca851fb0524e83c252c757b1a91ceceeb912effcc22ba146",
    RESULT: "396459049373c85222cb36e522896a0739c9af407e68c6ec690e0fb7f5b4245a",
    TEMPLATE: "1fa844e00b6e3d592c8ef9a478ff45cb61f15bc310842cadbc116d2134a2f05c",
    ROOT_SCRIPT: "23eff7ab259c1508df82eed18adad6c754096aea0d636058c6ed1308efc84394",
    ROOT_RESULT: "8926ee6b1cb910b32c6d14545f329ee03056ef3f290eccfa4f8d40a770ed619a",
}
P = 2130706433
...
def main():
    ...
    require(
        payload["schema"]
        == "rate-half-kb-positive-433-1b-cell12-positive-de-pairing9-adapter-v1"
        and payload["field"] == P
    ...
    require(totals == (224, 336, 608, 608, 64, 0), "exact totals")
    ...
    require(endings == {"MISSING_RELATION_NONZERO": 992,
                        "COLORED_PAIR_NONZERO": 64}, "1056 final uf rows")
    require(
    ...
    print("PASS cell-12 positive-DE pairing 9/10: rows=16 candidates=336 uf=1056")
