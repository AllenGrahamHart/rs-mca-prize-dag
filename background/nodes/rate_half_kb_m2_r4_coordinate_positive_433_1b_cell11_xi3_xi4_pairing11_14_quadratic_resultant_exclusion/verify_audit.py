#!/usr/bin/env python3
"""Independent root and direct-lane audit for cell-11 pairing 11/14."""
...
def main():
    ...
    require(len(profiles) == 49, "pairing-specific polynomial census")
    ...
    require(
        ...
        and root_payload["source_primary_sha256"]["11"]
    ...
    require(lift_count == 16 and lane_count == 32,
            "direct lift/lane census")
    print(
        "PASS pairing-11 adapter audit: "
        "profiles=112 unique=49 boundary=16 lifts=16 lanes=32"
    )
