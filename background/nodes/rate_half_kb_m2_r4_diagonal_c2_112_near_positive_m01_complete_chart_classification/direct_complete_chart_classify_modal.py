#!/usr/bin/env python3
"""Run complete-chart M01 residual classifiers on Modal."""
...
app = modal.App("rs-mca-k3-near-positive-m01-complete-chart")
image = (
...
def main() -> None:
    ...
    output = {
        "schema": "kb-c2-112-near-positive-m01-complete-chart-modal-v1",
        "results": results,
    }
