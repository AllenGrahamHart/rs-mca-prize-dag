#!/usr/bin/env python3
"""Direct residual replay for the cell-11 DE pairing-4 packet."""
...
def main():
    ...
    require(
        root_payload["schema"]
        == "rate-half-kb-positive-433-1b-cell11-de-pairing4-frobenius-roots-v1"
    ...
    print(
        "PASS pairing-4 adapter audit: profiles=320 unique=41 "
