#!/usr/bin/env python3
"""Verify the reciprocal-xi mixed contract and primary certificate."""
...
HELPER = (ROOT / "critical/nodes/rate_half_band_closure/notes/"
          "kb_c2_112_near_tau_xi_mixed.py")
UTILITY = (ROOT / "critical/nodes/rate_half_band_closure/notes/"
           "kb_c2_112_near_fixed_xi_square_direct.py")
EXPECTED = "f27e5658f215bc15c7b13f026ef73f4318dff3cfa5e1495d66b8907712baa883"
...
if "- **status:** PROVED" not in statement or "other 14 affine" not in statement:
