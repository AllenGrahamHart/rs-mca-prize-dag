#!/usr/bin/env python3
"""Independently verify the cell-4 xi3 pairing-7 exclusion."""
...
PINNED = {
    SCRIPT: "ed5c0a3883180e43e2f380fc76971a4a645fe0260679ed27374cd2bfc844d2df",
    RESULT: "e82a21d9af048a8c933951a9cd9199252a7236b8b7b5ba8facddf08cc12df98e",
...
def verify_payload(payload):
    require(
        payload["schema"] ==
        "rate-half-kb-positive-433-1b-cell4-xi3-pairing7-"
...
def main():
    ...
    require((rows, raw_cases, lane_checks) == (8, 16, 32), "scope accounting")
    verify_dag()
    print(
        "cell=4 xi=3 pairing=7 raw_cases=16 sign_lane_rows=8 candidate_r=64 "
        "source_points=32 z=16 q=16 lane_checks=32 witnesses=0"
    )
