#!/usr/bin/env python3
"""Audit cell-4 xi3 pairing-7 quadratic-resultant sign-free exclusion."""
...
def main():
    ...
    require("two matching-exchange pairs" in frontier, "retained frontier")
    print(
        "audit=ok cell=4 xi=3 pairing=7 sign_lane_rows=8 "
