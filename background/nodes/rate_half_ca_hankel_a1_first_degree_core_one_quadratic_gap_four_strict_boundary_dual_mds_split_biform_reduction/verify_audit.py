#!/usr/bin/env python3
"""Finite-field audit of the strict-boundary dual-GRS representation."""
...
# The next domain degree fails at the top moment, pinning p-2 sharply.
tamper = [0] * (MAX_DUAL_DEGREE + 1) + [1]
assert moment(tamper, D) == 1

# A clean fiber is represented by its p-2 inside roots.
...
print("RATE_HALF_QUADRATIC_STRICT_BOUNDARY_DUAL_MDS_BIFORM_AUDIT_PASS")
