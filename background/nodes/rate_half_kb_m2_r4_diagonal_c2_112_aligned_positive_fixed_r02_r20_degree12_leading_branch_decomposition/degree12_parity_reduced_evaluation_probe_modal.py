#!/usr/bin/env python3
"""Run parity-reduced degree-12 evaluations on Modal."""
...
image = (
    ...
    .add_local_file(SCRIPT, "/degree12_parity_reduced_evaluation_probe.sage")
)
...
def main() -> None:
    ...
    output = {
        "schema": "kb-c2-112-fixed-degree12-parity-modal-v1",
        "app": APP_NAME,
        "mode": MODE,
