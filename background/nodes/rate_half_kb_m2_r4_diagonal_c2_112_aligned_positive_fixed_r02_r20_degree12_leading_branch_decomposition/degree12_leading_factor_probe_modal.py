#!/usr/bin/env python3
"""Run initial leading-factor probes for the degree-12 route on Modal."""
...
APP_NAME = "rs-mca-k3-f04-degree12-leading-factors"
...
SCRIPT = HERE / "degree12_leading_factor_probe.sage"
OUTPUT = HERE / "modal_degree12_leading_factors_output.json"
...
image = (
    ...
    .add_local_file(SCRIPT, "/degree12_leading_factor_probe.sage")
)
...
def run_case(case: dict[str, object]) -> dict[str, object]:
    ...
    command = ["sage", "/degree12_leading_factor_probe.sage", "--cell", str(case["cell"])]
    try:
...
def main() -> None:
    ...
    output = {
        "schema": "kb-c2-112-f04-degree12-leading-factors-modal-v1",
        "app": APP_NAME,
