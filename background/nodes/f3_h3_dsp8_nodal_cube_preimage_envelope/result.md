...
All singular trace branches combine into one shifted intersection of the
cube-preimage subgroup. The resulting raw nodal DSP8 envelope is

```text
<552n^2   for p=2 (mod 3),
<2387n^2  for p=1 (mod 3),
```
