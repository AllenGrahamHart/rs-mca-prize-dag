#!/usr/bin/env python3
"""Verify the cell-4 pairing-8/13 DE orbit composition."""
...
PAIRING8 = (
    ...
    "cell4_de_pairing8_complete_exclusion"
)
QUOTIENT = (
    "rate_half_kb_m2_r4_coordinate_positive_433_1b_"
...
PREVIOUS = (
    "rate_half_kb_m2_r4_coordinate_positive_433_1b_"
    "cell4_de_pairing7_10_complete_exclusion"
)
...
def verify_composition():
    ...
    require(len(previous) == 33 and len(previous_orbits) == 18,
    ...
    require(new_orbits == {
        frozenset(((0, 8), (1, 8))),
        frozenset(((2, 8), (2, 13))),
    } and new_labels == {(0, 8), (1, 8), (2, 8), (2, 13)},
            "honest pairing-8/13 orbit closure")
    require((0, 13) not in new_labels and (1, 13) not in new_labels,
            "positive pairing-13 scope fence")
    ...
    require(len(paid) == 37 and len(paid_orbits) == 20 and
            sum(map(len, paid_orbits)) == 37,
            "aggregate paid ledger")
    require(len(live_orbits) == 40 and sum(map(len, live_orbits)) == 68,
...
def verify_documents():
    ...
    require("= 64 raw cases" in compact_statement and
            "68 labels in 40 quotient orbits" in compact_statement,
            "printed aggregate")
    require("105-37 = 68" in proof and "60-20 = 40" in proof,
            "ledger subtraction")
    require("`(0,13)` and `(1,13)`" in frontier and
...
def main():
    ...
    print(
        ...
        "paid_labels=37 live_labels=68 live_orbits=40"
    )
