#!/usr/bin/env python3
"""Independent role-cell and label audit for the cells 12-13 transport."""
...
def main():
    ...
    require("premise" in statement and "remains open" in statement,
            "conditional scope")
    print("audit=ok role_cell=12->13 labels=105 systems=1680")
