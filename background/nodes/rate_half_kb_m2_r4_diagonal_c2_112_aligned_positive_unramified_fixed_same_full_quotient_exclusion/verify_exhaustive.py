#!/usr/bin/env python3
"""Regenerate the exhaustive fixed-same direct-component certificate."""
...
with tempfile.TemporaryDirectory() as directory:
    ...
    marker = "SURVIVOR_CERTIFICATE_PASS allocation=same count=4"
...
print(
    ...
    "EXHAUSTIVE_PASS norm_factors=28 survivors=4 certificate_match=true"
)
