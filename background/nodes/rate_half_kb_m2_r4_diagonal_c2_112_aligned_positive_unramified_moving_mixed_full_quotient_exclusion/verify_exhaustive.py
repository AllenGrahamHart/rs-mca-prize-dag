#!/usr/bin/env python3
"""Regenerate the exhaustive moving-mixed direct-component certificate."""
...
with tempfile.TemporaryDirectory() as directory:
    ...
    marker = "DIRECT_COMPONENT_SURVIVORS_PASS allocation=mixed count=4"
...
print(
    ...
    "EXHAUSTIVE_PASS norm_factors=38 survivors=4 certificate_match=true"
)
