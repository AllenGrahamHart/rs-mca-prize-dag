...
| open residue | Components of the bounded system, the actual Frobenius/cyclotomic tests, and any inner lift. |
| excluded scope | Order zero, lower `h`, `m=4,h=2`, wider widths, and full L1. |
