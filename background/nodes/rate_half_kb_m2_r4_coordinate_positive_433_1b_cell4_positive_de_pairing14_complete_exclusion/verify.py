#!/usr/bin/env python3
"""Independently verify the cell-4 positive-DE pairing-14 exclusion."""
...
PINNED = {
    SCRIPT: "d46de7b84de40e9be7902d9c26e51df8b2e9fd99e7d208e78fc110338feb406a",
    RESULT: "b1333d996324313bcb630ae35e6d31c05f74d07ffeb3fbc383da90413f419bcb",
}
PARENTS = (
...
def verify_payload(payload):
    require(payload["schema"] ==
            "rate-half-kb-positive-433-1b-cell4-positive-de-pairing14-"
    ...
    require(collections.Counter(candidate_counts) == {9: 8, 10: 8},
            "candidate-root census")
    require(collections.Counter(source_counts) == {4: 8, 6: 8},
            "source-point census")
    require(collections.Counter(uf_counts) == {8: 16},
            "uf-candidate census")
    require(collections.Counter(target_root_counts) == {7: 8, 8: 8},
            "target-root census")
    require(sum(candidate_counts) == 152 and sum(source_counts) == 80 and
            sum(uf_counts) == 128 and sum(target_root_counts) == 120 and
            aggregate == {
                "relation_nonzero": 0,
                "colored_nonzero": 128,
                "target_boundaries": 0,
    ...
    require(norm_shapes == {
        (0, 1078, 949, 504, 505): 8,
        (0, 1082, 957, 504, 505): 8,
...
def main():
    ...
    verify_dag()
    print(
        "cell=4 pairing=14 positive_DE=2 raw_cases=32 computed=16 "
        "transported=16 candidates=152 source_points=80 "
        "quartic_candidates=128 colored_nonzero=128 boundaries=0 witnesses=0"
    )
