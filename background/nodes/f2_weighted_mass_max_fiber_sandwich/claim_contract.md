...
- **claim:** the exact sandwich `M^2/2^m <= Z <= M` and the lossless
  implication from a normalized max-fiber estimate to a mass estimate;
- **scope:** every finite prime field, every finite-dimensional linear
