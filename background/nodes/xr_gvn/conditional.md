...
Apply the exchange move used in `averaged_xr`. The predicate supplies the
...
energy to be large. This is exactly the generalized von Neumann reduction
claimed by the XR stage-1 node, conditional on the averaged XR input.
