#!/usr/bin/env python3
"""Hostile controls for the uncolored EF exclusion."""
...
SPEC = importlib.util.spec_from_file_location("ef_verify", NODE / "verify.py")
...
def main():
    ...
    print("PASS uncolored EF hostile audit: 4/4")
