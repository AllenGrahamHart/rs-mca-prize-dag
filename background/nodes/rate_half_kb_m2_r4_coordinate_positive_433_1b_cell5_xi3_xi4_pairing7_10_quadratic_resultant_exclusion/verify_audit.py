#!/usr/bin/env python3
"""Independent root and direct-lane audit for cell-5 pairing 7/10."""
...
SCRIPT = EXP / (
    "rate_half_kb_positive_433_1b_cell5_xi3_pairing7_"
...
def main():
    ...
    require(
        root_payload["schema"]
        == (
            "rate-half-kb-positive-433-1b-cell5-xi3-pairing7-"
    ...
    require(lift_count == 8 and lane_count == 16, "direct lift/lane census")
    print(
        "PASS pairing-7 adapter audit: "
        "profiles=112 unique=45 boundary=0 lifts=8 lanes=16"
    )
