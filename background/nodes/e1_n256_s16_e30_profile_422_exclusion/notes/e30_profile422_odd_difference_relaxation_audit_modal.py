#!/usr/bin/env python3
"""Run the independent profile-(4,2,2) odd-difference relaxation."""
...
SOURCE = HERE / "e30_profile422_odd_difference_relaxation_audit.cpp"
PRODUCTION = HERE / "e30_profile422_odd_difference_relaxation_result.json"
RESULT = HERE / "e30_profile422_odd_difference_relaxation_audit_result.json"
REMOTE_SOURCE = "/root/e30_profile422_odd_difference_relaxation_audit.cpp"
REMOTE_BINARY = "/root/e30_profile422_odd_difference_relaxation_audit"
SHARDS = 4

app = modal.App("e1-n256-e30-profile422-odd-difference-relaxation-audit")
image = (
...
def main() -> None:
    ...
    def write_checkpoint(complete: bool) -> dict[str, object]:
        ...
        packet = {
            "schema": "e1-e30-profile422-odd-difference-relaxation-audit-v1",
            "complete": complete,
    ...
    try:
        ...
        print(f"E30_PROFILE422_ODD_DIFFERENCE_AUDIT_INCOMPLETE completed={len(rows)}/{SHARDS}")
        raise
    complete = (
        len(rows) == SHARDS
    ...
    print("E30_PROFILE422_ODD_DIFFERENCE_AUDIT " + json.dumps(packet["summary"], sort_keys=True))
    print(f"E30_PROFILE422_ODD_DIFFERENCE_AUDIT_COMPLETE {complete}")
    print(f"E30_PROFILE422_ODD_DIFFERENCE_AUDIT_RESULT {RESULT}")
