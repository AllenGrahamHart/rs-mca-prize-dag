#!/usr/bin/env python3
"""Audit positive-DE pairing-10 signs, scope, and aggregate terminals."""
...
def main():
    ...
    require(pairs == (("de", "bf"), ("-de", "sigma_o*ef"),
                      ("df", "sigma_c*cf")),
            "signed matching-10 pairs")
    payload = json.loads(RESULT.read_text())
    rows = payload["rows"]
    require(len(rows) == 16 and all(
        row["xi_index"] == 0 and row["pairing_index"] == 10 and
