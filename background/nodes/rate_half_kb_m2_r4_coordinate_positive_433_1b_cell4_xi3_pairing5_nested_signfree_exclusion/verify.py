#!/usr/bin/env python3
"""Independently verify the cell-4 xi3 pairing-5 exclusion."""
...
PINNED = {
    SCRIPT: "f1dd2096b7dfb7cf6a4a784ae04ef5a0fbd8b6e91f5bfa21bd584d990625f342",
    RESULT: "73228767600f8a7f6afdcd5a9724ca72bd81ff5ae95fa5dad8f368553424c6e5",
...
def verify_payload(payload):
    ...
    require(
        sum(row["candidate_root_count"] for row in payload["rows"]) == 104
        and sum(row["source_point_count"] for row in payload["rows"]) == 128
...
def main():
    ...
    require((rows, raw_cases, lane_checks) == (8, 16, 64), "scope accounting")
    verify_dag()
    print(
        "cell=4 xi=3 pairing=5 raw_cases=16 sign_lane_rows=8 candidate_r=104 "
        "source_points=128 z=32 q=32 lane_checks=64 witnesses=0"
    )
