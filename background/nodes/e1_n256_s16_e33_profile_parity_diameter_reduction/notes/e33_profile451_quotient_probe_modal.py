#!/usr/bin/env python3
"""Run the E33 profile-(4,5,1) mod-16 quotient allocation probe."""
...
SOURCE = HERE / "e33_profile451_quotient_census.cpp"
REMOTE_SOURCE = "/root/e33_profile451_quotient.cpp"
REMOTE_BASE_SOURCE = "/root/e34_nested_quotient_census.cpp"
REMOTE_BINARY = "/root/e33_profile451_quotient"
SHARDS = 16

app = modal.App("e1-n256-e33-profile451-quotient-probe")
image = (
    ...
    .run_commands(
        f"g++ -O3 -std=c++17 {REMOTE_SOURCE} -o {REMOTE_BINARY}",
    )
)
...
def main() -> None:
    ...
    print("E33_PROFILE451_QUOTIENT_PROBE " + json.dumps(summary, sort_keys=True))
    print("E33_PROFILE451_QUOTIENT_ROWS " + json.dumps(results, sort_keys=True))
