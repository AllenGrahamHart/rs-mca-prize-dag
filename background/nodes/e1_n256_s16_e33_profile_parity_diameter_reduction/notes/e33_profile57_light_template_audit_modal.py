#!/usr/bin/env python3
"""Independent ordered-negacyclic audit for E33 profile (5,7)."""
...
SOURCE = HERE / "e33_profile57_light_template_audit.cpp"
RESULT = HERE / "e33_profile57_light_template_audit_result.json"
REMOTE_SOURCE = "/root/e33_profile57_light_template_audit.cpp"
REMOTE_BINARY = "/root/e33_profile57_light_template_audit"
TEMPLATES = 100

app = modal.App("e1-n256-e33-profile57-light-template-audit")
image = (
...
def write_checkpoint(rows: list[dict[str, object]], errors: list[dict[str, object]]) -> None:
    packet = {
        "schema": "e1-e33-profile57-light-template-audit-v1",
...
def main() -> None:
    ...
    summary = {
        ...
        "maximum_m3": max((int(row["maximum_m3"]) for row in rows), default=-1),
    ...
    print("E33_PROFILE57_LIGHT_TEMPLATE_AUDIT " + json.dumps(summary, sort_keys=True))
    print(f"E33_PROFILE57_LIGHT_TEMPLATE_AUDIT_RESULT {RESULT}")
