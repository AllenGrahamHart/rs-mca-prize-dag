...
RESULT_SHA256 = "921f8a76d5b426617e6a6d437bd14e26092f29dd902eb6c5f6502b21c3707315"
PARENTS = {
...
def validate(payload, generic, roots, lifts):
    ...
    return CERT.validate_exceptional("DF+", payload, generic, roots, lifts)
...
def main():
    ...
    print("RATE_HALF_KB_POSITIVE_433_1B_O0B_REPEAT_BCMINUS_UNCOLORED_DF_VERIFY_PASS cases={cases} fibers={fibers} unit_endpoints={endpoint_rows} labels=240".format(**summary))
