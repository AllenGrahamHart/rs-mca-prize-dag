#!/usr/bin/env python3
"""Verify the cell-4 DE-missing pairing-8 48-case exclusion."""
...
PINNED = {
    SCRIPT: "31255c599952ea86dffbc35cb5713b4bd40ca4d40ac494f960bce11e194d525d",
    RESULT: "d524aaf3b05b0e89403d342ca92da77b5323755ae1b90bc0085d5f23a392dad0",
}
PARENTS = (
...
def verify_payload(payload):
    require(payload["schema"] ==
            "rate-half-kb-positive-433-1b-cell4-de-pairing8-"
...
def main():
    ...
    verify_dag()
    print(
        "cell=4 pairing=8 DE_copies=3 raw_cases=48 computed=32 "
