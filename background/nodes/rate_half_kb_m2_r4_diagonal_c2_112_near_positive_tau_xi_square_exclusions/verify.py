#!/usr/bin/env python3
"""Verify the reciprocal-xi square contract and direct pair (0,0)."""
...
HELPER = (ROOT / "critical/nodes/rate_half_band_closure/notes/"
          "kb_c2_112_near_tau_xi_square_direct.py")
...
if "- **status:** PROVED" not in statement or "other 12 affine" not in statement:
