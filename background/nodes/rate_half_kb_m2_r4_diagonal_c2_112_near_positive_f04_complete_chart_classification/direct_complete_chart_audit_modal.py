#!/usr/bin/env python3
"""Run independent complete-chart F04 audits on Modal."""
...
app = modal.App("rs-mca-k3-near-positive-f04-complete-chart-audit")
image = (
...
def main() -> None:
    ...
    output = {
        "schema": "kb-c2-112-near-positive-f04-complete-chart-audit-modal-v1",
        "results": results,
    }
