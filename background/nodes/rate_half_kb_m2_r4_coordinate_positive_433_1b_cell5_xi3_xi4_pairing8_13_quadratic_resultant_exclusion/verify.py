#!/usr/bin/env python3
"""Verify the cell-5 xi3/xi4 pairing-8/13 quadratic-resultant packet."""
...
SCRIPT = EXP / "rate_half_kb_positive_433_1b_cell5_xi3_pairing8_template_adapter_modal.py"
RESULT = EXP / "rate_half_kb_positive_433_1b_cell5_xi3_pairing8_template_adapter_result.json"
...
ROOT_SCRIPT = EXP / "rate_half_kb_positive_433_1b_cell5_xi3_pairing8_independent_roots_modal.py"
ROOT_RESULT = EXP / "rate_half_kb_positive_433_1b_cell5_xi3_pairing8_independent_roots_result.json"
ROUTER = EXP / "rate_half_kb_positive_433_1b_universal_generic_label_orbit_router.py"
PINNED = {
    SCRIPT: "282351f1c69e494ed474958f2d2f0c6cbc148ca4dce68aa2f653f4035a7a050b",
    RESULT: "53e7e44e0e19b37e76e4f66eb1ce43fde3091927b396d0729b6a6d08d4482c13",
    ...
    ROOT_SCRIPT: "9390914055080478aa59ad1de84c5b0531ae1224e95dd2975350a04207371273",
    ROOT_RESULT: "d250e8893011cdb3f89ec4156b471dda003f99bfabbaf4df17384051dcfc1b57",
...
def main():
    ...
    require(
        payload["schema"]
        == "rate-half-kb-positive-433-1b-cell5-xi3-pairing8-adapter-v1"
        and payload["field"] == P
    ...
    require(
        roots["schema"]
        == "rate-half-kb-positive-433-1b-cell5-xi3-pairing8-independent-roots-v1"
        and roots["field"] == P
    ...
    require(manifest["id"] == NODE.name and manifest["status"] == "PROVED",
            "node manifest")
    print("PASS cell-5 xi3/xi4 pairing 8/13: "
