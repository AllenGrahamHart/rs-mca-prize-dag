#!/usr/bin/env python3
"""Verify the cell-3 BC+ uncolored DF residual exclusion."""
...
RESULT = E / f"{PREFIX}uncolored_exceptional_DFplus_result.json"
...
RESULT_SHA256 = "1cf9d55db8e263d3aa2ece86b72602fb50330d7894b4bd1b3b7d33c1c03f21ca"
PARENTS = {
    "rate_half_kb_m2_r4_coordinate_positive_433_1b_o0b_common_repeat_cell3_bcplus_uncolored_guard_root_atlas",
...
def validate(payload, generic, roots, torus):
    ...
    return CERT.validate_exceptional("DF+", payload, generic, roots, torus)
...
def main():
    ...
    print("RATE_HALF_KB_POSITIVE_433_1B_O0B_REPEAT_BCPLUS_UNCOLORED_DF_VERIFY_PASS cases={cases} fibers={fibers} unit_endpoints={endpoint_rows} labels=240".format(**summary))
