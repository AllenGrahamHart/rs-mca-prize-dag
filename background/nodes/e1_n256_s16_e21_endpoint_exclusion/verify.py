...
NODE="e1_n256_s16_e21_endpoint_exclusion"
DEPENDENCIES={"e1_n256_s16_e21_profile_parity_light_reduction","e1_n256_s16_e21_seven_profile_exclusion"}
TARGETS={"e1_official_prime_exception_control","unsafe_crossing_family_instantiation"}
PROFILES={"(5,4)","(1,5)","(4,2,1)","(0,3,1)","(3,0,2)","(5,0,0,1)","(1,1,0,1)"}
def main()->None:
    ...
    assert "0<V<=40" in nodes[NODE]["statement"] and all(p in nodes[NODE]["statement"] for p in PROFILES)
    print("E1_N256_S16_E21_ENDPOINT_EXCLUSION_PASS profiles=7 exclusions=7 frontier=40 mutations=2")
