...
`eta_3,eta_5,...,eta_127`. A regulator, minimum-log-vector, certified lattice
enumeration, or sparse-product theorem is still needed before this body
yields a numeric orbit cap.
...
The next theorem must count the integer circular-unit exponent vectors whose
products satisfy the sparse profile, or derive a height/packing inequality
that charges their full profile weight in the weighted-kernel ledger.
