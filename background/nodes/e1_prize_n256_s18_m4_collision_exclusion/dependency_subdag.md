...
e1_prize_n256_s18_m4_collision_exclusion [PROVED]
...
The evidence edges do not close the targets because cofactor `m=2` and the
aggregate weighted pair accounting remain open.
