#!/usr/bin/env python3
"""Direct residual replay for the cell-5 DE pairing-4 packet."""
...
def main():
    ...
    require(
        root_payload["schema"]
        == "rate-half-kb-positive-433-1b-cell5-de-pairing4-frobenius-roots-v1"
    ...
    require((uf_count, lift_count, colored_count, f_boundary_count)
            == (1552, 176, 128, 48), "direct residual census")
    print(
        "PASS pairing-4 adapter audit: profiles=320 unique=41 "
        "uf=1552 lifts=176 colored=128"
    )
