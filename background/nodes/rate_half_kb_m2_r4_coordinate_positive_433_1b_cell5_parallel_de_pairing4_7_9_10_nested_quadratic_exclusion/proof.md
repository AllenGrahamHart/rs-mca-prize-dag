...
```text
R(u,f)=(u^2+eta*de*f^2)^2-S*f^2*u^2=0.            (RS5-DE4)
```
...
union has 560 case-labeled candidates and lifts to 832 guarded source
points. There are 176 compatible `(u,f)` rows satisfying (RS5-DE4): 48
...
and directly replays all 1,552 `(u,f)` rows and all 176 zero-relation lifts.
