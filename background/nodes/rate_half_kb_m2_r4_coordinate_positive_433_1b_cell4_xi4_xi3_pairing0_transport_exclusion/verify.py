#!/usr/bin/env python3
"""Verify the cell-4 xi4 pairing-0 transport corollary."""
...
def main():
    ...
    require("role-cell-4" in direct_statement and "matching index `0`" in direct_statement,
            "direct-parent scope")
    ...
    require("4 source signs * 4 target lanes = 16" in statement,
            "statement payment")
    require("matching 0 maps to matching 0" in proof,
            "matching-index preservation")
    print("cell=4 xi=4 pairing=0 transport=exact raw_cases=16")
