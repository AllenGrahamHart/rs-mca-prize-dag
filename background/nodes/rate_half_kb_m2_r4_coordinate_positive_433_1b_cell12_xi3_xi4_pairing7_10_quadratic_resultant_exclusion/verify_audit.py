#!/usr/bin/env python3
"""Independent root and direct-lane audit for cell-12 pairing 7/10."""
...
def main():
    ...
    require(
        root_payload["schema"]
        == (
            "rate-half-kb-positive-433-1b-cell12-xi3-pairing7-"
    ...
    print(
        ...
        "profiles=112 unique=41 boundary=8 lifts=16 lanes=32"
    )
