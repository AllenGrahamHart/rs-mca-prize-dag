"""Remote launcher registration for the ANTIINVARIANT Modal screen (w17-C1 ruling).
...
must be re-pinned afterwards. Original run: Modal app ap-6KQ2mJjoE3Qkq7VaKqnxlZ, 0 hits.
"""
import subprocess
import sys
...
LAUNCHER = ROOT / "experiments/prize_resolution" / "rate_half_list_fiber_two_cycle_c1_parity_antiinvariant_characteristic_modal.py"
