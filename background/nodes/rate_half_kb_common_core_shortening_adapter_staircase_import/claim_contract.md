...
1. The same-record common-core cancellation adapter
   `(n,k,m) -> (n-c,k-c,m-c)` with all six clauses (quotient degrees,
   maximal-support restriction, witness-through-core existence,
...
S/A/E closure; KoalaBear row closure; any LIST or universal four-rate
statement; any K3 allocation; any first-match ledger regeneration.

**Falsifier:** a common-core record whose adapter image violates any
clause (e.g. a size-`(m-c)` pair-contained image of a noncontained
witness through `C`), or an exact-arithmetic error in any displayed
wall constant.
