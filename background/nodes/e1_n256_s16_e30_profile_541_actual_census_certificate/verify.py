#!/usr/bin/env python3
"""Verify the profile-(5,4,1) actual-vector census child."""
...
NODE = "e1_n256_s16_e30_profile_541_actual_census_certificate"
DEPENDENCY = "e1_n256_s16_e30_profile_541_relaxation_certificate"
PARENT = ROOT / "background/nodes/e1_n256_s16_e30_profile_541_exclusion"


def load_parent():
    spec = importlib.util.spec_from_file_location("e30_profile541_parent_actual", PARENT / "verify.py")
...
def main() -> None:
    ...
    print("E1_E30_PROFILE541_ACTUAL_CENSUS_CERTIFICATE_PASS templates=321 vectors=6371187456 profile=45846 exceptional=440 primitive=86")
