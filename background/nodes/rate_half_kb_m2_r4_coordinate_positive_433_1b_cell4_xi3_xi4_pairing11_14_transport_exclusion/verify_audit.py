#!/usr/bin/env python3
"""Audit the scope composition for cell-4 xi3/xi4 pairings 11/14."""
...
def main():
    ...
    require({direct["status"], xi_transport["status"],
            ...
            "all parents proved")
    require("pairing-11 exclusion" in direct["closure"],
    ...
    require("105/105" in result and "cell-4 labels live           0" in result,
            "updated cell-4 ledger")
    require("No cell-4 matching-exchange pair remains" in frontier,
            "closed frontier")
    require("four labels" in audit and "4*4" in audit,
            "label multiplicity discipline")
    print("audit=ok cell=4 xi=3,4 pairings=11,14 raw_cases=64 parents=3")
