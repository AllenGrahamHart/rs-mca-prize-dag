#!/usr/bin/env sage
"""Independent one-step Rabinowitsch audit for the two F02 mixed cells."""
...
compiled = {
    "schema": "kb-c2-112-near-positive-f02-mixed-collision-audit-v1",
    "cell": cell,
...
print("F02_MIXED_COLLISION_AUDIT_JSON " + json.dumps(
