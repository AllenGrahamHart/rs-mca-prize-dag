#!/usr/bin/env python3
"""Cross-audit the two cell-9 first-pair residual ledgers."""
...
def totals(payload, independent):
    ...
    require((systems, units) == (288, 288), "terminal totals")
...
def main():
    ...
    require("other 20 active" in contract and "Prize closure" in contract,
            "scope markers")
    print("PASS cell-9 first-pair audit: primary=288 audit=288 hostile=detected")
