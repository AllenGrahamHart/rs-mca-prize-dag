...
has 304 case-labeled candidates and lifts to 576 guarded source points. Of
1,056 Cartesian `(u,f)` rows, 960 fail (RS12-DE12). The other 96
...
An external compiled Frobenius/gcd pass reconstructs all roots of the 33
...
profile and directly replays all 1,056 `(u,f)` rows.
