#!/usr/bin/env python3
"""Direct residual replay for the cell-5 positive-DE pairing-12 packet."""
...
def main():
    ...
    require(leading_boundaries == 0, "leading-boundary count")
    require((uf_count, lift_count, colored_count) == (1056, 96, 96),
            "direct residual census")
    print(
        "PASS positive pairing-12 adapter audit: profiles=160 unique=33 "
        "boundary=0 uf=1056 lifts=96 colored=96"
    )
