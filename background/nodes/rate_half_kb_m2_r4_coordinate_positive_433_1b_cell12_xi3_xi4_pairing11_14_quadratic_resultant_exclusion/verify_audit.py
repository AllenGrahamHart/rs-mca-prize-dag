#!/usr/bin/env python3
"""Independent root and direct-lane audit for cell-12 pairing 11/14."""
...
def main():
    ...
    require(
        root_payload["schema"]
        == (
            "rate-half-kb-positive-433-1b-cell12-xi3-pairing11-"
    ...
    print(
        ...
        "profiles=112 unique=45 boundary=8 lifts=16 lanes=32"
    )
