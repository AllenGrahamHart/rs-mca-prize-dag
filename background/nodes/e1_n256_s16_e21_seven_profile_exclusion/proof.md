...
The E21 router exhausts every candidate with seven profiles on 111 affine
...
4,640 retained representatives.

The proper-conductor theorem removes 5,814 of the 10,454 actual vectors,
including every `(1,1,0,1)` vector. For the 4,640 full-conductor
...
impossible. All seven profiles are excluded.
