#!/usr/bin/env python3
"""Verify complete duplicate-role transport from cell 3 to cell 6."""
...
ROOT = NODE.parents[2]
NODE_ID = NODE.name
SCRIPT = ROOT / "experiments/prize_resolution/rate_half_kb_positive_433_1b_cells3_6_duplicate_role_transport.py"
SCRIPT_SHA256 = "2b90594a38175ce2fae6bba95b4803ecc36be67b7262c51b3b54240c29fefaf2"
DEPENDENCIES = {
...
def load_compiler():
    specification = importlib.util.spec_from_file_location("cells36_transport", SCRIPT)
...
def main():
    ...
    require("0, 1, 2, 3, 6" in rank_statement,
            "cell-6 rank-drop exclusion")
    statement = (NODE / "statement.md").read_text()
    require("= 1680" in statement and "not a valid shortcut" in statement,
            "scope and symmetry discipline")
    print("cells=3,6 duplicate_role_transport=exact cell6_raw_cases=1680 complete=yes")
