#!/usr/bin/env python3
"""Run quotient-normal-form full-J probes on Modal."""
...
APP_NAME = "rs-mca-k3-f04-r02-r20-quotient-full-j"
...
SCRIPT = HERE / "quotient_full_j_probe.sage"
OUTPUT = HERE / "modal_quotient_full_j_output.json"
CASES = ({"target": "R02"}, {"target": "R20"})
...
image = (
    ...
    .add_local_file(SCRIPT, "/quotient_full_j_probe.sage")
)


@app.function(image=image, cpu=4, memory=32768, timeout=960, max_containers=2)
...
def main() -> None:
    ...
    output = {
        "schema": "kb-c2-112-f04-quotient-full-j-modal-v1",
        "app": APP_NAME,
