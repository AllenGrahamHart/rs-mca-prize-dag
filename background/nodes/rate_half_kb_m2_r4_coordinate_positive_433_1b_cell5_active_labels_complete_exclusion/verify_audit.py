#!/usr/bin/env python3
"""Hostile mutations for the cell-5 active-label aggregate."""
...
def load_verifier():
    spec = importlib.util.spec_from_file_location("cell5_active_verify", VERIFY)
...
def main():
    ...
    print("PASS cell-5 active-label hostile audit: 3/3 mutations rejected")
