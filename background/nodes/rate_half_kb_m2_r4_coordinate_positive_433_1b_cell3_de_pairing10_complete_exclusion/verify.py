#!/usr/bin/env python3
"""Verify the cell-3 DE-missing pairing-10 48-case exclusion."""
...
PINNED = {
    SCRIPT: "24a4054b79b5fdd44ecf424eccc5d6c227ee28ab18fbaa04ae5edf15298a7b16",
    RESULT: "41c07c85a6360cf66ef3598306772a400ab9352ee67005894b4dda58098e1632",
}
SIGNS = set(itertools.product((-1, 1), repeat=2))
EXPECTED_MATCHING = ((0, 4), (1, 3), (2, 5))
...
def verify_payload(payload):
    require(
        payload["schema"] ==
        "rate-half-kb-positive-433-1b-cell3-de-pairing10-"
    ...
    for row in payload["rows"]:
        ...
        require(sigma_c == -1 and row["pairing_index"] == 10,
...
def main():
    ...
    verify_dag()
    print(
        "cell=3 pairing=10 DE_copies=3 raw_cases=48 "
        "source_rows=16 lane_checks=128 witnesses=0"
    )
