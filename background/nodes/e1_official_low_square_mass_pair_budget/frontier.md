...
certified preflight now proves `|xi_t|<=7` and `sum xi_t^2<=101`, but exactly
counts more than `2^143` zero-sum vectors in that coarse envelope. Even the
weighted ellipsoid contains at least `38,482,585,013,041` explicit
