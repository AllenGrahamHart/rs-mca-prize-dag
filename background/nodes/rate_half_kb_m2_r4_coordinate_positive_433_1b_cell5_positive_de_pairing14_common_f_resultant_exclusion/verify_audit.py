#!/usr/bin/env python3
"""Audit the independent cell-5 positive-DE pairing-14 replay boundary."""
...
def main():
    ...
    require("30 labels in 9 active orbits" in contract
            and "Prize closure" in contract, "scope markers")
    print("PASS cell-5 pairing-14 audit: roots=136 routes=240 hostile=detected")
