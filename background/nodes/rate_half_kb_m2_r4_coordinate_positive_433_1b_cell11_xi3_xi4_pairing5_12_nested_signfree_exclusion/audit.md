...
ledger while selecting only pairing 5 from the shared audit.

The second parses all executable sources, checks the independent root method,
checks the nested sign-free roots, 16 common `q` lifts, and 32 final colored
cuts, and rejects a hostile mutation of the pairing-5 ledger.
