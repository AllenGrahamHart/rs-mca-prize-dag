#!/usr/bin/env python3
"""Direct residual replay for the cell-12 DE pairing-5 packet."""
...
def main():
    ...
    require(
        root_payload["schema"]
        == "rate-half-kb-positive-433-1b-cell12-de-pairing5-frobenius-roots-v1"
    ...
    require((uf_count, lift_count, colored_count, f_boundary_count)
            == (1680, 208, 160, 48), "direct residual census")
    print(
        "PASS pairing-5 adapter audit: profiles=320 unique=37 "
        "boundary=32 uf=1680 lifts=208 colored=160"
    )
