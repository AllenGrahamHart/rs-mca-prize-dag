#!/usr/bin/env python3
"""Audit the E32 joint census with direct negacyclic multiplication."""
...
SOURCE = HERE / "e32_four_odd_joint_census_audit.cpp"
ORBITS = HERE / "e32_four_odd_light_orbit_result.json"
RESULT = HERE / "e32_four_odd_joint_census_audit_result.json"
REMOTE_SOURCE = "/root/e32_four_odd_joint_census_audit.cpp"
REMOTE_BINARY = "/root/e32_four_odd_joint_census_audit"

app = modal.App("e1-n256-e32-four-odd-joint-census-audit")
image = (
...
def main() -> None:
    ...
    packet = {
        "schema": "e1-e32-four-odd-joint-census-audit-v1",
    ...
    print("E32_FOUR_ODD_JOINT_AUDIT " + json.dumps(summary, sort_keys=True))
    print(f"E32_FOUR_ODD_JOINT_AUDIT_RESULT {RESULT}")
