#!/usr/bin/env python3
"""Run the E32 profile-(3,5,1) mod-16 quotient allocation probe."""
...
SOURCE = HERE / "e32_profile351_quotient_census.cpp"
REMOTE_SOURCE = "/root/e32_profile351_quotient.cpp"
REMOTE_BASE_SOURCE = "/root/e34_nested_quotient_census.cpp"
REMOTE_BINARY = "/root/e32_profile351_quotient"
SHARDS = 16

app = modal.App("e1-n256-e32-profile351-quotient-probe")
image = (
...
def main() -> None:
    ...
    print("E32_PROFILE351_QUOTIENT_PROBE " + json.dumps(summary, sort_keys=True))
    print("E32_PROFILE351_QUOTIENT_ROWS " + json.dumps(results, sort_keys=True))
