...
```text
e1_n256_s16_e33_endpoint_exclusion [PROVED] --req-->
...
e1_n256_s16_e32_profile_parity_diameter_reduction [PROVED] --ev-->
...
The node narrows the next endpoint but does not close any of its three
