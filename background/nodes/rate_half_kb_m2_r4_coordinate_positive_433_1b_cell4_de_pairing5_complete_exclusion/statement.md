...
gives 320 candidate base-field roots, 288 guarded source points, 1,040
`(u,f)` rows, 960 nonzero missing-relation terminals, 64 nonzero colored-
...
by itself pay the positive-`DE` cases at matching 12, close cell 4, close
