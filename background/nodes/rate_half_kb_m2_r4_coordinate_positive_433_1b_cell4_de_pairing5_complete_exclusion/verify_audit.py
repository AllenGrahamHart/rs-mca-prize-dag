#!/usr/bin/env python3
"""Audit the pairing-5 eliminant identity and terminal scope."""
...
def main():
    ...
    require("Positive `DE` at matching 12 is not claimed" in
            (NODE / "audit.md").read_text(), "matching-12 fence")
