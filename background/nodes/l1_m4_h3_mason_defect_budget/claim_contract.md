...
- **claim id:** `l1_m4_h3_mason_defect_budget`
- **status:** PROVED
- **scope:** hypothetical exact `h=3` pencils on the four official rows
  `n=4(p+1)` at first-checkpoint width `t=p`
...
- **nonclaim:** no emptiness, component count, nonembedded `h=2`
  classification, `m=8,16` result, wider-width result, or L1 promotion
