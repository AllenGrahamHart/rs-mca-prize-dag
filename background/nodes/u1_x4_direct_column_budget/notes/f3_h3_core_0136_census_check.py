#!/usr/bin/env python3
"""Integrity check for the banked A=[0,1,36] census JSON."""
...
RESULT_PATH = Path(
    ...
    "f3_h3_core_0136_census_results.json"
)

EXPECTED = [
    ([0, 1, 36, 9, 54, 80], [10273]),
    ([0, 1, 36, 27, 37, 44], [19777]),
]
...
def main() -> None:
    ...
    print("H3_CORE_0136_CENSUS_CHECK_PASS")
