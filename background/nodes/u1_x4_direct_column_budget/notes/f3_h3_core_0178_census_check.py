#!/usr/bin/env python3
"""Integrity check for the banked A=[0,1,78] census JSON."""
...
RESULT_PATH = Path(
    ...
    "f3_h3_core_0178_census_results.json"
)

EXPECTED = [
    ([0, 1, 78, 12, 67, 90], [27361]),
    ([0, 1, 78, 29, 68, 87], [40897]),
    ([0, 1, 78, 31, 66, 84], [12289]),
]
...
def main() -> None:
    ...
    print("H3_CORE_0178_CENSUS_CHECK_PASS")
