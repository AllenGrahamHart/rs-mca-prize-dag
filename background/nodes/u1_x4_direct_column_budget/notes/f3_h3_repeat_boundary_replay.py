...
COMMANDS = [
    ...
    (
        "h3 repeat same-lambda J ramification",
        "f3_h3_repeat_same_lambda_j_ramification.py",
    ...
    (
        "h3 repeat slope-miss degree compiler",
        "f3_h3_repeat_slope_miss_degree_compiler.py",
    ...
    (
        "h3 repeat loose collision-branch parametrization",
        "f3_h3_repeat_loose_collision_branch_parametrization.py",
    ...
    (
        "h3 repeat loose branch slope maps",
        "f3_h3_repeat_loose_branch_slope_maps.py",
    ...
    (
        "h3 repeat loose secondary payment",
        "f3_h3_repeat_loose_secondary_payment.py",
    ...
    (
        "h3 repeat loose Stepanov compiler",
        "f3_h3_repeat_loose_stepanov_compiler.py",
    ...
    (
        "h3 repeat star refined assembly",
        "f3_h3_repeat_star_refined_assembly.py",
...
def main() -> None:
    notes = "background/nodes/u1_x4_direct_column_budget/notes"
