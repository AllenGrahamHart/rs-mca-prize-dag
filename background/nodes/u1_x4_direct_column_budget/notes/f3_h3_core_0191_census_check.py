#!/usr/bin/env python3
"""Integrity check for the banked A=[0,1,91] census JSON."""
...
RESULT_PATH = Path(
    ...
    "f3_h3_core_0191_census_results.json"
)

EXPECTED = [
    ([0, 1, 91, 31, 37, 54], [12289]),
    ([0, 1, 91, 42, 55, 61], [27361]),
    ([0, 1, 91, 44, 46, 47], [40897]),
]
...
def main() -> None:
    ...
    print("H3_CORE_0191_CENSUS_CHECK_PASS")
