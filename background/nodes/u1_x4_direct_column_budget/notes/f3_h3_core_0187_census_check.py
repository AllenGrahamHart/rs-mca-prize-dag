#!/usr/bin/env python3
"""Integrity check for the banked A=[0,1,87] census JSON."""
...
RESULT_PATH = Path(
    ...
    "f3_h3_core_0187_census_results.json"
)

EXPECTED = [
    ([0, 1, 87, 26, 93, 94], [10273]),
    ([0, 1, 87, 38, 59, 69], [20929]),
]
...
def main() -> None:
    ...
    if data["norm_exception_count"] != 1111:
    ...
    print("H3_CORE_0187_CENSUS_CHECK_PASS")
