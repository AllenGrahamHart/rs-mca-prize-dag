#!/usr/bin/env python3
"""Integrity check for the banked A=[0,1,7] census JSON."""
...
RESULT_PATH = Path(
    ...
    "f3_h3_core_017_census_results.json"
)

EXPECTED = [
    ([0, 1, 7, 37, 43, 54], [12289]),
    ([0, 1, 7, 42, 61, 67], [12289]),
    ([0, 1, 7, 77, 82, 93], [15361]),
]
...
def main() -> None:
    ...
    print("H3_CORE_017_CENSUS_CHECK_PASS")
