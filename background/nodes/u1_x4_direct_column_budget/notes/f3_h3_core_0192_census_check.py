#!/usr/bin/env python3
"""Integrity check for the banked A=[0,1,92] census JSON."""
...
RESULT_PATH = Path(
    ...
    "f3_h3_core_0192_census_results.json"
)

EXPECTED = [
    ([0, 1, 92, 43, 50, 51], [18913]),
    ([0, 1, 92, 53, 70, 81], [18913]),
    ([0, 1, 92, 59, 76, 87], [18913]),
]
...
def main() -> None:
    ...
    print("H3_CORE_0192_CENSUS_CHECK_PASS")
