#!/usr/bin/env python3
"""Integrity check for the banked A=[0,1,46] census JSON."""
...
RESULT_PATH = Path(
    ...
    "f3_h3_core_0146_census_results.json"
)

EXPECTED = [
    ([0, 1, 46, 3, 44, 90], [67777]),
    ([0, 1, 46, 4, 45, 65], [18433]),
    ([0, 1, 46, 50, 51, 93], [40897]),
]
...
def main() -> None:
    ...
    print("H3_CORE_0146_CENSUS_CHECK_PASS")
