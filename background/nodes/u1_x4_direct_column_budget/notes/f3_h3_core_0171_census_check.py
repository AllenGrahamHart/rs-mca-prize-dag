#!/usr/bin/env python3
"""Integrity check for the banked A=[0,1,71] census JSON."""
...
RESULT_PATH = Path(
    ...
    "f3_h3_core_0171_census_results.json"
)

EXPECTED = [
    ([0, 1, 71, 19, 61, 77], [20353]),
    ([0, 1, 71, 20, 56, 61], [19777]),
]
...
def main() -> None:
    ...
    print("H3_CORE_0171_CENSUS_CHECK_PASS")
