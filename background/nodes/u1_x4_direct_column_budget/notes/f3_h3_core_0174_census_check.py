#!/usr/bin/env python3
"""Integrity check for the banked A=[0,1,74] census JSON."""
...
RESULT_PATH = Path(
    ...
    "f3_h3_core_0174_census_results.json"
)

EXPECTED = [
    ([0, 1, 74, 21, 38, 57], [19777]),
    ([0, 1, 74, 38, 44, 54], [20353]),
]
...
def main() -> None:
    ...
    print("H3_CORE_0174_CENSUS_CHECK_PASS")
