#!/usr/bin/env python3
"""Integrity check for the banked A=[0,1,56] census JSON."""
...
RESULT_PATH = Path(
    ...
    "f3_h3_core_0156_census_results.json"
)

EXPECTED = [
    ([0, 1, 56, 7, 35, 90], [18913]),
    ([0, 1, 56, 7, 50, 51], [18913]),
    ([0, 1, 56, 65, 71, 73], [31393]),
]
...
def main() -> None:
    ...
    print("H3_CORE_0156_CENSUS_CHECK_PASS")
