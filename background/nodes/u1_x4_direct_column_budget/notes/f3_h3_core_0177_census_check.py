#!/usr/bin/env python3
"""Integrity check for the banked A=[0,1,77] census JSON."""
...
RESULT_PATH = Path(
    ...
    "f3_h3_core_0177_census_results.json"
)

EXPECTED = [
    ([0, 1, 77, 2, 46, 81], [18913]),
    ([0, 1, 77, 28, 63, 80], [18913]),
    ([0, 1, 77, 30, 67, 86], [18913]),
]
...
def main() -> None:
    ...
    print("H3_CORE_0177_CENSUS_CHECK_PASS")
