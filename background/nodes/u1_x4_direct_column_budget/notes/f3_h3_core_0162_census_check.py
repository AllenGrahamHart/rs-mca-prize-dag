#!/usr/bin/env python3
"""Integrity check for the banked A=[0,1,62] census JSON."""
...
RESULT_PATH = Path(
    ...
    "f3_h3_core_0162_census_results.json"
)

EXPECTED = [
    ([0, 1, 62, 13, 23, 84], [30817]),
    ([0, 1, 62, 13, 50, 51], [30817]),
    ([0, 1, 62, 36, 54, 64], [69313]),
]
...
def main() -> None:
    ...
    print("H3_CORE_0162_CENSUS_CHECK_PASS")
