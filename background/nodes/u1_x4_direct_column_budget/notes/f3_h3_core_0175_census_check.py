#!/usr/bin/env python3
"""Integrity check for the banked A=[0,1,75] census JSON."""
...
RESULT_PATH = Path(
    ...
    "f3_h3_core_0175_census_results.json"
)

EXPECTED = [
    ([0, 1, 75, 5, 70, 79], [20929]),
    ([0, 1, 75, 8, 45, 81], [10273]),
    ([0, 1, 75, 36, 59, 72], [10177]),
]
...
def main() -> None:
    ...
    print("H3_CORE_0175_CENSUS_CHECK_PASS")
