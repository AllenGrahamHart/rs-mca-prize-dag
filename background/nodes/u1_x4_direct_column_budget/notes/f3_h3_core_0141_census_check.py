#!/usr/bin/env python3
"""Integrity check for the banked A=[0,1,41] census JSON."""
...
RESULT_PATH = Path(
    ...
    "f3_h3_core_0141_census_results.json"
)

EXPECTED = [
    ([0, 1, 41, 7, 62, 90], [18913]),
    ([0, 1, 41, 24, 26, 32], [31393]),
    ([0, 1, 41, 46, 47, 90], [18913]),
]
...
def main() -> None:
    ...
    print("H3_CORE_0141_CENSUS_CHECK_PASS")
