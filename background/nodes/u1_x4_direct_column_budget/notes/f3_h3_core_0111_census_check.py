#!/usr/bin/env python3
"""Integrity check for the banked A=[0,1,11] census JSON."""
...
RESULT_PATH = Path(
    ...
    "f3_h3_core_0111_census_results.json"
)

EXPECTED = [
    ([0, 1, 11, 26, 37, 60], [30817]),
    ([0, 1, 11, 46, 47, 60], [30817]),
    ([0, 1, 11, 75, 89, 95], [69313]),
]
...
def main() -> None:
    ...
    print("H3_CORE_0111_CENSUS_CHECK_PASS")
