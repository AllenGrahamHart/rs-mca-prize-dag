#!/usr/bin/env python3
"""Integrity check for the banked A=[0,1,44] census JSON."""
...
RESULT_PATH = Path(
    ...
    "f3_h3_core_0144_census_results.json"
)

EXPECTED = [
    ([0, 1, 44, 7, 69, 76], [18433]),
    ([0, 1, 44, 31, 34, 77], [10273]),
    ([0, 1, 44, 50, 51, 91], [18913]),
]
...
def main() -> None:
    ...
    print("H3_CORE_0144_CENSUS_CHECK_PASS")
