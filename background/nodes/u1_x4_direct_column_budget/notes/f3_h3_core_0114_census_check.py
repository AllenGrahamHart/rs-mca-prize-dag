#!/usr/bin/env python3
"""Integrity check for the banked A=[0,1,14] census JSON."""
...
RESULT_PATH = Path(
    ...
    "f3_h3_core_0114_census_results.json"
)

EXPECTED = [
    ([0, 1, 14, 23, 36, 61], [30817]),
    ([0, 1, 14, 50, 51, 61], [30817]),
]
...
def main() -> None:
    ...
    print("H3_CORE_0114_CENSUS_CHECK_PASS")
