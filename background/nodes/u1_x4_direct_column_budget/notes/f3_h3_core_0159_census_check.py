#!/usr/bin/env python3
"""Integrity check for the banked A=[0,1,59] census JSON."""
...
RESULT_PATH = Path(
    ...
    "f3_h3_core_0159_census_results.json"
)

EXPECTED = [
    ([0, 1, 59, 12, 26, 85], [30817]),
    ([0, 1, 59, 12, 46, 47], [30817]),
]
...
def main() -> None:
    ...
    print("H3_CORE_0159_CENSUS_CHECK_PASS")
