#!/usr/bin/env python3
"""Integrity check for the banked A=[0,1,30] census JSON."""
...
RESULT_PATH = Path(
    ...
    "f3_h3_core_0130_census_results.json"
)

EXPECTED = [
    ([0, 1, 30, 12, 19, 42], [27361]),
    ([0, 1, 30, 18, 79, 84], [12289]),
    ([0, 1, 30, 20, 77, 87], [40897]),
]
...
def main() -> None:
    ...
    print("H3_CORE_0130_CENSUS_CHECK_PASS")
