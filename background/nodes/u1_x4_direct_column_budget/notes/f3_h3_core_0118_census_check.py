#!/usr/bin/env python3
"""Integrity check for the banked A=[0,1,18] census JSON."""
...
RESULT_PATH = Path(
    ...
    "f3_h3_core_0118_census_results.json"
)

EXPECTED = [
    ([0, 1, 18, 6, 31, 84], [27361]),
    ([0, 1, 18, 12, 30, 67], [27361]),
    ([0, 1, 18, 15, 32, 65], [10177]),
    ([0, 1, 18, 50, 51, 65], [10177]),
]
...
def main() -> None:
    ...
    print("H3_CORE_0118_CENSUS_CHECK_PASS")
