#!/usr/bin/env python3
"""Integrity check for the banked A=[0,1,66] census JSON."""
...
RESULT_PATH = Path(
    ...
    "f3_h3_core_0166_census_results.json"
)

EXPECTED = [
    ([0, 1, 66, 12, 19, 78], [27361]),
    ([0, 1, 66, 15, 17, 80], [10177]),
    ([0, 1, 66, 17, 50, 51], [10177]),
    ([0, 1, 66, 54, 79, 84], [27361]),
]
...
def main() -> None:
    ...
    print("H3_CORE_0166_CENSUS_CHECK_PASS")
