#!/usr/bin/env python3
"""Integrity check for the banked A=[0,1,34] census JSON."""
...
RESULT_PATH = Path(
    ...
    "f3_h3_core_0134_census_results.json"
)

EXPECTED = [
    ([0, 1, 34, 2, 37, 89], [17377]),
    ([0, 1, 34, 14, 76, 83], [67777]),
    ([0, 1, 34, 26, 30, 76], [10369]),
    ([0, 1, 34, 50, 51, 81], [10177]),
]
...
def main() -> None:
    ...
    print("H3_CORE_0134_CENSUS_CHECK_PASS")
