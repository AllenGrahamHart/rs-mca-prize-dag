#!/usr/bin/env python3
"""Integrity check for the banked A=[0,1,21] census JSON."""
...
RESULT_PATH = Path(
    ...
    "f3_h3_core_0121_census_results.json"
)

EXPECTED = [
    ([0, 1, 21, 9, 12, 56], [37633]),
    ([0, 1, 21, 9, 29, 68], [37633]),
    ([0, 1, 21, 13, 28, 89], [37633]),
    ([0, 1, 21, 13, 40, 84], [37633]),
]
...
def main() -> None:
    ...
    print("H3_CORE_0121_CENSUS_CHECK_PASS")
