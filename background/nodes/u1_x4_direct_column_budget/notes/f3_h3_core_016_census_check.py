#!/usr/bin/env python3
"""Integrity check for the banked A=[0,1,6] census JSON."""
...
RESULT_PATH = Path(
    ...
    "f3_h3_core_016_census_results.json"
)

EXPECTED = [
    ([0, 1, 6, 36, 42, 55], [27361]),
    ([0, 1, 6, 43, 60, 66], [12289]),
    ([0, 1, 6, 50, 51, 53], [40897]),
]
...
def main() -> None:
    ...
    print("H3_CORE_016_CENSUS_CHECK_PASS")
