#!/usr/bin/env python3
"""Integrity check for the banked A=[0,1,60] census JSON."""
...
RESULT_PATH = Path(
    ...
    "f3_h3_core_0160_census_results.json"
)

EXPECTED = [
    ([0, 1, 60, 11, 36, 81], [10177]),
]
...
def main() -> None:
    ...
    if data["norm_exception_count"] != 1289:
    ...
    print("H3_CORE_0160_CENSUS_CHECK_PASS")
