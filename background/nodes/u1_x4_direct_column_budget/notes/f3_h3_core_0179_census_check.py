#!/usr/bin/env python3
"""Integrity check for the banked A=[0,1,79] census JSON."""
...
RESULT_PATH = Path(
    ...
    "f3_h3_core_0179_census_results.json"
)

EXPECTED = [
    ([0, 1, 79, 13, 66, 91], [27361]),
    ([0, 1, 79, 30, 67, 85], [27361]),
    ([0, 1, 79, 32, 46, 47], [10177]),
    ([0, 1, 79, 32, 65, 82], [10177]),
]
...
def main() -> None:
    ...
    if data["norm_exception_count"] != 1135:
    ...
    print("H3_CORE_0179_CENSUS_CHECK_PASS")
