...
COMMANDS = [
    ...
    (
        ...
        [
            sys.executable,
            "background/nodes/u1_x4_direct_column_budget/notes/f3_h3_private_linear_one_factor_rank.py",
        ],
    ...
    (
        ...
        [
            sys.executable,
            "background/nodes/u1_x4_direct_column_budget/notes/f3_h3_private_linear_two_factor_guardrail.py",
        ],
    ...
    (
        ...
        [
            sys.executable,
            "background/nodes/u1_x4_direct_column_budget/notes/f3_h3_private_linear_bad_prime_guardrail.py",
        ],
    ...
    (
        ...
        [
            sys.executable,
            "background/nodes/u1_x4_direct_column_budget/notes/f3_h5_certificate_scaling_frontier.py",
        ],
    ...
    (
        ...
        [
            sys.executable,
            "background/nodes/u1_x4_direct_column_budget/notes/f3_h8_locator_parity_antipodal.py",
        ],
    ...
    (
        ...
        [
            sys.executable,
            "background/nodes/u1_x4_direct_column_budget/notes/f3_h8_x83_split_rotation_equivariance.py",
        ],
