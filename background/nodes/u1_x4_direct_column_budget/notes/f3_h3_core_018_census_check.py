#!/usr/bin/env python3
"""Integrity check for the banked A=[0,1,8] census JSON."""
...
RESULT_PATH = Path(
    ...
    "f3_h3_core_018_census_results.json"
)

EXPECTED = [
    ([0, 1, 8, 33, 73, 87], [31393]),
    ([0, 1, 8, 35, 42, 55], [18913]),
    ([0, 1, 8, 50, 51, 55], [18913]),
]
...
def main() -> None:
    ...
    print("H3_CORE_018_CENSUS_CHECK_PASS")
