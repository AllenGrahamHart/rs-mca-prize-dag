#!/usr/bin/env python3
"""Integrity check for the banked A=[0,1,4] census JSON."""
...
RESULT_PATH = Path(
    ...
    "f3_h3_core_014_census_results.json"
)

EXPECTED = [
    ([0, 1, 4, 9, 37, 60], [37633]),
    ([0, 1, 4, 12, 23, 33], [17377]),
    ([0, 1, 4, 40, 44, 53], [37633]),
    ([0, 1, 4, 40, 61, 89], [37633]),
    ([0, 1, 4, 45, 56, 60], [37633]),
]
...
def main() -> None:
    ...
    if data["norm_exception_count"] != 1142:
    ...
    print("H3_CORE_014_CENSUS_CHECK_PASS")
