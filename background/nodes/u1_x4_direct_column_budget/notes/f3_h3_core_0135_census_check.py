#!/usr/bin/env python3
"""Integrity check for the banked A=[0,1,35] census JSON."""
...
RESULT_PATH = Path(
    ...
    "f3_h3_core_0135_census_results.json"
)

EXPECTED = [
    ([0, 1, 35, 13, 74, 84], [30817]),
    ([0, 1, 35, 33, 43, 61], [69313]),
    ([0, 1, 35, 46, 47, 84], [30817]),
]
...
def main() -> None:
    ...
    print("H3_CORE_0135_CENSUS_CHECK_PASS")
