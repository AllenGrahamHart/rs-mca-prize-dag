#!/usr/bin/env python3
"""Integrity check for the banked A=[0,1,67] census JSON."""
...
RESULT_PATH = Path(
    ...
    "f3_h3_core_0167_census_results.json"
)

EXPECTED = [
    ([0, 1, 67, 10, 20, 77], [40897]),
    ([0, 1, 67, 13, 18, 79], [12289]),
    ([0, 1, 67, 55, 78, 85], [27361]),
]
...
def main() -> None:
    ...
    print("H3_CORE_0167_CENSUS_CHECK_PASS")
