#!/usr/bin/env python3
"""Integrity check for the banked A=[0,1,88] census JSON."""
...
RESULT_PATH = Path(
    ...
    "f3_h3_core_0188_census_results.json"
)

EXPECTED = [
    ([0, 1, 88, 5, 20, 45], [37633]),
    ([0, 1, 88, 16, 72, 87], [37633]),
    ([0, 1, 88, 17, 33, 51], [239233]),
    ([0, 1, 88, 24, 39, 64], [37633]),
    ([0, 1, 88, 53, 68, 93], [37633]),
]
...
def main() -> None:
    ...
    print("H3_CORE_0188_CENSUS_CHECK_PASS")
