#!/usr/bin/env python3
"""Integrity check for the banked A=[0,1,26] census JSON."""
...
RESULT_PATH = Path(
    ...
    "f3_h3_core_0126_census_results.json"
)

EXPECTED = [
    ([0, 1, 26, 20, 36, 78], [20353]),
    ([0, 1, 26, 36, 41, 77], [19777]),
]
...
def main() -> None:
    ...
    print("H3_CORE_0126_CENSUS_CHECK_PASS")
