#!/usr/bin/env python3
"""Integrity check for the banked A=[0,1,55] census JSON."""
...
RESULT_PATH = Path(
    ...
    "f3_h3_core_0155_census_results.json"
)

EXPECTED = [
    ([0, 1, 55, 6, 37, 91], [12289]),
    ([0, 1, 55, 11, 27, 94], [15361]),
    ([0, 1, 55, 19, 61, 90], [12289]),
]
...
def main() -> None:
    ...
    print("H3_CORE_0155_CENSUS_CHECK_PASS")
