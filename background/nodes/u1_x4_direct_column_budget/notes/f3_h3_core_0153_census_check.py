#!/usr/bin/env python3
"""Integrity check for the banked A=[0,1,53] census JSON."""
...
RESULT_PATH = Path(
    ...
    "f3_h3_core_0153_census_results.json"
)

EXPECTED = [
    ([0, 1, 53, 6, 46, 47], [18913]),
    ([0, 1, 53, 20, 63, 66], [10273]),
    ([0, 1, 53, 21, 28, 90], [18433]),
]
...
def main() -> None:
    ...
    print("H3_CORE_0153_CENSUS_CHECK_PASS")
