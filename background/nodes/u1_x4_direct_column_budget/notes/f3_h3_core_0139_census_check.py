#!/usr/bin/env python3
"""Integrity check for the banked A=[0,1,39] census JSON."""
...
RESULT_PATH = Path(
    ...
    "f3_h3_core_0139_census_results.json"
)

EXPECTED = [
    ([0, 1, 39, 11, 69, 86], [20929]),
]
...
def main() -> None:
    ...
    if data["norm_exception_count"] != 1194:
    ...
    print("H3_CORE_0139_CENSUS_CHECK_PASS")
