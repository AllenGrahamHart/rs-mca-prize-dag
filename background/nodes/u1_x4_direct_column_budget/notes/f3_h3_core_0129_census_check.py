#!/usr/bin/env python3
"""Integrity check for the banked A=[0,1,29] census JSON."""
...
RESULT_PATH = Path(
    ...
    "f3_h3_core_0129_census_results.json"
)

EXPECTED = [
    ([0, 1, 29, 3, 4, 90], [10273]),
    ([0, 1, 29, 18, 33, 44], [18433]),
    ([0, 1, 29, 19, 78, 86], [18913]),
]
...
def main() -> None:
    ...
    print("H3_CORE_0129_CENSUS_CHECK_PASS")
