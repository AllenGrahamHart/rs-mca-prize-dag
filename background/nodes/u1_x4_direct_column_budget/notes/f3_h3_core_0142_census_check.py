#!/usr/bin/env python3
"""Integrity check for the banked A=[0,1,42] census JSON."""
...
RESULT_PATH = Path(
    ...
    "f3_h3_core_0142_census_results.json"
)

EXPECTED = [
    ([0, 1, 42, 3, 70, 86], [15361]),
    ([0, 1, 42, 6, 60, 91], [12289]),
    ([0, 1, 42, 7, 36, 78], [12289]),
]
...
def main() -> None:
    ...
    print("H3_CORE_0142_CENSUS_CHECK_PASS")
