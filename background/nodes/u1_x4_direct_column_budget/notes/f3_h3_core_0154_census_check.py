#!/usr/bin/env python3
"""Integrity check for the banked A=[0,1,54] census JSON."""
...
RESULT_PATH = Path(
    ...
    "f3_h3_core_0154_census_results.json"
)

EXPECTED = [
    ([0, 1, 54, 5, 50, 51], [40897]),
    ([0, 1, 54, 7, 36, 90], [27361]),
    ([0, 1, 54, 18, 60, 91], [12289]),
]
...
def main() -> None:
    ...
    print("H3_CORE_0154_CENSUS_CHECK_PASS")
