#!/usr/bin/env python3
"""Integrity check for the banked A=[0,1,22] census JSON."""
...
RESULT_PATH = Path(
    ...
    "f3_h3_core_0122_census_results.json"
)

EXPECTED = [
    ([0, 1, 22, 16, 52, 89], [10273]),
    ([0, 1, 22, 18, 27, 92], [20929]),
    ([0, 1, 22, 25, 38, 61], [10177]),
]
...
def main() -> None:
    ...
    if data["norm_exception_count"] != 1105:
    ...
    print("H3_CORE_0122_CENSUS_CHECK_PASS")
