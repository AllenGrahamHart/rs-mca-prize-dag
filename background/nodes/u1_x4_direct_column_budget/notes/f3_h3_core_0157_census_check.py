#!/usr/bin/env python3
"""Integrity check for the banked A=[0,1,57] census JSON."""
...
RESULT_PATH = Path(
    ...
    "f3_h3_core_0157_census_results.json"
)

EXPECTED = [
    ([0, 1, 57, 5, 20, 28], [37633]),
    ([0, 1, 57, 10, 25, 33], [37633]),
    ([0, 1, 57, 53, 68, 76], [37633]),
    ([0, 1, 57, 58, 73, 81], [37633]),
]
...
def main() -> None:
    ...
    print("H3_CORE_0157_CENSUS_CHECK_PASS")
