#!/usr/bin/env python3
"""Integrity check for the banked A=[0,1,20] census JSON."""
...
RESULT_PATH = Path(
    ...
    "f3_h3_core_0120_census_results.json"
)

EXPECTED = [
    ([0, 1, 20, 11, 30, 67], [18913]),
    ([0, 1, 20, 16, 51, 95], [18913]),
    ([0, 1, 20, 17, 34, 69], [18913]),
]
...
def main() -> None:
    ...
    print("H3_CORE_0120_CENSUS_CHECK_PASS")
