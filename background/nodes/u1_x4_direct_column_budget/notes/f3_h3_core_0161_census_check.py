#!/usr/bin/env python3
"""Integrity check for the banked A=[0,1,61] census JSON."""
...
RESULT_PATH = Path(
    ...
    "f3_h3_core_0161_census_results.json"
)

EXPECTED = [
    ([0, 1, 61, 17, 43, 88], [10273]),
    ([0, 1, 61, 53, 60, 70], [19777]),
]
...
def main() -> None:
    ...
    print("H3_CORE_0161_CENSUS_CHECK_PASS")
