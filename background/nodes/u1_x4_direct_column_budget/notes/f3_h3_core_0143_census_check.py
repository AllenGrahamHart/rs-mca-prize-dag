#!/usr/bin/env python3
"""Integrity check for the banked A=[0,1,43] census JSON."""
...
RESULT_PATH = Path(
    ...
    "f3_h3_core_0143_census_results.json"
)

EXPECTED = [
    ([0, 1, 43, 6, 37, 79], [12289]),
    ([0, 1, 43, 7, 61, 90], [27361]),
    ([0, 1, 43, 46, 47, 92], [40897]),
]
...
def main() -> None:
    ...
    print("H3_CORE_0143_CENSUS_CHECK_PASS")
