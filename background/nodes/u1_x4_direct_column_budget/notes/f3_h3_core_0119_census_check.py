#!/usr/bin/env python3
"""Integrity check for the banked A=[0,1,19] census JSON."""
...
RESULT_PATH = Path(
    ...
    "f3_h3_core_0119_census_results.json"
)

EXPECTED = [
    ([0, 1, 19, 7, 30, 85], [27361]),
    ([0, 1, 19, 10, 29, 68], [40897]),
    ([0, 1, 19, 13, 31, 66], [12289]),
]
...
def main() -> None:
    ...
    print("H3_CORE_0119_CENSUS_CHECK_PASS")
