#!/usr/bin/env python3
"""Integrity check for the banked A=[0,1,38] census JSON."""
...
RESULT_PATH = Path(
    ...
    "f3_h3_core_0138_census_results.json"
)

EXPECTED = [
    ([0, 1, 38, 12, 71, 85], [30817]),
    ([0, 1, 38, 50, 51, 85], [30817]),
]
...
def main() -> None:
    ...
    print("H3_CORE_0138_CENSUS_CHECK_PASS")
