#!/usr/bin/env python3
"""Integrity check for the banked A=[0,1,40] census JSON."""
...
RESULT_PATH = Path(
    ...
    "f3_h3_core_0140_census_results.json"
)

EXPECTED = [
    ([0, 1, 40, 16, 24, 39], [37633]),
    ([0, 1, 40, 21, 29, 44], [37633]),
    ([0, 1, 40, 64, 72, 87], [37633]),
    ([0, 1, 40, 69, 77, 92], [37633]),
]
...
def main() -> None:
    ...
    if data["norm_exception_count"] != 1381:
    ...
    print("H3_CORE_0140_CENSUS_CHECK_PASS")
