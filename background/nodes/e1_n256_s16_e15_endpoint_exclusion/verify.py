...
NODE = "e1_n256_s16_e15_endpoint_exclusion"
DEPENDENCIES = {
    "e1_n256_s16_e15_profile_parity_light_reduction",
    "e1_n256_s16_e15_two_profile_exclusion",
}
...
def main() -> None:
    ...
    assert "0<V<=28" in nodes[NODE]["statement"]
    assert all(profile in nodes[NODE]["statement"] for profile in PROFILES)
    print(
        "E1_N256_S16_E15_ENDPOINT_EXCLUSION_PASS "
        "profiles=2 exclusions=2 frontier=28 mutations=2"
    )
