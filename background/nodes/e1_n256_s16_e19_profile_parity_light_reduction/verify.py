#!/usr/bin/env python3
"""Verify the cutoff-free E19 profile/parity router."""
...
NODE = "e1_n256_s16_e19_profile_parity_light_reduction"
DEPENDENCIES = {
    "e1_n256_s16_e20_endpoint_exclusion",
...
EXCLUSION = "e1_n256_s16_e19_four_profile_exclusion"
...
def main() -> None:
    ...
    assert packet["complete"] and packet["variance"] == 38 and packet["energy"] == 19
    assert packet["l1_bound"] == 11 and packet["profile_count"] == 5
    ...
    assert "l1=11 profiles=5 survivors=4 templates=8 floor=158783488" in run.stdout
    ...
    print(
        "E1_N256_S16_E19_PROFILE_PARITY_LIGHT_REDUCTION_PASS "
        "l1=11 profiles=5 survivors=4 templates=8 floor=158783488 mutations=1"
    )
