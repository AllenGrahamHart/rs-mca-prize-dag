#!/usr/bin/env python3
"""Run the exact profile-(5,4,1) odd-difference relaxation on Modal."""
...
SOURCE = HERE / "e30_profile541_odd_difference_relaxation.cpp"
RESULT = HERE / "e30_profile541_odd_difference_relaxation_result.json"
REMOTE_SOURCE = "/root/e30_profile541_odd_difference_relaxation.cpp"
REMOTE_BINARY = "/root/e30_profile541_odd_difference_relaxation"
SHARDS = 64

app = modal.App("e1-n256-e30-profile541-odd-difference-relaxation")
image = (
...
def main() -> None:
    ...
    def write_checkpoint(complete: bool) -> dict[str, object]:
        ...
        packet = {
            "schema": "e1-e30-profile541-odd-difference-relaxation-v1",
            "complete": complete,
            ...
            "summary": {
                ...
                "above_histogram": dict(sorted(histogram.items(), key=lambda item: int(item[0]))),
                "exceptional": [
                    candidate
                    for row in rows
    ...
    try:
        ...
        print(f"E30_PROFILE541_ODD_DIFFERENCE_INCOMPLETE completed={len(rows)}/{SHARDS}")
        raise
    complete = (
        len(rows) == SHARDS
    ...
    print("E30_PROFILE541_ODD_DIFFERENCE " + json.dumps(packet["summary"], sort_keys=True))
    print(f"E30_PROFILE541_ODD_DIFFERENCE_COMPLETE {complete}")
    print(f"E30_PROFILE541_ODD_DIFFERENCE_RESULT {RESULT}")
