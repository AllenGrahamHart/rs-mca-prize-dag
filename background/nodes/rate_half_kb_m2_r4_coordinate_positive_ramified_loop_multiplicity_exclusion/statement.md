...
Consequently every positive packet has at most one common loop:

```text
ell_positive <= 1.                                 (KBPRM-4)
```
...
it must be the unique zero of the nonzero linear form `B_1`.
...
packet with two or more common loops.
