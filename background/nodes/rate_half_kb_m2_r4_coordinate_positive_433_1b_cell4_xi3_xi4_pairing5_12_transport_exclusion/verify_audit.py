#!/usr/bin/env python3
"""Audit the scope composition for cell-4 xi3/xi4 pairings 5/12."""
...
DIRECT = (
    ...
    "cell4_xi3_pairing5_nested_signfree_exclusion"
)
XI_TRANSPORT = (
    "rate_half_kb_m2_r4_coordinate_positive_433_1b_"
...
def main():
    ...
    require({direct["status"], xi_transport["status"],
            ...
            "all parents proved")
    require("pairing-5 exclusion" in direct["closure"],
    ...
    require("93/105" in result and "cell-4 labels live          12" in result,
            "updated cell-4 ledger")
    require("Three cell-4 matching-exchange pairs remain" in frontier,
            "retained frontier")
    require("four labels" in audit and "4*4" in audit,
            "label multiplicity discipline")
    print("audit=ok cell=4 xi=3,4 pairings=5,12 raw_cases=64 parents=3")
