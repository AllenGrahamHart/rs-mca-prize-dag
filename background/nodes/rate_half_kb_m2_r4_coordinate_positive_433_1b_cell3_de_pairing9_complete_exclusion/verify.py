#!/usr/bin/env python3
"""Verify the cell-3 DE-missing pairing-9 48-case exclusion."""
...
PINNED = {
    SCRIPT: "d82ed774ee1d0d2a5d05b7bc4b7c2e50c864d5ef48f58d15e970dfe6cb8a3e5e",
    RESULT: "a88e9b0cc1c25cfe9e591df864b600ff82e7700c31cdd768926c7ec1aacc13e9",
}
SIGNS = set(itertools.product((-1, 1), repeat=2))
LANES = {(-1, -1), (-1, 1), (1, -1), (1, 1)}
EXPECTED_MATCHING = ((0, 4), (1, 2), (3, 5))
...
def verify_payload(payload):
    require(
        payload["schema"] ==
        "rate-half-kb-positive-433-1b-cell3-de-pairing9-"
    ...
    for row in payload["rows"]:
        ...
        rows[key] = row
        require(row["sigma"] == [-1, -1] and row["pairing_index"] == 9,
...
def main():
    ...
    verify_dag()
    print(
        "cell=3 pairing=9 DE_copies=3 raw_cases=48 "
        "source_rows=8 lane_checks=128 witnesses=0"
    )
