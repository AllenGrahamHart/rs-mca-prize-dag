...
(KBP1B3-QUOT-1): global quadratic quotient [PROVED]
        |
        v
(KBP1B3-DE-P9-1): pairing-9 DE block [PROVED]
        |
        v
...
rate_half_kb_m2_r4_coordinate_positive_433_1b_cell3_global_quadratic_quotient
  -> rate_half_kb_m2_r4_coordinate_positive_433_1b_cell3_de_pairing9_complete_exclusion
  -> rate_half_band_closure
```

The quotient-to-pairing-9 edge is `req`. The edge to
