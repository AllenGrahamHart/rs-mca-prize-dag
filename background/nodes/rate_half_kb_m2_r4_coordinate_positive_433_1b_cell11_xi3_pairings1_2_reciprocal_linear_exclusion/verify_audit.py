#!/usr/bin/env python3
"""Audit the independent cell-11 xi3 pairings-1/2 replay boundary."""
...
def check(payload):
    ...
    require(payload["status"] == "PASS" and payload["rows"] == 36
            ...
            and pairing_one["z_lifts"] == 16
            and pairing_two["z_lifts"] == 32
            and pairing_one["leading_boundaries"] == 24
            and pairing_two["leading_boundaries"] == 48
            and pairing_one["final_color_nonzero"] == 64
            and pairing_two["final_color_nonzero"] == 64
...
def main():
    ...
    print("PASS cell-11 xi3 pairings-1/2 audit: roots=610 lanes=128 hostile=detected")
