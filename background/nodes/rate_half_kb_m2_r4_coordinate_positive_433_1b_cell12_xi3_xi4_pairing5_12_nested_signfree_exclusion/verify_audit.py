#!/usr/bin/env python3
"""Independent root and direct-lane audit for cell-12 pairing 5/12."""
...
def main():
    ...
    require(
        root_payload["schema"]
        == (
            "rate-half-kb-positive-433-1b-cell12-xi3-pairing5-"
            ...
            for z_row in finite.get("z_rows", []):
                ...
                for q_row in z_row["q_rows"]:
                    ...
                    for lane in q_row["lanes"]:
                        ...
                        lane_count += 1
    require(profile_visits == 128, "profile replay count")
    require(boundary_count == 8, "eight leading-boundary terminals")
    require(lift_count == 16 and lane_count == 32, "direct lift/lane census")
    print(
        "PASS pairing-5 adapter audit: "
        "profiles=128 unique=45 boundary=8 lifts=16 lanes=32"
    )
