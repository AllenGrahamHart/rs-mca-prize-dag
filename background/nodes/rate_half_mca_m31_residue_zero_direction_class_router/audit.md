...
The class count concerns normalized codeword directions, not slopes.  The
sets used in the Johnson count are the intrinsic agreement sets
`{q=p}`, so enlarging a chosen pair intersection is harmless.  Each class
...
The verifier reconstructs the prefix, Johnson denominator, class/line cap,
and common-core ceiling with exact integers and rejects four mutations.
