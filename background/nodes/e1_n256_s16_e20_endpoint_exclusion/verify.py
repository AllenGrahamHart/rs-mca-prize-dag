...
NODE="e1_n256_s16_e20_endpoint_exclusion"
DEPENDENCIES={"e1_n256_s16_e20_profile_parity_light_reduction","e1_n256_s16_e20_six_profile_exclusion"}
TARGETS={"e1_official_prime_exception_control","unsafe_crossing_family_instantiation"}
PROFILES={"(4,4)","(0,5)","(3,2,1)","(2,0,2)","(4,0,0,1)","(0,1,0,1)"}
def main()->None:
    ...
    assert "0<V<=38" in nodes[NODE]["statement"] and all(p in nodes[NODE]["statement"] for p in PROFILES)
    print("E1_N256_S16_E20_ENDPOINT_EXCLUSION_PASS profiles=6 exclusions=6 frontier=38 mutations=2")
