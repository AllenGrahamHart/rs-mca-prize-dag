#!/usr/bin/env python3
"""Verify complete exclusion of all 105 cell-11 labels."""
...
ACTIVE = (
    ...
    "cell11_active_labels_complete_exclusion"
)
ENDPOINT = (
    "rate_half_kb_m2_r4_coordinate_positive_433_1b_"
    "cell11_endpoint_roles_complete_exclusion"
)
...
def main():
    ...
    print(f"PASS cell-11 complete exclusion: labels=75+30={total}")
