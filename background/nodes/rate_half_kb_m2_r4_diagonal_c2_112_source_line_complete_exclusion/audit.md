...
1. The `96/12` count is a combinatorial orbit census, not an algebraic
   covariance theorem.
2. The colored quotient compiler gives the two target types but does not
   identify all literal source systems with one canonical representative.
3. The local six-cell crosswalk is exact and deliberately narrow:
...
7. No conclusion is drawn about coordinate/source-cover orientations or
   packet/source-row assembly outside the source-line branch.
