...
require("**status:** CONDITIONAL" in statement, "status")
...
require("literal-assignment coverage" in statement, "missing premise")
...
print("KB_C2_112_SOURCE_LINE_COMPLETE_EXCLUSION_CONDITIONAL_CONTRACT_PASS")
