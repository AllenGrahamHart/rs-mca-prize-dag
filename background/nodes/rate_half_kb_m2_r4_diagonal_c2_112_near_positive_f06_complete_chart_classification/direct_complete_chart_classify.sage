#!/usr/bin/env sage
"""Classify one F06 residual q-slice cell on its complete affine chart."""
...
payload = {
    "schema": "kb-c2-112-near-positive-f06-complete-chart-classifier-v1",
    "cell": cell,
