#!/usr/bin/env python3
"""Run independent complete-chart F06 audits on Modal."""
...
app = modal.App("rs-mca-k3-near-positive-f06-complete-chart-audit")
image = (
...
def main() -> None:
    ...
    output = {
        "schema": "kb-c2-112-near-positive-f06-complete-chart-audit-modal-v1",
        "results": results,
    }
