#!/usr/bin/env python3
"""Exact normalized m=4 third-moment frontier through V=162."""
...
SOURCE = HERE / "m4_residual_m3_frontier.cpp"
OUTPUT = HERE / "m4_residual_m3_frontier_result.json"
SHARDS = 32
...
app = modal.App("e1-prize-m4-residual-m3-frontier")
...
def write_packet(results: list[dict[str, object]]) -> None:
    ...
    packet = {
        "schema": "e1-prize-m4-residual-m3-frontier-v1",
...
def main() -> None:
    ...
    for result in frontier.map(range(SHARDS), order_outputs=False):
        ...
        print(f"M4_RESIDUAL_M3_PROGRESS returned={len(results)}/{SHARDS}")
    print(
        "M4_RESIDUAL_M3 "
