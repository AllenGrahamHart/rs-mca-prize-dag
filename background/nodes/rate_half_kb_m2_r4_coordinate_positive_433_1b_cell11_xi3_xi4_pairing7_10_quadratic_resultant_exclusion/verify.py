#!/usr/bin/env python3
"""Verify the cell-11 xi3/xi4 pairing-7/10 quadratic-resultant packet."""
...
SCRIPT = EXP / "rate_half_kb_positive_433_1b_cell11_xi3_pairing7_template_adapter_modal.py"
RESULT = EXP / "rate_half_kb_positive_433_1b_cell11_xi3_pairing7_template_adapter_result.json"
...
PINNED = {
    SCRIPT: "882688642971b76ae4466db333ddf70a1f65ebe1b792a5373917345777e1e653",
    RESULT: "f6c7e8875338926027e8994cce772a55e57e989c239b4cdfa6fa99881b3d6d41",
...
def main():
    ...
    require(
        payload["schema"]
        == "rate-half-kb-positive-433-1b-cell11-xi3-pairing7-adapter-v1"
        and payload["field"] == P
    ...
    require(
        ...
        and roots["field"] == P
        and roots["source_primary_sha256"]["7"] == digest(RESULT)
    ...
    require(manifest["id"] == NODE.name and manifest["status"] == "PROVED",
            "node manifest")
    print("PASS cell-11 xi3/xi4 pairing 7/10: "
