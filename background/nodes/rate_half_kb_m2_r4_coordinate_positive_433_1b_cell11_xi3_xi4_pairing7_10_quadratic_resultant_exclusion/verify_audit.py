#!/usr/bin/env python3
"""Independent root and direct-lane audit for cell-11 pairing 7/10."""
...
SCRIPT = EXP / (
    "rate_half_kb_positive_433_1b_cell11_xi3_pairing7_"
...
def main():
    ...
    require(
        ...
        and root_payload["source_primary_sha256"]["7"]
