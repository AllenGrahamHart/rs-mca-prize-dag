#!/usr/bin/env python3
"""Verify the cutoff-free E14 profile/parity router."""
...
NODE = "e1_n256_s16_e14_profile_parity_light_reduction"
DEPENDENCIES = {
    "e1_n256_s16_e15_endpoint_exclusion",
...
EXCLUSION = "e1_n256_s16_e14_four_profile_exclusion"
...
def main() -> None:
    ...
    assert packet["complete"] and packet["variance"] == 28 and packet["energy"] == 14
    assert packet["l1_bound"] == 10 and packet["profile_count"] == 4
    ...
    assert packet["relevant_normalized_supports"] == 288_888
    assert packet["relevant_affine_templates"] == 1_321
    assert packet["direct_vector_floor"] == 26_219_123_456
    run = subprocess.run(
        [sys.executable, str(ROOT / pin["probe_checker_file"])],
        cwd=ROOT, capture_output=True, text=True, timeout=30, check=True)
    assert "l1=10 profiles=4 survivors=4 templates=1321 floor=26219123456" in run.stdout
    ...
    print("E1_N256_S16_E14_PROFILE_PARITY_LIGHT_REDUCTION_PASS "
          "l1=10 profiles=4 survivors=4 templates=1321 floor=26219123456 mutations=1")
