...
- The next complete core slice `(0,1,3)` has only three actual activations,
  ...
  `(0,1,30)` each have three activations, and `(0,1,31)` has four activations.
...
remaining full census is now organized into 91 core-orbit slices; 30 are
...
`(0,1,30)`, and `(0,1,31)`.  The resultant/common-root pass over all
