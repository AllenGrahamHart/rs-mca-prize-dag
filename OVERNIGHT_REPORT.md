...
- The next complete core slice `(0,1,3)` has only three actual activations,
  ...
  `(0,1,30)` each have three activations, `(0,1,31)` has four activations, and
  `(0,1,32)` has fourteen activations.
...
remaining full census is now organized into 91 core-orbit slices; 31 are
...
`(0,1,30)`, `(0,1,31)`, and `(0,1,32)`.  The resultant/common-root pass over all
