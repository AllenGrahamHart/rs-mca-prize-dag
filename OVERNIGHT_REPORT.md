...
complete with `32/129766` actual activations.
...
Continuation update: the complete core-by-core census is now 63 of 91 core
types complete, through `(0,1,64)`.  The latest slice has `1074/129766`
rational norm exceptions and `32/129766` actual common-root activation
exceptions.
