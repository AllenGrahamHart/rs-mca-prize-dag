...
core type `(0,1,66)` is complete with `4/129766` actual activations.
...
Continuation update: the complete core-by-core census is now 65 of 91 core
types complete, through `(0,1,66)`.  The latest slice has `1070/129766`
rational norm exceptions and `4/129766` actual common-root activation
exceptions.
