...
`2/129766` actual activations, both at `p=30817`.
...
Continuation update: the complete core-by-core census is now 82 of 91 core
types complete, through `(0,1,83)`.  The latest slice has `1218/129766`
rational norm exceptions and `2/129766` actual common-root activation
exceptions, both at `p=30817`.
