...
`(0,1,60)` is complete with `1/129766` actual activation.
...
Continuation update: the complete core-by-core census is now 59 of 91 core
types complete, through `(0,1,60)`.  The latest slice has `1289/129766`
rational norm exceptions and `1/129766` actual common-root activation
exception.
