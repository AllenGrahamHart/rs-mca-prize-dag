...
`(0,1,9)` is complete with `5/129766` actual activations.
...
remaining full census is now organized into 91 core-orbit slices; 8 are
complete, represented by `(0,1,2)`, `(0,1,3)`, `(0,1,4)`, `(0,1,5)`,
`(0,1,6)`, `(0,1,7)`, `(0,1,8)`, and `(0,1,9)`.  The
