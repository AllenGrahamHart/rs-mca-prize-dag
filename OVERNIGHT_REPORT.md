...
type `(0,1,12)` is complete with `2/129766` actual activations.
...
- The next complete core slice `(0,1,3)` has only three actual activations,
  ...
  `(0,1,12)` again has two activations.
...
remaining full census is now organized into 91 core-orbit slices; 11 are
complete, represented by `(0,1,2)`, `(0,1,3)`, `(0,1,4)`, `(0,1,5)`,
`(0,1,6)`, `(0,1,7)`, `(0,1,8)`, `(0,1,9)`, `(0,1,10)`, `(0,1,11)`, and
`(0,1,12)`.  The resultant/common-root pass over all representatives and final
