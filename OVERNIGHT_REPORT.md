...
`(0,1,65)` is complete with `14/129766` actual activations.
...
Continuation update: the complete core-by-core census is now 64 of 91 core
types complete, through `(0,1,65)`.  The latest slice has `957/129766`
rational norm exceptions and `14/129766` actual common-root activation
exceptions.
