...
`(0,1,70)` is complete with `1/129766` actual activation.
...
Continuation update: the complete core-by-core census is now 69 of 91 core
types complete, through `(0,1,70)`.  The latest slice has `1093/129766`
