#!/usr/bin/env python3
"""Reconstruct cell-5 pairings-3/4/5 norm roots independently on Modal."""
...
app = modal.App("rs-mca-positive-433-1b-cell5-pairings3-5-independent-roots")
image = modal.Image.debian_slim(python_version="3.12").pip_install(
    "sympy==1.14.0"
)


@app.function(image=image, cpu=1.0, memory=2048, timeout=300, max_containers=45)
def audit(profile):
    import warnings
