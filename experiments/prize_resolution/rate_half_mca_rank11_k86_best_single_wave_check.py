#!/usr/bin/env python3
"""Merge the paired complete K'=86 best-single wave."""
...
def main() -> None:
    ...
    for job, wrapper in jobs.items():
        ...
        assert row["units_checked"] == (76 - offset) * 5929
        assert wrapper["progress_rows"] == 76 - offset
    ...
    assert source_units == 13_571_481
    assert unsafe_units == 415_413
    print(json.dumps({
        "status": "PASS",
