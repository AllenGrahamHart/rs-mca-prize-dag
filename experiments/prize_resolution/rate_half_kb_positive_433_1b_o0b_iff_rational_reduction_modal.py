#!/usr/bin/env python3
"""Run the four-variable necessary superset for the surviving O0b IFF branch."""
...
PROGRAM = DIRECTORY / "rate_half_kb_positive_433_1b_o0b_iff_rational_reduction_program.py"
COLLAPSED_UNIT = DIRECTORY / "rate_half_kb_positive_433_1b_o0b_collapsed_common_admissible_result.json"
RESULT = DIRECTORY / "rate_half_kb_positive_433_1b_o0b_iff_rational_reduction_result.json"
REMOTE_CACHE = "/root/cache.json"
REMOTE_BASIS = "/root/basis.json"
REMOTE_PROGRAM = "/root/iff_rational_reduction_program.py"
PRIME = 2130706433
...
app = modal.App("rs-mca-positive-433-1b-o0b-iff-rational-reduction")
image = (
...
@app.function(image=image, cpu=1.0, memory=4096, timeout=210)
def decide_branch():
    core = load("iff_rational_reduction_program", REMOTE_PROGRAM)
...
def write_checkpoint(row, collection_complete):
    payload = {
        "schema": "rate-half-kb-positive-433-1b-o0b-iff-rational-reduction-v1",
        "app": "rs-mca-positive-433-1b-o0b-iff-rational-reduction",
        "collection_complete": collection_complete,
        "field": PRIME,
        "source_cache_sha256": CACHE_SHA256,
        "source_basis_sha256": BASIS_SHA256,
        "source_collapsed_unit_sha256": COLLAPSED_UNIT_SHA256,
