#!/usr/bin/env python3
"""Independently reconstruct cell-9 xi=3 pairing-1 roots."""
...
MANIFEST = DIRECTORY / (
    "rate_half_kb_positive_433_1b_cell9_xi3_pairing1_chart_result/manifest.json"
)
RESULT = DIRECTORY / (
...
app = modal.App(
    "rs-mca-positive-433-1b-cell9-xi3-pairing1-frobenius-roots"
)
