#!/usr/bin/env python3
"""Run the E1 profile-weight payoff verifier on one small Modal container."""
...
VERIFIER = ROOT / "experiments/prize_resolution/e1_profile_weight_payoff_ladder.py"
DAG = ROOT / "dag.json"

app = modal.App("e1-profile-weight-payoff-ladder")
image = (
