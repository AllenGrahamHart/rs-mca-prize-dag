#!/usr/bin/env python3
"""Run dual complete E23 four-profile censuses on Modal."""
...
PRIMARY=HERE/"e23_four_profile_census.cpp"
AUDIT=HERE/"e23_four_profile_census_audit.cpp"
PROBE=HERE/"e23_profile_parity_probe_result.json"
RESULT=HERE/"e23_four_profile_census_result.json"
REMOTE_PRIMARY_SOURCE="/root/e23_four_profile_census.cpp"
REMOTE_AUDIT_SOURCE="/root/e23_four_profile_census_audit.cpp"
REMOTE_PRIMARY="/root/e23_four_profile_census"
REMOTE_AUDIT="/root/e23_four_profile_census_audit"

app=modal.App("e1-n256-e23-four-profile-census")
...
def main()->None:
    ...
    if not probe["complete"] or int(probe["relevant_affine_templates"]) != 8:
        raise RuntimeError("E23 router is incomplete or changed")
    root=HERE.parents[1]
    ...
    def write_checkpoint(complete:bool)->dict[str,object]:
        ...
        packet={
            "schema":"e1-e23-four-profile-census-v1","complete":complete,
    ...
    try:
        ...
        print(f"E23_FOUR_PROFILE_CENSUS_INCOMPLETE completed={len(rows)}/8")
        raise
    ...
    print("E23_FOUR_PROFILE_CENSUS "+json.dumps(packet["summary"],sort_keys=True))
    print(f"E23_FOUR_PROFILE_CENSUS_COMPLETE {packet['complete']}")
    print(f"E23_FOUR_PROFILE_CENSUS_RESULT {RESULT}")
