#!/usr/bin/env python3
"""Scout the pinned xi=3 pairing-11 compiler on cell-9 charts."""
...
RESULT = DIRECTORY / (
    "rate_half_kb_positive_433_1b_cell9_xi3_pairing11_chart_scout_result.json"
)
FULL_RESULT = DIRECTORY / (
    "rate_half_kb_positive_433_1b_cell9_xi3_pairing11_chart_result"
)
...
app = modal.App("rs-mca-positive-433-1b-cell9-xi3-pairing11-chart-scout")
image = (
...
def main(
    ...
    if full:
        ...
        writer = ShardedResultWriter(full_result, metadata={
            ...
            "scope": (
                ...
                "sign-free "
                "compiler for cell-9 xi=3, pairing=11."
            ),
    ...
    output = {
        "schema": "rate-half-kb-positive-433-1b-cell9-xi3-pairing11-chart-scout-v1",
        "field": PRIME,
