#!/usr/bin/env python3
"""Benchmark the rigorous m16 early-cap interval screen."""
...
OUTPUT = Path(
    ...
    "e1_profile_36_mu4_m16_early_cap_benchmark_result.json"
)

app = modal.App("e1-profile-36-mu4-m16-early-cap-benchmark")
image = (
...
def main() -> None:
    ...
    result = {
        "schema": "e1-profile-36-mu4-m16-early-cap-benchmark-v1",
    ...
    print(
        "E1_PROFILE_36_MU4_M16_EARLY_CAP_BENCHMARK_PASS "
