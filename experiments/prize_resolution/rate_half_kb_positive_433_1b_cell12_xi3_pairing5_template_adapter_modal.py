#!/usr/bin/env python3
"""Apply the pinned pairing-5 compiler to cell 12."""
...
TEMPLATE = DIRECTORY / (
    "rate_half_kb_positive_433_1b_cell4_xi3_pairing5_nested_signfree_modal.py"
)
TOWER = DIRECTORY / (
...
app = modal.App("rs-mca-positive-433-1b-cell12-xi3-pairing5-adapter")
image = (
...
@app.function(image=image, cpu=2.0, memory=4096, timeout=900, max_containers=8)
def evaluate(case):
    import time
...
def main(limit: int = 0):
    ...
    output = {
        ...
        "scope": (
            ...
            "xi=3, pairing 5; adapter evidence until audited."
        ),
