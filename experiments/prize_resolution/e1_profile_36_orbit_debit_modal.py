#!/usr/bin/env python3
"""Run the profile-36 orbit-debit verifier on a small Modal container."""
...
VERIFIER = ROOT / "experiments/prize_resolution/e1_profile_36_orbit_debit.py"
DAG = ROOT / "dag.json"

app = modal.App("e1-profile-36-orbit-debit")
image = (
