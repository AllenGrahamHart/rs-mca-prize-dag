#!/usr/bin/env python3
"""Reconstruct pairing-7 norm roots independently on Modal."""
...
app = modal.App("rs-mca-positive-433-1b-cell5-pairing7-independent-roots")
image = modal.Image.debian_slim(python_version="3.12").pip_install(
    "sympy==1.14.0"
)


@app.function(image=image, cpu=1.0, memory=2048, timeout=300, max_containers=41)
def audit(profile):
    import warnings
