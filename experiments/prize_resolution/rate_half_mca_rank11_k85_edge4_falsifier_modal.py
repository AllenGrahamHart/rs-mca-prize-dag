#!/usr/bin/env python3
"""Run one K'=85 edge-4 falsifier and replay any witness."""
...
SCAN = DIRECTORY / "rate_half_mca_rank11_k85_edge4_domination_falsifier.py"
AUDIT = DIRECTORY / "rate_half_mca_rank11_k85_edge4_witness_audit.py"
...
app = modal.App("rate-half-mca-rank11-k85-edge4-falsifier")
image = (
...
def run(offset: int) -> dict[str, object]:
    ...
    if result["event"] == "FALSIFIED":
        ...
        keys = (
            ...
            "edge4_cap", "raw_before", "raw_before_high", "edge4_after",
            "edge4_high", "leader", "excess_over_leader",
        )
