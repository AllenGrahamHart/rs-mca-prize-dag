#!/usr/bin/env python3
"""Apply the pinned pairing-7 compiler to cell 12."""
...
app = modal.App("rs-mca-positive-433-1b-cell12-xi3-pairing7-adapter")
image = (
...
def main(limit: int = 0):
    ...
    output = {
        ...
        "scope": (
            ...
            "compiler for xi=3, pairing 7; adapter evidence until audited."
        ),
