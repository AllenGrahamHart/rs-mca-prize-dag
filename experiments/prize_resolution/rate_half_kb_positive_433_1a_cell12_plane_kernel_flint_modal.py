#!/usr/bin/env python3
"""Clear cell-12 plane-chart kernel denominators with FLINT."""
...
KERNEL = DIRECTORY / "rate_half_kb_positive_433_1a_cell12_kernel_reduction_result.json"
RESULT = DIRECTORY / "rate_half_kb_positive_433_1a_cell12_plane_kernel_flint_result.json"
REMOTE_SCOUT = "/root/remaining_lex_scout.json"
REMOTE_KERNEL = "/root/cell12_kernel_reduction.json"
PRIME = 2130706433
NAMES = ("a20", "a21", "a22", "a00", "a01", "a02", "b10", "b11")

app = modal.App("rs-mca-positive-433-1a-cell12-plane-kernel-flint")
image = (
...
def clear_denominators():
    ...
    if len(basis) != 9:
        raise RuntimeError("unexpected cell-12 lex basis")
...
def main():
    output = {
        "schema": "rate-half-kb-positive-433-1a-cell12-plane-kernel-flint-v1",
        "scope": (
            "Exact denominator clearing and plane reduction of the cell-12 "
