#!/usr/bin/env python3
"""Independently reconstruct cell-9 xi=3 pairing-7 roots."""
...
MANIFEST = DIRECTORY / (
    "rate_half_kb_positive_433_1b_cell9_xi3_pairing7_chart_result/manifest.json"
)
RESULT = DIRECTORY / (
...
app = modal.App(
    "rs-mca-positive-433-1b-cell9-xi3-pairing7-frobenius-roots"
)
...
def main():
    ...
    output = {
        "schema": (
            "rate-half-kb-positive-433-1b-cell9-xi3-pairing7-"
            "frobenius-roots-v1"
        ),
        "field": PRIME,
