...
#include "e1_profile_36_mu6_m64_direct_radius.cpp"
...
struct AuditCounts {
    ...
    std::array<uint64_t, 47> live_by_energy{};
    std::array<uint64_t, 47> above_by_energy{};
};
...
int main() {
    ...
    for (int candidate_energy = 2; candidate_energy <= 46; ++candidate_energy) {
