#!/usr/bin/env python3
"""Reconstruct parallel-DE pairing-3 norm roots independently on Modal."""
...
app = modal.App("rs-mca-positive-433-1b-cell11-de-pairing3-independent-roots")
...
def main():
    ...
    output = {
        "schema": (
            "rate-half-kb-positive-433-1b-cell11-de-pairing3-"
