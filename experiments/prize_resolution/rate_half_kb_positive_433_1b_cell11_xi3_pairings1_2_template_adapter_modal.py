#!/usr/bin/env python3
"""Apply the pinned reciprocal-linear compiler to cell-11 pairings 1-2."""
...
RESULT = DIRECTORY / (
    "rate_half_kb_positive_433_1b_cell11_xi3_pairings1_2_template_adapter_result.json"
)
...
app = modal.App("rs-mca-positive-433-1b-cell11-xi3-pairings1-2-adapter")
image = (
...
def main(limit: int = 0):
    ...
    output = {
        "schema": "rate-half-kb-positive-433-1b-cell11-xi3-pairings1-2-adapter-v1",
        "field": PRIME,
        "scope": (
            "Cell-11 execution of the pinned reciprocal-linear compiler for "
