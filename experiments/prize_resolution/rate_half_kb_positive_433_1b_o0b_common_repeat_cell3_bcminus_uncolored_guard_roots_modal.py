...
app = modal.App("rs-mca-positive-433-1b-o0b-cell3-bcminus-uncolored-guard-roots")
image = (
...
@app.function(image=image, cpu=1.0, memory=1024, timeout=120, max_containers=47)
def roots(digest):
...
def main():
    ...
    output = {
        "schema": "rate-half-kb-positive-433-1b-o0b-cell3-bcminus-uncolored-guard-roots-v1",
        "scope": (
