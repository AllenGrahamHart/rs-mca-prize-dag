#!/usr/bin/env python3
"""Classify deployed leading-coefficient boundaries of the cell-11 tower."""
...
app = modal.App("rs-mca-positive-433-1b-cell11-tower-boundary")
image = (
...
def main():
    ...
    for case, result in zip(cases, raw):
        if isinstance(result, BaseException):
            ...
            rows.append(result)
    output = {
        "schema": "rate-half-kb-positive-433-1b-cell11-tower-boundary-v1",
        "field": PRIME,
        "scope": (
            "Exact deployed-field classification of the two non-guard "
            "leading-coefficient fibers in one cell-11 common chart."
        ),
