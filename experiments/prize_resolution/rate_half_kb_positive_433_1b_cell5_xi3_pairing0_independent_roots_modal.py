#!/usr/bin/env python3
"""Reconstruct pairing-0 norm roots independently on Modal."""
...
PRIMARY = DIRECTORY / (
    "rate_half_kb_positive_433_1b_cell5_xi3_pairing0_"
...
app = modal.App("rs-mca-positive-433-1b-cell5-pairing0-independent-roots")
...
def main():
    ...
    output = {
        "schema": (
            "rate-half-kb-positive-433-1b-cell5-xi3-pairing0-"
