#!/usr/bin/env python3
"""Apply the pinned parallel-DE pairing-3 compiler to cell 5."""
...
RESULT = DIRECTORY / (
    "rate_half_kb_positive_433_1b_cell5_de_pairing3_"
...
app = modal.App("rs-mca-positive-433-1b-cell5-de-pairing3-adapter")
image = (
...
def main(limit: int = 0):
    ...
    output = {
        "schema": (
            "rate-half-kb-positive-433-1b-cell5-de-pairing3-adapter-v1"
        ),
        "field": PRIME,
        "scope": (
