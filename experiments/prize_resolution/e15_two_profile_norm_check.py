#!/usr/bin/env python3
"""Check the dual exact E15 cyclotomic norm ledger."""
...
SOURCE = HERE / "e15_two_profile_norm_modal.py"
...
def main() -> None:
    ...
    assert packet["schema"] == "e1-e15-two-profile-norm-v1"
    ...
    print(
        "E15_TWO_PROFILE_NORM_CHECK_PASS "
