#!/usr/bin/env python3
"""Independently reconstruct cell-9 xi=3 pairing-0 roots."""
...
MANIFEST = DIRECTORY / (
    "rate_half_kb_positive_433_1b_cell9_xi3_pairing0_chart_result/manifest.json"
)
RESULT = DIRECTORY / (
...
app = modal.App(
    "rs-mca-positive-433-1b-cell9-xi3-pairing0-frobenius-roots"
)
