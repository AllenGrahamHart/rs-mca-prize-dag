#!/usr/bin/env python3
"""Apply the pinned parallel-DE pairing-4 compiler to cell 12."""
...
app = modal.App("rs-mca-positive-433-1b-cell12-de-pairing4-adapter")
image = (
...
def main(limit: int = 0):
    ...
    output = {
        ...
        "scope": (
            ...
            "parallel-DE xi in {0,2}, pairing 4; adapter evidence until audited."
        ),
