#!/usr/bin/env python3
"""Run the normal-form-first FFF square subsystem."""
...
SQUARE = DIRECTORY / "rate_half_kb_positive_433_1b_o0b_fff_square_subsystem_program.py"
PROGRAM = DIRECTORY / "rate_half_kb_positive_433_1b_o0b_fff_reduced_square_program.py"
SQUARE_TIMEOUT = DIRECTORY / "rate_half_kb_positive_433_1b_o0b_fff_square_subsystem_result.json"
RESULT = DIRECTORY / "rate_half_kb_positive_433_1b_o0b_fff_reduced_square_result.json"
REMOTE_CACHE = "/root/cache.json"
REMOTE_BASIS = "/root/basis.json"
REMOTE_SQUARE = "/root/fff_square_subsystem_program.py"
REMOTE_PROGRAM = "/root/fff_reduced_square_program.py"
PRIME = 2130706433
...
app = modal.App("rs-mca-positive-433-1b-o0b-fff-reduced-square")
image = (
    modal.Image.debian_slim(python_version="3.12")
    .apt_install("singular")
    .add_local_file(CACHE, REMOTE_CACHE)
    .add_local_file(BASIS, REMOTE_BASIS)
    .add_local_file(SQUARE, REMOTE_SQUARE)
...
def decide_subsystem():
    square = load("fff_square_subsystem_program", REMOTE_SQUARE)
    core = load("fff_reduced_square_program", REMOTE_PROGRAM)
    ...
    built = core.build(packet_row, basis_row, square)
...
def write_checkpoint(row, collection_complete):
    payload = {
        "schema": "rate-half-kb-positive-433-1b-o0b-fff-reduced-square-v1",
        "app": "rs-mca-positive-433-1b-o0b-fff-reduced-square",
        "collection_complete": collection_complete,
        "field": PRIME,
        "source_cache_sha256": CACHE_SHA256,
        "source_basis_sha256": BASIS_SHA256,
        "source_square_sha256": SQUARE_SHA256,
        "source_square_timeout_sha256": SQUARE_TIMEOUT_SHA256,
