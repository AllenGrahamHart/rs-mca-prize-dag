...
AUDITOR = DIRECTORY / "rate_half_kb_positive_433_1b_cell5_common_f_resultant_audit.py"
PRIMARY = DIRECTORY / (
...
RESULT = DIRECTORY / (
    "rate_half_kb_positive_433_1b_cell5_de_pairing11_direct_audit_result.json"
)
...
app = modal.App("rs-mca-positive-433-1b-cell5-de-pairing11-direct-audit")
image = (
...
def main():
    ...
    output = {
        "schema": "rate-half-kb-positive-433-1b-cell5-de-pairing11-direct-audit-v1",
        "field": PRIME,
