#!/usr/bin/env python3
"""Apply the pinned positive-DE pairing-14 compiler to cell 12."""
...
app = modal.App("rs-mca-positive-433-1b-cell12-positive-de-pairing14-adapter")
image = (
...
def main(limit: int = 0):
    ...
    output = {
        "schema": (
            ...
            "pairing14-adapter-v1"
        ),
        "field": PRIME,
        "scope": (
            "Cell-12 execution of the pinned common-f resultant compiler "
            "for positive-DE xi=0, pairing 14; adapter evidence until audited."
        ),
