#!/usr/bin/env python3
"""Decide every deployed cell-9 linear exceptional scale in the common ideal."""
...
FACTORS = DIRECTORY / "rate_half_kb_positive_433_1a_cell9_exceptional_scale_factor_result.json"
RESULT = DIRECTORY / "rate_half_kb_positive_433_1a_cell9_exceptional_common_charts_result.json"
REMOTE_SCOUT = "/root/remaining_lex_scout.json"
REMOTE_FACTORS = "/root/cell9_exceptional_scales.json"
PRIME = 2130706433

app = modal.App("rs-mca-positive-433-1a-cell9-exceptional-common-charts")
image = (
...
def main():
    ...
    output = {
        "schema": "rate-half-kb-positive-433-1a-cell9-exceptional-common-charts-v1",
        "scope": (
            "Exact original-common-ideal decisions at every deployed linear "
            "root of the cell-9 chart scales; no outside, orbit, or Prize claim."
        ),
