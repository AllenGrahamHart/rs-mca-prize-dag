#!/usr/bin/env python3
"""Benchmark the exact-upper-product primitive reverse audit."""
...
OUTPUT = Path(
    ...
    "e1_profile_36_mu4_m16_primitive_reverse_upper_benchmark_result.json"
)

app = modal.App("e1-profile-36-mu4-m16-primitive-reverse-upper-benchmark")
image = (
...
def main() -> None:
    ...
    result = {
        "schema": "e1-profile-36-mu4-m16-primitive-reverse-upper-benchmark-v1",
    ...
    print(
        "E1_PROFILE_36_MU4_M16_PRIMITIVE_REVERSE_UPPER_BENCHMARK_PASS "
