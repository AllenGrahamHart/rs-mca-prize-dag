#!/usr/bin/env python3
"""Apply the pinned parallel-DE pairing-3 compiler to cell 12."""
...
app = modal.App("rs-mca-positive-433-1b-cell12-de-pairing3-adapter")
image = (
...
def main(limit: int = 0):
    ...
    output = {
        ...
        "scope": (
            ...
            "parallel-DE xi in {0,2}, pairing 3; adapter evidence until audited."
        ),
    ...
    print(json.dumps({
        ...
        "rows": [
            {key: row.get(key) for key in (
                ...
                "route_point_count", "uv_candidate_count",
