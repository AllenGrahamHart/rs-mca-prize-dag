#!/usr/bin/env python3
"""Independently check the dual E20 full-conductor collection."""
...
PRIMARY = HERE / "e20_six_profile_collect.cpp"
AUDIT = HERE / "e20_six_profile_collect_audit.cpp"
...
def main() -> None:
    ...
    assert packet["schema"] == "e1-e20-six-profile-collect-v1"
    ...
    for row in rows:
        ...
        for match in primary["matches"]:
            ...
            positions = [int(value) for value in match["positions"]]
            assert 0 <= profile < 6 and len(positions) == 7
    ...
    print(
        "E20_SIX_PROFILE_COLLECT_CHECK_PASS "
