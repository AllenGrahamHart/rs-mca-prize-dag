#!/usr/bin/env python3
"""Check the dual exact E17 cyclotomic norm ledger."""
...
SOURCE = HERE / "e17_five_profile_norm_modal.py"
...
def main() -> None:
    ...
    assert packet["schema"] == "e1-e17-five-profile-norm-v1"
    ...
    print(
        "E17_FIVE_PROFILE_NORM_CHECK_PASS "
