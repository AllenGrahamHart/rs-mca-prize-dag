#!/usr/bin/env python3
"""Reduce the cell-14 common coefficient kernel modulo its lex curve basis."""
...
RESULT = DIRECTORY / "rate_half_kb_positive_433_1a_cell14_kernel_reduction_result.json"
...
app = modal.App("rs-mca-positive-433-1a-cell14-kernel-reduction")
image = (
...
def reduce_kernel():
    ...
    a2, a0, b1, common_gcd, _ = common_kernel(14, -1, -1)
...
def main():
    output = {
        "schema": "rate-half-kb-positive-433-1a-cell14-kernel-reduction-v1",
        "scope": (
            "Exact reduction of the unique common coefficient kernel modulo "
            "the cell-14 lex curve basis; no outside, route, K3, or Prize claim."
        ),
