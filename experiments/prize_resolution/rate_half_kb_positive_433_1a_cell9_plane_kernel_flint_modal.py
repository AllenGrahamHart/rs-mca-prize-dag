#!/usr/bin/env python3
"""Clear cell-9 plane-chart kernel denominators with FLINT."""
...
KERNEL = DIRECTORY / "rate_half_kb_positive_433_1a_cell9_kernel_reduction_result.json"
RESULT = DIRECTORY / "rate_half_kb_positive_433_1a_cell9_plane_kernel_flint_result.json"
REMOTE_SCOUT = "/root/remaining_lex_scout.json"
REMOTE_KERNEL = "/root/cell9_kernel_reduction.json"
PRIME = 2130706433
NAMES = ("a20", "a21", "a22", "a00", "a01", "a02", "b10", "b11")

app = modal.App("rs-mca-positive-433-1a-cell9-plane-kernel-flint")
image = (
...
def clear_denominators():
    ...
    c_terms = parse_polynomial(basis[6])
...
def main():
    output = {
        "schema": "rate-half-kb-positive-433-1a-cell9-plane-kernel-flint-v1",
        "scope": (
            "Exact denominator clearing and plane reduction of the cell-9 "
