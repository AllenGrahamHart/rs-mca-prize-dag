#!/usr/bin/env python3
"""Run the root-free determinant superset of the collapsed O0b FFI chart."""
...
PROGRAM = DIRECTORY / "rate_half_kb_positive_433_1b_o0b_ffi_rootfree_program.py"
COLLAPSED = DIRECTORY / "rate_half_kb_positive_433_1b_o0b_ffi_collapsed_result.json"
RESULT = DIRECTORY / "rate_half_kb_positive_433_1b_o0b_ffi_rootfree_result.json"
REMOTE_CACHE = "/root/cache.json"
REMOTE_BASIS = "/root/basis.json"
REMOTE_COMPILER = "/root/cached_outside_core.py"
REMOTE_PROGRAM = "/root/ffi_rootfree_program.py"
PRIME = 2130706433
...
app = modal.App("rs-mca-positive-433-1b-o0b-ffi-rootfree")
image = (
...
def decide_chart():
    ...
    program_core = load("ffi_rootfree_program", REMOTE_PROGRAM)
...
def write_checkpoint(row, collection_complete):
    payload = {
        "schema": "rate-half-kb-positive-433-1b-o0b-ffi-rootfree-v1",
        "app": "rs-mca-positive-433-1b-o0b-ffi-rootfree",
