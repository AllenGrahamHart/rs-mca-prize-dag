#!/usr/bin/env python3
"""Solve cell-4 xi3/pairing5 by nested sign-free elimination."""
...
RESULT = DIRECTORY / (
    "rate_half_kb_positive_433_1b_cell4_xi3_pairing5_nested_signfree_result.json"
)
REMOTE_STRUCTURE = "/root/structure.json"
REMOTE_KERNEL = "/root/kernel.json"
PRIME = 2130706433

app = modal.App("rs-mca-positive-433-1b-cell4-xi3-pairing5-nested-signfree")
image = (
...
def main(cases: str = "-1:-1:-1", all_cases: bool = False):
    ...
    output = {
        "schema": (
            "rate-half-kb-positive-433-1b-cell4-xi3-pairing5-"
            "nested-signfree-v1"
        ),
        "field": PRIME,
        "scope": (
            "Exact nested q/z sign-free resultant norm and direct exceptional-"
            "root replay for cell 4 at xi=3 and pairing=5. Each source-sign/"
            "sigma_c row checks both sigma_o target lanes."
        ),
