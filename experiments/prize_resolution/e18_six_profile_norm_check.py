#!/usr/bin/env python3
"""Check the dual exact E18 cyclotomic norm ledger."""
...
SOURCE = HERE / "e18_six_profile_norm_modal.py"
...
def main() -> None:
    ...
    assert packet["schema"] == "e1-e18-six-profile-norm-v1"
    ...
    print(
        "E18_SIX_PROFILE_NORM_CHECK_PASS "
