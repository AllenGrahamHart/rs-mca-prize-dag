#!/usr/bin/env python3
"""Lift the cell-3 xi2/pairing0 target-free norm roots."""
...
PILOT = DIRECTORY / "rate_half_kb_positive_433_1b_cell3_xi2_pairing0_six_basis_cut_census_result.json"
RESULT = DIRECTORY / "rate_half_kb_positive_433_1b_cell3_xi2_pairing0_six_basis_root_replay_result.json"
CENSUS_RESULT = DIRECTORY / "rate_half_kb_positive_433_1b_cell3_xi2_pairing0_six_basis_root_replay_census_result.json"
...
app = modal.App("rs-mca-positive-433-1b-cell3-xi2-pairing0-six-basis-root-replay")
image = (
...
def main(signs: str = "-1:-1", all_signs: bool = False):
    ...
    output = {
        "schema": (
            ...
            if all_signs else
            "rate-half-kb-positive-433-1b-cell3-xi2-pairing0-six-basis-root-replay-v1"
        ),
        "scope": (
            "Exact deployed-field lift of the xi2/pairing0 target-free norm "
            "root ledger; no wider outside or cell claim."
        ),
