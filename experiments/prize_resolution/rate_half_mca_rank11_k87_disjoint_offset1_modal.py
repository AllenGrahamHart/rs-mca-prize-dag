#!/usr/bin/env python3
"""Paired exhaustive K'=87 support-disjoint stress on offset 1."""
...
PRIMARY = DIRECTORY / "rate_half_mca_rank11_k87_disjoint_domination_falsifier.py"
AUDIT = DIRECTORY / "rate_half_mca_rank11_k87_disjoint_domination_audit.py"
K87_PRIMARY = DIRECTORY / "rate_half_mca_rank11_k87_best_single_domination_falsifier.py"
K87_AUDIT = DIRECTORY / "rate_half_mca_rank11_k87_best_single_domination_audit.py"
K87_CORE = DIRECTORY / "rate_half_mca_rank11_k87_best_single_scan_core.py"
...
SOURCES = (
    PRIMARY, AUDIT, K87_PRIMARY, K87_AUDIT, K87_CORE,
    K85_PRIMARY, K85_AUDIT, K85_BASE, CODE, DEPS,
)
for path in SOURCES:
    if not path.is_file():
...
app = modal.App("rate-half-mca-rank11-k87-disjoint-offset1")
...
@app.function(image=image, cpu=1, memory=256, timeout=495)
