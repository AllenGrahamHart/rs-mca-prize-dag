#!/usr/bin/env python3
"""Run the exact root-free presentation of the collapsed O0b FFI chart."""
...
ROOTFREE = DIRECTORY / "rate_half_kb_positive_433_1b_o0b_ffi_rootfree_program.py"
PROGRAM = DIRECTORY / "rate_half_kb_positive_433_1b_o0b_ffi_exact_rootfree_program.py"
COLLAPSED = DIRECTORY / "rate_half_kb_positive_433_1b_o0b_ffi_collapsed_result.json"
SLOPE_ANCHORS = DIRECTORY / "rate_half_kb_positive_433_1b_o0b_collapsed_finite_slope_anchors.py"
RESULT = DIRECTORY / "rate_half_kb_positive_433_1b_o0b_ffi_exact_rootfree_result.json"
REMOTE_CACHE = "/root/cache.json"
REMOTE_BASIS = "/root/basis.json"
REMOTE_COMPILER = "/root/cached_outside_core.py"
REMOTE_ROOTFREE = "/root/ffi_rootfree_program.py"
REMOTE_PROGRAM = "/root/ffi_exact_rootfree_program.py"
PRIME = 2130706433
...
app = modal.App("rs-mca-positive-433-1b-o0b-ffi-exact-rootfree")
image = (
    ...
    .add_local_file(ROOTFREE, REMOTE_ROOTFREE)
...
def decide_chart():
    ...
    rootfree = load("ffi_rootfree_program", REMOTE_ROOTFREE)
    program_core = load("ffi_exact_rootfree_program", REMOTE_PROGRAM)
    ...
    built = program_core.build(packet_row, basis_row, compiler, rootfree)
...
def write_checkpoint(row, collection_complete):
    payload = {
        "schema": "rate-half-kb-positive-433-1b-o0b-ffi-exact-rootfree-v1",
        "app": "rs-mca-positive-433-1b-o0b-ffi-exact-rootfree",
        "collection_complete": collection_complete,
        "field": PRIME,
        "source_cache_sha256": CACHE_SHA256,
        "source_basis_sha256": BASIS_SHA256,
        "source_compiler_sha256": COMPILER_SHA256,
        "source_rootfree_sha256": ROOTFREE_SHA256,
        "source_program_sha256": hashlib.sha256(PROGRAM.read_bytes()).hexdigest(),
        "source_collapsed_sha256": COLLAPSED_SHA256,
        "source_slope_anchors_sha256": SLOPE_ANCHORS_SHA256,
        "row": row,
    }
