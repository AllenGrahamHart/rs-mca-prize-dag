#!/usr/bin/env python3
"""Replay the cell-9 positive-DE pairing-12 certificate."""
...
PRIMARY = DIRECTORY / (
    "rate_half_kb_positive_433_1b_cell9_positive_de_pairing12_chart_result"
)
ROOTS = DIRECTORY / (
    "rate_half_kb_positive_433_1b_cell9_positive_de_pairing12_"
...
RESULT = DIRECTORY / (
    "rate_half_kb_positive_433_1b_cell9_positive_de_pairing12_direct_audit_result.json"
)
...
app = modal.App(
    "rs-mca-positive-433-1b-cell9-positive-de-pairing12-direct-audit"
)
image = (
...
def audit(chart_case):
    ...
    expected_metadata = {
        ...
        "scope": (
            ...
            "positive-DE pairing-12 compiler for cell-9 xi=0."
        ),
    ...
    core.require(
        roots["schema"]
        == "rate-half-kb-positive-433-1b-cell9-positive-de-pairing12-frobenius-roots-v1"
    ...
    for row in json.loads(Path(REMOTE_BASE).read_text())["rows"]:
        ...
        relevant = [
            ...
            if item["pairing_index"] == 12 and item["xi_index"] == 0
        ]
        core.require(
    ...
    return {
        "schema": (
            "rate-half-kb-positive-433-1b-cell9-positive-de-pairing12-direct-audit-v1"
        ),
        "field": PRIME,
