...
namespace {
constexpr std::array<std::array<int, 4>, 5> kProfiles{{
    {{5, 3, 0, 0}}, {{1, 4, 0, 0}}, {{4, 1, 1, 0}},
    {{0, 2, 1, 0}}, {{1, 0, 0, 1}},
}};
struct Match {
  int profile = -1;
...
int main(int argc, char** argv) {
  ...
  std::array<std::uint64_t, 5> profile_counts{};
  std::array<std::uint64_t, 5> full_conductor_counts{};
