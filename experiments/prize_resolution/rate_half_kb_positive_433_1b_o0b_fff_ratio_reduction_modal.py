#!/usr/bin/env python3
"""Run the six-variable necessary superset for the canonical O0b FFF chart."""
...
PROGRAM = DIRECTORY / "rate_half_kb_positive_433_1b_o0b_fff_ratio_reduction_program.py"
IFF_UNIT = DIRECTORY / "rate_half_kb_positive_433_1b_o0b_iff_rational_reduction_result.json"
RESULT = DIRECTORY / "rate_half_kb_positive_433_1b_o0b_fff_ratio_reduction_result.json"
REMOTE_CACHE = "/root/cache.json"
REMOTE_BASIS = "/root/basis.json"
REMOTE_PROGRAM = "/root/fff_ratio_reduction_program.py"
PRIME = 2130706433
...
app = modal.App("rs-mca-positive-433-1b-o0b-fff-ratio-reduction")
image = (
...
def decide_chart():
    core = load("fff_ratio_reduction_program", REMOTE_PROGRAM)
...
def write_checkpoint(row, collection_complete):
    payload = {
        "schema": "rate-half-kb-positive-433-1b-o0b-fff-ratio-reduction-v1",
        "app": "rs-mca-positive-433-1b-o0b-fff-ratio-reduction",
        "collection_complete": collection_complete,
        "field": PRIME,
        "source_cache_sha256": CACHE_SHA256,
        "source_basis_sha256": BASIS_SHA256,
        "source_iff_unit_sha256": IFF_UNIT_SHA256,
