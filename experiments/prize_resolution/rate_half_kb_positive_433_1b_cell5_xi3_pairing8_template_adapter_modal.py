#!/usr/bin/env python3
"""Apply the pinned pairing-8 compiler to source-role cell 5."""
...
RESULT = DIRECTORY / (
    "rate_half_kb_positive_433_1b_cell5_xi3_pairing8_"
...
app = modal.App("rs-mca-positive-433-1b-cell5-xi3-pairing8-adapter")
image = (
...
def main(limit: int = 0):
    ...
    output = {
        ...
        "field": PRIME,
        "scope": (
            "Cell-5 execution of the pinned quadratic-resultant sign-free "
