...
app = modal.App("rs-mca-positive-433-1b-cell5-positive-de-pairing12-adapter")
image = (
...
def main(limit: int = 0):
    ...
    output = {
        "schema": (
            "rate-half-kb-positive-433-1b-cell5-positive-de-"
            "pairing12-adapter-v1"
        ),
        "field": PRIME,
        "scope": (
            "Cell-5 execution of the pinned nested-quadratic compiler for "
