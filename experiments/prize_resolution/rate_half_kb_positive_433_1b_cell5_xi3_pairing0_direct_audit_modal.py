#!/usr/bin/env python3
"""Independently replay the cell-5 xi=3 pairing-0 certificate."""
...
app = modal.App("rs-mca-positive-433-1b-cell5-xi3-pairing0-direct-audit")
image = (
...
def audit():
    ...
    totals = {key: 0 for key in (
        ...
        "third_pair_nonzero", "target_boundaries",
    )}
    profile_visits = 0
    for row in payload["rows"]:
