...
RESULT = DIRECTORY / (
    "rate_half_kb_positive_433_1b_cell5_xi3_pairing3_"
...
app = modal.App("rs-mca-positive-433-1b-cell5-xi3-pairing3-adapter")
image = (
...
def main(limit: int = 0):
    ...
    output = {
        ...
        "field": PRIME,
        "scope": (
            "Cell-5 execution of the pinned reciprocal-square/sign-free "
