#!/usr/bin/env python3
"""Reconstruct pairings-1-2 norm roots independently on Modal."""
...
PRIMARY = DIRECTORY / (
    "rate_half_kb_positive_433_1b_cell11_xi3_pairings1_2_"
...
app = modal.App("rs-mca-positive-433-1b-cell11-pairings1-2-independent-roots")
...
def main():
    ...
    output = {
        "schema": (
            "rate-half-kb-positive-433-1b-cell11-xi3-pairings1-2-"
