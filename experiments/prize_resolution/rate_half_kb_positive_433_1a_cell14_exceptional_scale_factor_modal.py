#!/usr/bin/env python3
"""Factor the cell-14 plane-chart exceptional scales over the deployed field."""
...
RESULT = DIRECTORY / "rate_half_kb_positive_433_1a_cell14_exceptional_scale_factor_result.json"
REMOTE_PLANE = "/root/cell14_plane_kernel_flint.json"
PRIME = 2130706433

app = modal.App("rs-mca-positive-433-1a-cell14-exceptional-scale-factor")
image = (
...
def main():
    output = {
        "schema": "rate-half-kb-positive-433-1a-cell14-exceptional-scale-factor-v1",
        "scope": (
            "Exact deployed-field factorization of the cell-14 plane-chart "
