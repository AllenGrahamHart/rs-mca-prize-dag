#!/usr/bin/env python3
"""Compute four-basis norms for the two cell-5 parallel-DE source cuts."""
...
app = modal.App("rs-mca-positive-433-1b-cell5-parallel-de-four-basis")
image = (
...
def main(limit: int = 0):
    ...
    output = {
        "schema": "rate-half-kb-positive-433-1b-cell5-parallel-de-four-basis-v1",
        "field": PRIME,
        "scope": (
            "Exact four-basis norms for the cell-5 first-pair parallel-DE "
