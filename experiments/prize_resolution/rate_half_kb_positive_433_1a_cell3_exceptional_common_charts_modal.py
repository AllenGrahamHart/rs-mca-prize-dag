#!/usr/bin/env python3
"""Decide the six deployed cell-3 exceptional t charts in the common ideal."""
...
FACTORS = DIRECTORY / "rate_half_kb_positive_433_1a_cell3_exceptional_scale_factor_result.json"
RESULT = DIRECTORY / "rate_half_kb_positive_433_1a_cell3_exceptional_common_charts_result.json"
REMOTE_SCOUT = "/root/cell3_triangle_scout.json"
REMOTE_FACTORS = "/root/cell3_exceptional_scales.json"
PRIME = 2130706433

app = modal.App("rs-mca-positive-433-1a-cell3-exceptional-common-charts")
image = (
...
def main():
    ...
    output = {
        "schema": "rate-half-kb-positive-433-1a-cell3-exceptional-common-charts-v1",
        "scope": (
            "Exact original-common-ideal decisions at every deployed linear "
            "root of the cell-3 chart scales; no outside, orbit, or Prize claim."
        ),
