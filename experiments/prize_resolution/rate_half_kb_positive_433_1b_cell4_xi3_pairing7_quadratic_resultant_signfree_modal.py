#!/usr/bin/env python3
"""Solve cell-4 xi3/pairing7 by a quadratic q-resultant and z sign cut."""
...
RESULT = DIRECTORY / (
    "rate_half_kb_positive_433_1b_cell4_xi3_pairing7_quadratic_resultant_signfree_result.json"
)
REMOTE_STRUCTURE = "/root/structure.json"
REMOTE_KERNEL = "/root/kernel.json"
PRIME = 2130706433

app = modal.App("rs-mca-positive-433-1b-cell4-xi3-pairing7-qresultant-signfree")
image = (
...
def main(cases: str = "-1:-1:-1", all_cases: bool = False):
    ...
    output = {
        ...
        "scope": (
            ...
            "exceptional-root replay for cell 4 at xi=3 and pairing=7. "
