#!/usr/bin/env python3
"""Paired bounded completion wave for K'=86 best-single domination."""
...
PRIMARY = DIRECTORY / "rate_half_mca_rank11_k86_best_single_domination_falsifier.py"
AUDIT = DIRECTORY / "rate_half_mca_rank11_k86_best_single_domination_audit.py"
CORE = DIRECTORY / "rate_half_mca_rank11_k86_best_single_scan_core.py"
...
app = modal.App("rate-half-mca-rank11-k86-best-single-wave")
...
@app.function(image=image, cpu=1, memory=256, timeout=315)
