...
AUDITOR = DIRECTORY / "rate_half_kb_positive_433_1b_cell11_positive_de_pairing14_common_f_audit.py"
PRIMARY = DIRECTORY / (
    "rate_half_kb_positive_433_1b_cell11_positive_de_pairing14_"
...
RESULT = DIRECTORY / (
    "rate_half_kb_positive_433_1b_cell11_positive_de_pairing14_direct_audit_result.json"
)
...
app = modal.App("rs-mca-positive-433-1b-cell11-positive-de-pairing14-direct-audit")
image = (
...
def main():
    ...
    output = {
        "schema": "rate-half-kb-positive-433-1b-cell11-positive-de-pairing14-direct-audit-v1",
        "field": PRIME,
