#!/usr/bin/env python3
"""Apply the pinned pairing-8 compiler to cell 12."""
...
app = modal.App("rs-mca-positive-433-1b-cell12-xi3-pairing8-adapter")
image = (
...
def main(limit: int = 0):
    ...
    output = {
        ...
        "field": PRIME,
        "scope": (
            "Cell-12 execution of the pinned quadratic-resultant sign-free "
            "compiler for xi=3, pairing 8; adapter evidence until audited."
        ),
