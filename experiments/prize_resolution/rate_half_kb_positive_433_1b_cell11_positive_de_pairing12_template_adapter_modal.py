#!/usr/bin/env python3
"""Apply the pinned positive-DE pairing-12 compiler to cell 5."""
...
app = modal.App("rs-mca-positive-433-1b-cell11-positive-de-pairing12-adapter")
image = (
...
def main(limit: int = 0):
    ...
    output = {
        "schema": (
            "rate-half-kb-positive-433-1b-cell11-positive-de-"
            "pairing12-adapter-v1"
        ),
        "field": PRIME,
        "scope": (
            "Cell-11 execution of the pinned nested-quadratic compiler for "
