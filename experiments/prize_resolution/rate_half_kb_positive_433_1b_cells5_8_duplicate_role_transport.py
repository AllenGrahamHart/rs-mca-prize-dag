#!/usr/bin/env python3
"""Verify exact B/C duplicate-role transport from cell 5 to cell 8."""
...
def common_cell5(b, c, r, t, iota, epsilon_1, epsilon_2):
    roots = (1, t, r, epsilon_2*iota*r, epsilon_1*iota)
...
def common_cell8(b, c, r, t, iota, epsilon_1, epsilon_2):
    roots = (1, r, t, epsilon_2*iota*r, epsilon_1*iota)
    products = (-1, b, c, b*c, -b*c)
    sums = (0, 1+b, 1+c, b+c, b-c)
    return {
        role: (sp.expand(product), sp.expand(root*edge_sum), sp.expand(root**2))
...
def main():
    ...
    for epsilon_1, epsilon_2 in itertools.product((-1, 1), repeat=2):
        left = common_cell5(b, c, r, t, iota, epsilon_1, epsilon_2)
        right = common_cell8(c, b, r, t, iota, -epsilon_1, epsilon_2)
