...
gcds at once. Each completed row is printed before the next starts.
"""
...
def endpoint_polynomials() -> dict[str, list[int]]:
    ...
    e = add(scale(multiply(s, s), 14), scale(b, 75), scale=-1)
    f = add(
...
def main(output: str = "") -> None:
    ...
    if output:
        ...
        print(f"L1_H7_LOW_DEGREE_NORM_CERTIFICATE {output}")
    print(rendered, end="")
