#!/usr/bin/env python3
"""Apply the pinned positive-DE pairing-14 compiler to cell 5."""
...
app = modal.App("rs-mca-positive-433-1b-cell11-positive-de-pairing14-adapter")
image = (
...
def main(limit: int = 0):
    ...
    output = {
        ...
        "field": PRIME,
        "scope": (
            "Cell-11 execution of the pinned common-f resultant compiler "
