...
RESULT = DIRECTORY / (
    "rate_half_kb_positive_433_1b_cell5_xi3_pairing4_"
...
app = modal.App("rs-mca-positive-433-1b-cell5-xi3-pairing4-adapter")
image = (
...
def main(limit: int = 0):
    ...
    output = {
        ...
        "field": PRIME,
        "scope": (
            "Cell-5 execution of the pinned nested sign-free compiler for "
