#!/usr/bin/env python3
"""Apply the pinned pairing-3 compiler to source-role cell 5."""
...
RESULT = DIRECTORY / (
    "rate_half_kb_positive_433_1b_cell11_xi3_pairing3_"
...
app = modal.App("rs-mca-positive-433-1b-cell11-xi3-pairing3-adapter")
image = (
...
def main(limit: int = 0):
    ...
    output = {
        ...
        "field": PRIME,
        "scope": (
            "Cell-11 execution of the pinned reciprocal-square/sign-free "
