#!/usr/bin/env python3
"""Independently reconstruct cell-9 pairing-4 roots by Frobenius/gcd."""
...
MANIFEST = DIRECTORY / (
    "rate_half_kb_positive_433_1b_cell9_de_pairing4_chart_result/manifest.json"
)
RESULT = DIRECTORY / (
...
app = modal.App("rs-mca-positive-433-1b-cell9-de-pairing4-frobenius-roots")
...
def main():
    ...
    output = {
        "schema": (
            "rate-half-kb-positive-433-1b-cell9-de-pairing4-"
            "frobenius-roots-v1"
        ),
        "field": PRIME,
