#!/usr/bin/env python3
"""Run the exact K'=87 component payment on Modal."""
...
PAYMENT = DIRECTORY / "rate_half_mca_rank11_k87_component_payment.py"
...
app = modal.App("rate-half-mca-rank11-k87-component-payment")
image = (
