#!/usr/bin/env python3
"""Scout the pinned pairing-5 compiler on the six cell-9 tower charts."""
...
app = modal.App("rs-mca-positive-433-1b-cell9-de-pairing5-chart-scout")
image = (
...
def main(
    ...
    output = {
        "schema": "rate-half-kb-positive-433-1b-cell9-de-pairing5-chart-scout-v1",
        "field": PRIME,
    ...
    if writer is not None:
        expected_rows = (
            ...
            else 1 if recovery_index >= 0 else 192
        )
