#!/usr/bin/env python3
"""Apply the pinned positive-DE pairing-12 compiler to cell 12."""
...
app = modal.App("rs-mca-positive-433-1b-cell12-positive-de-pairing12-adapter")
image = (
...
def main(limit: int = 0):
    ...
    output = {
        "schema": (
            ...
            "pairing12-adapter-v1"
        ),
        "field": PRIME,
        "scope": (
            "Cell-12 execution of the pinned nested-quadratic compiler for "
            "positive-DE xi=0, pairing 12; adapter evidence until audited."
        ),
