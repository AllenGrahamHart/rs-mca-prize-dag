#!/usr/bin/env python3
"""Compile the global coefficient kernel on the cell-5 common locus."""
...
app = modal.App("rs-mca-positive-433-1b-cell5-compact-kernel")
image = (
...
def main():
    ...
    for case, row in zip(cases, raw):
        if isinstance(row, BaseException):
            ...
            rows.append(row)
    output = {
        "schema": "rate-half-kb-positive-433-1b-cell5-compact-kernel-v1",
        "field": PRIME,
        "cell": CELL,
        "pivot": PIVOT,
        "scope": (
            "Exact global coefficient kernels on the guarded cell-5 common "
