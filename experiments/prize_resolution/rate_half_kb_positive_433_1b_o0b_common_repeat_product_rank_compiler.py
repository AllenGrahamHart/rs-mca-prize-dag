#!/usr/bin/env python3
"""Product-rank compiler for repeated-BC positive 433-1b -> O0b rows."""
...
def compile_cell(cell_index, bc_sign, dump=False):
    ...
    products = (-1, b, c, bc_sign*b*c, bc_sign*b*c)
    rows = [
...
def main():
    ...
    parser.add_argument("--bc-sign", type=int, choices=(-1, 1), required=True)
    parser.add_argument("--dump", action="store_true")
    arguments = parser.parse_args()
    print(json.dumps(compile_cell(
        arguments.cell, arguments.bc_sign, dump=arguments.dump),
