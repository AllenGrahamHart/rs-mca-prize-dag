#!/usr/bin/env python3
"""Check the dual complete E23 census and every retained vector."""
...
ATLAS=(ROOT/"background/nodes/e1_n256_s16_e27_profile_parity_light_reduction/notes"/
...
def main()->None:
    ...
    assert packet["schema"]=="e1-e23-four-profile-census-v1"
    ...
    print("E23_FOUR_PROFILE_CENSUS_CHECK_PASS "
