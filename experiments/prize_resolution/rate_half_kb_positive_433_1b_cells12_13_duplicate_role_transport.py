#!/usr/bin/env python3
"""Verify exact B/C duplicate-role transport from cell 12 to cell 13."""
...
def common_cell12(b, c, r, t, iota, epsilon_1, epsilon_2):
    roots = (1, epsilon_1*iota, r, epsilon_2*iota*r, t)
...
def common_cell13(b, c, r, t, iota, epsilon_1, epsilon_2):
    roots = (1, r, epsilon_1*iota, epsilon_2*iota*r, t)
    products = (-1, b, c, b*c, -b*c)
    sums = (0, 1+b, 1+c, b+c, b-c)
    return {
        role: (sp.expand(product), sp.expand(root*edge_sum), sp.expand(root**2))
...
def main():
    ...
    for epsilon_1, epsilon_2 in itertools.product((-1, 1), repeat=2):
        left = common_cell12(b, c, r, t, iota, epsilon_1, epsilon_2)
        right = common_cell13(c, b, r, -t, iota, epsilon_1, epsilon_2)
