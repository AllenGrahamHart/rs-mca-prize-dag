#!/usr/bin/env python3
"""Run the independent cell-5 positive-DE pairing-14 direct replay on Modal."""
...
AUDITOR = DIRECTORY / "rate_half_kb_positive_433_1b_cell5_positive_de_pairing14_common_f_audit.py"
PRIMARY = DIRECTORY / (
    "rate_half_kb_positive_433_1b_cell5_positive_de_pairing14_"
...
TOWER = DIRECTORY / "rate_half_kb_positive_433_1b_cell5_four_basis_tower_result.json"
KERNEL = DIRECTORY / "rate_half_kb_positive_433_1b_cell5_compact_kernel_result.json"
RESULT = DIRECTORY / (
    "rate_half_kb_positive_433_1b_cell5_positive_de_pairing14_direct_audit_result.json"
)
...
app = modal.App("rs-mca-positive-433-1b-cell5-positive-de-pairing14-direct-audit")
image = (
...
def audit():
    spec = importlib.util.spec_from_file_location("cell5_auditor", REMOTE_AUDITOR)
    ...
    return module.audit_result(
        ...
        primary_paths={"pairing14": primary},
...
def main():
    ...
    output = {
        "schema": "rate-half-kb-positive-433-1b-cell5-positive-de-pairing14-direct-audit-v1",
        "field": PRIME,
