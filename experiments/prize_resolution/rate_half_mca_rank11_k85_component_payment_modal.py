#!/usr/bin/env python3
"""Run the exact K'=85 component payment on Modal."""
...
PAYMENT = DIRECTORY / "rate_half_mca_rank11_k85_component_payment.py"
...
app = modal.App("rate-half-mca-rank11-k85-component-payment")
image = (
