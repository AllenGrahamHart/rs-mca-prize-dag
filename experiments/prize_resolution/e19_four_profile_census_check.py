#!/usr/bin/env python3
"""Check the dual complete E19 census and every retained vector."""
...
PROFILES=([3,4,0,0],[2,2,1,0],[1,0,2,0],[3,0,0,1])
...
def direct_profile(positions:list[int],coefficients:list[int])->list[int]:
    ...
    profile=[0]*4
    for d in range(1,64):
        magnitude=abs(product[d]); assert magnitude<=4
...
def main()->None:
    ...
    assert packet["schema"]=="e1-e19-four-profile-census-v1"
    ...
    print("E19_FOUR_PROFILE_CENSUS_CHECK_PASS "
