#!/usr/bin/env python3
"""Scout the pinned xi=3 pairing-5 compiler on cell-9 charts."""
...
RESULT = DIRECTORY / (
    "rate_half_kb_positive_433_1b_cell9_xi3_pairing5_chart_scout_result.json"
)
...
app = modal.App("rs-mca-positive-433-1b-cell9-xi3-pairing5-chart-scout")
image = (
...
def main(
    ...
    for envelope in evaluate.map(cases, order_outputs=False):
        ...
        rows.append({
            ...
            "xi_index": row["xi_index"], "pairing_index": 5,
    ...
    output = {
        "schema": "rate-half-kb-positive-433-1b-cell9-xi3-pairing5-chart-scout-v1",
        "field": PRIME,
