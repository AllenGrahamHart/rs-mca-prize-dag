#!/usr/bin/env python3
"""Apply the pinned pairing-5 compiler to source-role cell 5."""
...
RESULT = DIRECTORY / (
    "rate_half_kb_positive_433_1b_cell11_xi3_pairing5_"
...
app = modal.App("rs-mca-positive-433-1b-cell11-xi3-pairing5-adapter")
image = (
