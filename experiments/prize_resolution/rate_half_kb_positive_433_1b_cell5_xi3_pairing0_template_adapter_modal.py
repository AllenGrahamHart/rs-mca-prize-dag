...
RESULT = DIRECTORY / (
    "rate_half_kb_positive_433_1b_cell5_xi3_pairing0_template_adapter_result.json"
)
...
app = modal.App("rs-mca-positive-433-1b-cell5-xi3-pairing0-adapter")
image = (
...
def main(limit: int = 0):
    ...
    output = {
        "schema": "rate-half-kb-positive-433-1b-cell5-xi3-pairing0-adapter-v1",
        "field": PRIME,
        "scope": (
            "Cell-5 execution of the pinned cell-4 reciprocal-square "
