#!/usr/bin/env python3
"""Run the independent hash-block audit of the cofactor-64 census on Modal."""
...
app = modal.App("e1-profile-36-mu6-m64-direct-radius-audit")
image = (
...
@app.function(image=image, cpu=2.0, memory=768, timeout=300, max_containers=96)
...
def main(
    ...
    output: str = (
        ...
        "e1_profile_36_mu6_m64_direct_radius_audit_result.json"
    ),
) -> None:
    ...
    result = {
        "schema": "e1-profile-36-mu6-m64-direct-radius-audit-result-v1",
        "complete": all(
    ...
    print(
        "E1_PROFILE_36_MU6_M64_DIRECT_RADIUS_AUDIT_PASS "
