#!/usr/bin/env python3
"""Externally reconstruct pairing-5 roots by compiled Frobenius/gcd."""
...
app = modal.App("rs-mca-positive-433-1b-cell11-de-pairing5-frobenius-roots")
image = (
...
def main():
    ...
    output = {
        "schema": (
            "rate-half-kb-positive-433-1b-cell11-de-pairing5-"
            "frobenius-roots-v1"
        ),
        "field": PRIME,
