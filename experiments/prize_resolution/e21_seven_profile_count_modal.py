#!/usr/bin/env python3
"""Run dual count-only E21 seven-profile actual-vector engines on Modal."""
...
PRIMARY_SOURCE = HERE / "e21_seven_profile_count.cpp"
AUDIT_SOURCE = HERE / "e21_seven_profile_count_audit.cpp"
...
REMOTE_PRIMARY_SOURCE = "/root/e21_seven_profile_count.cpp"
REMOTE_AUDIT_SOURCE = "/root/e21_seven_profile_count_audit.cpp"
REMOTE_PRIMARY = "/root/e21_seven_profile_count"
REMOTE_AUDIT = "/root/e21_seven_profile_count_audit"

app = modal.App("e1-n256-e21-seven-profile-count")
image = (
...
def main() -> None:
    ...
    if (
        ...
        raise RuntimeError("E21 router or one-diameter atlas mismatch")
    ...
    def write_checkpoint(complete: bool, error: str | None = None) -> dict[str, object]:
        ...
        packet = {
            "schema": "e1-e21-seven-profile-count-v1",
            "complete": complete,
            ...
            "summary": {
                ...
                "proper_conductor_counts": [
                    profile_counts[index] - full_counts[index] for index in range(7)
                ],
    ...
    try:
        ...
        print(f"E21_SEVEN_PROFILE_COUNT_INCOMPLETE completed={len(rows)}/{len(tasks)}")
        raise
    ...
    print("E21_SEVEN_PROFILE_COUNT " + json.dumps(packet["summary"], sort_keys=True))
    print(f"E21_SEVEN_PROFILE_COUNT_COMPLETE {packet['complete']}")
    print(f"E21_SEVEN_PROFILE_COUNT_RESULT {RESULT}")
