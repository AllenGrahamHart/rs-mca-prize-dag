#!/usr/bin/env python3
"""Scout the pinned xi=3 pairing-4 compiler on cell-9 charts."""
...
RESULT = DIRECTORY / (
    "rate_half_kb_positive_433_1b_cell9_xi3_pairing4_chart_scout_result.json"
)
FULL_RESULT = DIRECTORY / (
    "rate_half_kb_positive_433_1b_cell9_xi3_pairing4_chart_result"
)
...
app = modal.App("rs-mca-positive-433-1b-cell9-xi3-pairing4-chart-scout")
image = (
...
def _evaluate_case(case):
    ...
    epsilon_1, epsilon_2, b_index, c_index = case
    ...
    result = namespace["evaluate_case"]((epsilon_1, epsilon_2))
...
def main(
    ...
    if full:
        ...
        writer = ShardedResultWriter(full_result, metadata={
            ...
            "scope": (
                ...
                "compiler for cell-9 xi=3, pairing=4."
            ),
    ...
    for envelope in evaluate.map(cases, order_outputs=False):
        ...
        if "error" in envelope:
            error = {
                ...
                "pairing_index": 4, "b_row_index": case[2],
                "c_row_index": case[3],
                "status": "REMOTE_ERROR",
    ...
    output = {
        "schema": "rate-half-kb-positive-433-1b-cell9-xi3-pairing4-chart-scout-v1",
        "field": PRIME,
    ...
    if writer is not None:
        expected_rows = (
            ...
            else 1 if recovery_index >= 0 else 24
        )
