#!/usr/bin/env python3
"""Run progressive quotient-ring reductions for the FFF R76 coefficients."""
...
PROGRAM = DIRECTORY / "rate_half_kb_positive_433_1b_o0b_fff_r76_progressive_program.py"
RAW_TIMEOUT = DIRECTORY / "rate_half_kb_positive_433_1b_o0b_fff_r76_coefficients_result.json"
RESULT = DIRECTORY / "rate_half_kb_positive_433_1b_o0b_fff_r76_progressive_result.json"
REMOTE_CACHE = "/root/cache.json"
REMOTE_GRAPH = "/root/graph.json"
REMOTE_RAW_CORE = "/root/fff_r76_coefficients_program.py"
REMOTE_PROGRAM = "/root/fff_r76_progressive_program.py"
PRIME = 2130706433
...
app = modal.App("rs-mca-positive-433-1b-o0b-fff-r76-progressive")
image = (
...
def reduce_coefficients():
    ...
    core = load("fff_r76_progressive_program", REMOTE_PROGRAM)
    ...
    built = core.build(packet_row, graph, raw_core)
    ...
    valid = (
        ...
        and len(intermediates) == 61 and len(stages) == 9 and len(values) == 9
    )
    return {
        **common,
...
def write_checkpoint(row, collection_complete):
    payload = {
        "schema": "rate-half-kb-positive-433-1b-o0b-fff-r76-progressive-v1",
        "app": "rs-mca-positive-433-1b-o0b-fff-r76-progressive",
        "collection_complete": collection_complete,
        "field": PRIME,
        "source_cache_sha256": CACHE_SHA256,
        "source_graph_sha256": GRAPH_SHA256,
        "source_raw_core_sha256": RAW_CORE_SHA256,
        "source_raw_timeout_sha256": RAW_TIMEOUT_SHA256,
