#!/usr/bin/env python3
"""Externally reconstruct pairing-4 roots by compiled Frobenius/gcd."""
...
app = modal.App("rs-mca-positive-433-1b-cell12-de-pairing4-frobenius-roots")
image = (
...
@app.function(image=image, cpu=1.0, memory=2048, timeout=300, max_containers=37)
...
def main():
    ...
    output = {
        "schema": (
            "rate-half-kb-positive-433-1b-cell12-de-pairing4-"
            "frobenius-roots-v1"
        ),
        "field": PRIME,
