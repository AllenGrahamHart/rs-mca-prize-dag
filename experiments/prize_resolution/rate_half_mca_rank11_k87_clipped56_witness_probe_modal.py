#!/usr/bin/env python3
"""Run the K'=87 raw-clipped support-5/6 witness probe on Modal."""
...
PROBE = DIRECTORY / "rate_half_mca_rank11_k87_clipped56_witness_probe.py"
...
app = modal.App("rate-half-mca-rank11-k87-clipped56-witness")
