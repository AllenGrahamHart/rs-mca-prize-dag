#!/usr/bin/env python3
"""Benchmark primitive m16 sign-twist quotient plus exact coarse norm cap."""
...
OUTPUT = Path(
    ...
    "e1_profile_36_mu4_m16_primitive_twist_coarse_benchmark_result.json"
)
...
app = modal.App("e1-profile-36-mu4-m16-primitive-twist-coarse-benchmark")
image = (
...
def main() -> None:
    ...
    result = {
        "schema": "e1-profile-36-mu4-m16-primitive-twist-coarse-benchmark-v1",
    ...
    print(
        "E1_PROFILE_36_MU4_M16_PRIMITIVE_TWIST_COARSE_BENCHMARK_PASS "
