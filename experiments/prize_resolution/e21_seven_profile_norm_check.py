#!/usr/bin/env python3
"""Check the dual exact E21 cyclotomic norm ledger."""
...
SOURCE = HERE / "e21_seven_profile_norm_modal.py"
...
def main() -> None:
    ...
    assert packet["schema"] == "e1-e21-seven-profile-norm-v1"
    ...
    assert summary["profile_maximum_bits"] == [
        value.bit_length() for value in expected_profile_maxima
    ]
    ...
    print(
        "E21_SEVEN_PROFILE_NORM_CHECK_PASS "
