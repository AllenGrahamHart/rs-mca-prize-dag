#!/usr/bin/env python3
"""Bounded paired Modal dispatcher for the K'=87 raw-threshold wave."""
...
PRIMARY = DIRECTORY / "rate_half_mca_rank11_k87_raw_threshold_offset_probe.py"
AUDIT = DIRECTORY / "rate_half_mca_rank11_k87_raw_threshold_offset_audit.py"
...
app = modal.App("rate-half-mca-rank11-k87-raw-threshold-wave")
image = (
...
def main(smoke: bool = False) -> None:
    offsets = (1, 76) if smoke else range(1, 77)
    jobs = [
