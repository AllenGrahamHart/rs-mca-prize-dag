#!/usr/bin/env python3
"""Apply the pinned pairing-3 compiler to cell 12."""
...
app = modal.App("rs-mca-positive-433-1b-cell12-xi3-pairing3-adapter")
image = (
...
def main(limit: int = 0):
    ...
    output = {
        ...
        "field": PRIME,
        "scope": (
            "Cell-12 execution of the pinned reciprocal-square/sign-free "
            "compiler for xi=3, pairing 3; adapter evidence until audited."
        ),
    ...
    print(json.dumps({
        ...
        "rows": [
            {key: row.get(key) for key in (
                "epsilon", "pairing_index", "sigma_c", "status",
                "candidate_root_count", "source_point_count",
                "route_point_count", "z_candidate_count",
                "q_lane_count", "final_pair_solution_count",
