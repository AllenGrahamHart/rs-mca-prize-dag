#!/usr/bin/env python3
"""Compute four-basis norms for the two cell-12 parallel-DE source cuts."""
...
RESULT = DIRECTORY / (
    "rate_half_kb_positive_433_1b_cell12_parallel_de_four_basis_norm_result.json"
)
REMOTE_TOWER = "/root/tower.json"
REMOTE_KERNEL = "/root/kernel.json"
PRIME = 2130706433

app = modal.App("rs-mca-positive-433-1b-cell12-parallel-de-four-basis")
image = (
...
def main(limit: int = 0):
    ...
    output = {
        "schema": "rate-half-kb-positive-433-1b-cell12-parallel-de-four-basis-v1",
        "field": PRIME,
        "scope": (
            "Exact four-basis norms for the cell-12 first-pair parallel-DE "
