#!/usr/bin/env python3
"""Independently reconstruct cell-9 positive pairing-14 roots."""
...
MANIFEST = DIRECTORY / (
    "rate_half_kb_positive_433_1b_cell9_positive_de_pairing14_chart_result/manifest.json"
)
RESULT = DIRECTORY / (
...
app = modal.App(
    "rs-mca-positive-433-1b-cell9-positive-de-pairing14-frobenius-roots"
)
