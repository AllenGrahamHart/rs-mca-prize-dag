#!/usr/bin/env python3
"""Run the multiplicity-three support verifier on a small Modal container."""
...
VERIFIER = ROOT / "experiments/prize_resolution/e1_profile_36_mu3_m8_support_contraction.py"
DAG = ROOT / "dag.json"

app = modal.App("e1-profile-36-mu3-m8-support-contraction")
image = (
