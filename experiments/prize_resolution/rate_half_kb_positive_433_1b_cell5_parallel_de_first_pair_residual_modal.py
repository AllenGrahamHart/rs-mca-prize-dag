#!/usr/bin/env python3
"""Census residual targets for the surviving cell-5 negative-DE points."""
...
app = modal.App("rs-mca-positive-433-1b-cell5-parallel-de-residual")
image = (
...
def main(limit: int = 0):
    ...
    for case, row in zip(cases, raw):
        if isinstance(row, BaseException):
            ...
            rows.append(row)
    output = {
        "schema": "rate-half-kb-positive-433-1b-cell5-parallel-de-residual-v1",
        "field": PRIME,
        "scope": (
            "Exact guarded residual census for xi=2 and first-pair matchings "
