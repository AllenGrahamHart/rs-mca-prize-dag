#!/usr/bin/env python3
"""Independently reconstruct cell-9 pairing-11 roots by Frobenius/gcd."""
...
MANIFEST = DIRECTORY / (
    "rate_half_kb_positive_433_1b_cell9_de_pairing11_chart_result/manifest.json"
)
RESULT = DIRECTORY / (
...
app = modal.App(
    "rs-mca-positive-433-1b-cell9-de-pairing11-frobenius-roots"
)
