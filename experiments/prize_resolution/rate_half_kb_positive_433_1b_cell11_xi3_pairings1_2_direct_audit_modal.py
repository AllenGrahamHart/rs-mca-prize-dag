#!/usr/bin/env python3
"""Independently replay the cell-11 xi=3 pairings-1/2 certificate."""
...
app = modal.App("rs-mca-positive-433-1b-cell11-xi3-pairings1-2-direct-audit")
image = (
...
def audit():
    ...
    fields = (
        ...
        "target_boundaries", "leading_boundaries",
    )
