#!/usr/bin/env python3
"""Independently reconstruct cell-9 positive pairing-12 roots."""
...
MANIFEST = DIRECTORY / (
    "rate_half_kb_positive_433_1b_cell9_positive_de_pairing12_chart_result/manifest.json"
)
RESULT = DIRECTORY / (
...
app = modal.App(
    "rs-mca-positive-433-1b-cell9-positive-de-pairing12-frobenius-roots"
)
...
def main():
    ...
    output = {
        "schema": (
            "rate-half-kb-positive-433-1b-cell9-positive-de-pairing12-"
            "frobenius-roots-v1"
        ),
        "field": PRIME,
